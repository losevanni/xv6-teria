...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	pushl  (%ebx)
  37:	e8 3d 04 00 00       	call   479 <open>
  ...
  57:	e8 05 04 00 00       	call   461 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 d0 03 00 00       	call   439 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	pushl  (%ebx)
  6c:	68 3b 09 00 00       	push   $0x93b
  71:	6a 01                	push   $0x1
  73:	e8 38 05 00 00       	call   5b0 <printf>
      exit();
  78:	e8 bc 03 00 00       	call   439 <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 ad 03 00 00       	call   439 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 a9 03 00 00       	call   459 <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 87 03 00 00       	call   451 <read>
  ...
  e4:	6a 01                	push   $0x1
  e6:	e8 c5 04 00 00       	call   5b0 <printf>
      exit();
  eb:	e8 49 03 00 00       	call   439 <exit>
    printf(1, "cat: read error\n");
  f0:	50                   	push   %eax
  f1:	50                   	push   %eax
  f2:	68 2a 09 00 00       	push   $0x92a
  f7:	6a 01                	push   $0x1
  f9:	e8 b2 04 00 00       	call   5b0 <printf>
    exit();
  fe:	e8 36 03 00 00       	call   439 <exit>
 ...
 239:	31 f6                	xor    %esi,%esi
{
 ...
 258:	50                   	push   %eax
 259:	6a 00                	push   $0x0
 25b:	e8 f1 01 00 00       	call   451 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2c1:	e8 b3 01 00 00       	call   479 <open>
  if(fd < 0)
 ...
 2d5:	50                   	push   %eax
 2d6:	e8 b6 01 00 00       	call   491 <fstat>
  close(fd);
 2db:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2de:	89 c6                	mov    %eax,%esi
  close(fd);
 2e0:	e8 7c 01 00 00       	call   461 <close>
  return r;
...
thread_create(thread_t* pid,void* (*start_routine)(void *, void *),void* arg1, void* arg2){
 ...
 37f:	e8 8c 04 00 00       	call   810 <malloc>
  *pid= clone(start_routine , arg1 , arg2 , stack);
 384:	50                   	push   %eax
 385:	ff 75 14             	pushl  0x14(%ebp)
 388:	ff 75 10             	pushl  0x10(%ebp)
 38b:	ff 75 0c             	pushl  0xc(%ebp)
 38e:	e8 46 01 00 00       	call   4d9 <clone>
 393:	8b 55 08             	mov    0x8(%ebp),%edx
  if(*pid){
 396:	83 c4 20             	add    $0x20,%esp
 399:	85 c0                	test   %eax,%eax
  *pid= clone(start_routine , arg1 , arg2 , stack);
 39b:	89 02                	mov    %eax,(%edx)
  if(*pid){
 39d:	0f 94 c0             	sete   %al
    return 0; 
  }
  return -1;
}
...
thread_join(thread_t tid,void** retval){
 ...
 3ba:	ff 75 0c             	pushl  0xc(%ebp)
 3bd:	ff 75 08             	pushl  0x8(%ebp)
 3c0:	e8 1c 01 00 00       	call   4e1 <join>
  if(x){
 ...
 50c:	89 d1                	mov    %edx,%ecx
{
 ...
 57e:	56                   	push   %esi
 57f:	57                   	push   %edi
 580:	e8 d4 fe ff ff       	call   459 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f9:	e8 5b fe ff ff       	call   459 <write>
 ...
 659:	e8 fb fd ff ff       	call   459 <write>
        putc(fd, c);
      } else {
 ...
 66d:	e8 e7 fd ff ff       	call   459 <write>
  for(i = 0; fmt[i]; i++){
 ...
 6e1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6e4:	e8 70 fd ff ff       	call   459 <write>
        ap++;
 ...
 734:	eb 1a                	jmp    750 <printf+0x1a0>
          s = "(null)";
 736:	bb 50 09 00 00       	mov    $0x950,%ebx
        while(*s != 0){
 ...
 75b:	57                   	push   %edi
 75c:	53                   	push   %ebx
 75d:	e8 f7 fc ff ff       	call   459 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 785:	a1 e0 0c 00 00       	mov    0xce0,%eax
{
 ...
 7a6:	73 10                	jae    7b8 <free+0x38>
{
 ...
 7d1:	5b                   	pop    %ebx
  freep = p;
 7d2:	a3 e0 0c 00 00       	mov    %eax,0xce0
}
 7d7:	5e                   	pop    %esi
 7d8:	5f                   	pop    %edi
 7d9:	5d                   	pop    %ebp
 ...
 7f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7fa:	a3 e0 0c 00 00       	mov    %eax,0xce0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 81d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 820:	8b 3d e0 0c 00 00    	mov    0xce0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 869:	8b 3d e0 0c 00 00    	mov    0xce0,%edi
 ...
 892:	e8 e9 fe ff ff       	call   780 <free>
  return freep;
 897:	a1 e0 0c 00 00       	mov    0xce0,%eax
 ...
 8c4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 8c7:	a3 e0 0c 00 00       	mov    %eax,0xce0
}
 ...
 8de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 8e0:	c7 05 e0 0c 00 00 e4 	movl   $0xce4,0xce0
 8e7:	0c 00 00 
    base.s.size = 0;
 8ea:	bf e4 0c 00 00       	mov    $0xce4,%edi
    base.s.ptr = freep = prevp = &base;
 8ef:	c7 05 e4 0c 00 00 e4 	movl   $0xce4,0xce4
 8f6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8fb:	c7 05 e8 0c 00 00 00 	movl   $0x0,0xce8
 902:	00 00 00 
    if(p->s.size >= nunits){

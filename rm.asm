...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 bf 03 00 00       	call   3f9 <unlink>
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	eb 1a                	jmp    6c0 <printf+0x1a0>
          s = "(null)";
 6a6:	bb b5 08 00 00       	mov    $0x8b5,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f5:	a1 14 0c 00 00       	mov    0xc14,%eax
{
 ...
 716:	73 10                	jae    728 <free+0x38>
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	a3 14 0c 00 00       	mov    %eax,0xc14
}
 747:	5e                   	pop    %esi
 748:	5f                   	pop    %edi
 749:	5d                   	pop    %ebp
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 14 0c 00 00       	mov    %eax,0xc14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 78d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 790:	8b 3d 14 0c 00 00    	mov    0xc14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d9:	8b 3d 14 0c 00 00    	mov    0xc14,%edi
 ...
 802:	e8 e9 fe ff ff       	call   6f0 <free>
  return freep;
 807:	a1 14 0c 00 00       	mov    0xc14,%eax
 ...
 834:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 837:	a3 14 0c 00 00       	mov    %eax,0xc14
}
 ...
 84e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 14 0c 00 00 18 	movl   $0xc18,0xc14
 857:	0c 00 00 
    base.s.size = 0;
 85a:	bf 18 0c 00 00       	mov    $0xc18,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 18 0c 00 00 18 	movl   $0xc18,0xc18
 866:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 86b:	c7 05 1c 0c 00 00 00 	movl   $0x0,0xc1c
 872:	00 00 00 
    if(p->s.size >= nunits){

...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2c:	6a 02                	push   $0x2
      2e:	68 d9 13 00 00       	push   $0x13d9
      33:	e8 61 0e 00 00       	call   e99 <open>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      48:	80 3d c2 1a 00 00 20 	cmpb   $0x20,0x1ac2
...
fork1(void)
{
  ...
  pid = fork();
      58:	e8 f4 0d 00 00       	call   e51 <fork>
  if(pid == -1)
    ...
    wait();
      6e:	e8 ee 0d 00 00       	call   e61 <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
      73:	83 ec 08             	sub    $0x8,%esp
      76:	6a 64                	push   $0x64
      78:	68 c0 1a 00 00       	push   $0x1ac0
      7d:	e8 8e 00 00 00       	call   110 <getcmd>
      82:	83 c4 10             	add    $0x10,%esp
      85:	85 c0                	test   %eax,%eax
      87:	78 14                	js     9d <main+0x9d>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      89:	80 3d c0 1a 00 00 63 	cmpb   $0x63,0x1ac0
      90:	75 c6                	jne    58 <main+0x58>
      92:	80 3d c1 1a 00 00 64 	cmpb   $0x64,0x1ac1
      99:	75 bd                	jne    58 <main+0x58>
      9b:	eb ab                	jmp    48 <main+0x48>
  exit();
      9d:	e8 b7 0d 00 00       	call   e59 <exit>
      buf[strlen(buf)-1] = 0;  // chop \n
      a2:	83 ec 0c             	sub    $0xc,%esp
      a5:	68 c0 1a 00 00       	push   $0x1ac0
      aa:	e8 01 0b 00 00       	call   bb0 <strlen>
      if(chdir(buf+3) < 0)
      af:	c7 04 24 c3 1a 00 00 	movl   $0x1ac3,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
      b6:	c6 80 bf 1a 00 00 00 	movb   $0x0,0x1abf(%eax)
      if(chdir(buf+3) < 0)
      bd:	e8 07 0e 00 00       	call   ec9 <chdir>
      c2:	83 c4 10             	add    $0x10,%esp
      c5:	85 c0                	test   %eax,%eax
      c7:	79 aa                	jns    73 <main+0x73>
        printf(2, "cannot cd %s\n", buf+3);
      c9:	50                   	push   %eax
      ca:	68 c3 1a 00 00       	push   $0x1ac3
      cf:	68 e1 13 00 00       	push   $0x13e1
      d4:	6a 02                	push   $0x2
      d6:	e8 f5 0e 00 00       	call   fd0 <printf>
      db:	83 c4 10             	add    $0x10,%esp
      de:	eb 93                	jmp    73 <main+0x73>
      close(fd);
      e0:	83 ec 0c             	sub    $0xc,%esp
      e3:	50                   	push   %eax
      e4:	e8 98 0d 00 00       	call   e81 <close>
      break;
      e9:	83 c4 10             	add    $0x10,%esp
      ec:	eb 85                	jmp    73 <main+0x73>
      runcmd(parsecmd(buf));
      ee:	83 ec 0c             	sub    $0xc,%esp
      f1:	68 c0 1a 00 00       	push   $0x1ac0
      f6:	e8 c5 09 00 00       	call   ac0 <parsecmd>
      fb:	89 04 24             	mov    %eax,(%esp)
      fe:	e8 7d 00 00 00       	call   180 <runcmd>
    panic("fork");
     103:	83 ec 0c             	sub    $0xc,%esp
     106:	68 62 13 00 00       	push   $0x1362
...
00000110 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     122:	68 38 13 00 00       	push   $0x1338
     127:	6a 02                	push   $0x2
     129:	e8 a2 0e 00 00       	call   fd0 <printf>
  memset(buf, 0, nbuf);
...
00000160 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     16d:	68 d5 13 00 00       	push   $0x13d5
     172:	6a 02                	push   $0x2
     174:	e8 57 0e 00 00       	call   fd0 <printf>
  exit();
     179:	e8 db 0c 00 00       	call   e59 <exit>
...
00000180 <runcmd>:
{
  ...
  pid = fork();
     1d2:	e8 7a 0c 00 00       	call   e51 <fork>
  if(pid == -1)
    ...
    close(p[0]);
     ...
     1ee:	e8 8e 0c 00 00       	call   e81 <close>
    close(p[1]);
     1f3:	58                   	pop    %eax
     1f4:	ff 75 f4             	pushl  -0xc(%ebp)
     1f7:	e8 85 0c 00 00       	call   e81 <close>
    wait();
     1fc:	e8 60 0c 00 00       	call   e61 <wait>
    wait();
     201:	e8 5b 0c 00 00       	call   e61 <wait>
    break;
     206:	83 c4 10             	add    $0x10,%esp
     209:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
     210:	e8 44 0c 00 00       	call   e59 <exit>
  pid = fork();
     215:	e8 37 0c 00 00       	call   e51 <fork>
  if(pid == -1)
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     235:	52                   	push   %edx
     236:	50                   	push   %eax
     237:	e8 55 0c 00 00       	call   e91 <exec>
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     23c:	83 c4 0c             	add    $0xc,%esp
     23f:	ff 73 04             	pushl  0x4(%ebx)
     242:	68 42 13 00 00       	push   $0x1342
     247:	6a 02                	push   $0x2
     249:	e8 82 0d 00 00       	call   fd0 <printf>
    break;
     24e:	83 c4 10             	add    $0x10,%esp
     251:	eb bd                	jmp    210 <runcmd+0x90>
  pid = fork();
     253:	e8 f9 0b 00 00       	call   e51 <fork>
  if(pid == -1)
    ...
    wait();
     265:	e8 f7 0b 00 00       	call   e61 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     27b:	e8 01 0c 00 00       	call   e81 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     280:	58                   	pop    %eax
     281:	5a                   	pop    %edx
     282:	ff 73 10             	pushl  0x10(%ebx)
     285:	ff 73 08             	pushl  0x8(%ebx)
     288:	e8 0c 0c 00 00       	call   e99 <open>
    ...
    panic("runcmd");
     ...
     2a2:	68 3b 13 00 00       	push   $0x133b
     2a7:	e8 b4 fe ff ff       	call   160 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2ac:	51                   	push   %ecx
     2ad:	ff 73 08             	pushl  0x8(%ebx)
     2b0:	68 52 13 00 00       	push   $0x1352
     2b5:	6a 02                	push   $0x2
     2b7:	e8 14 0d 00 00       	call   fd0 <printf>
      exit();
     2bc:	e8 98 0b 00 00       	call   e59 <exit>
      panic("pipe");
     2c1:	83 ec 0c             	sub    $0xc,%esp
     2c4:	68 67 13 00 00       	push   $0x1367
     2c9:	e8 92 fe ff ff       	call   160 <panic>
      close(1);
     2ce:	83 ec 0c             	sub    $0xc,%esp
     2d1:	6a 01                	push   $0x1
     2d3:	e8 a9 0b 00 00       	call   e81 <close>
      dup(p[1]);
     2d8:	58                   	pop    %eax
     2d9:	ff 75 f4             	pushl  -0xc(%ebp)
     2dc:	e8 f0 0b 00 00       	call   ed1 <dup>
      close(p[0]);
     2e1:	58                   	pop    %eax
     2e2:	ff 75 f0             	pushl  -0x10(%ebp)
     2e5:	e8 97 0b 00 00       	call   e81 <close>
      close(p[1]);
     2ea:	58                   	pop    %eax
     2eb:	ff 75 f4             	pushl  -0xc(%ebp)
     2ee:	e8 8e 0b 00 00       	call   e81 <close>
      runcmd(pcmd->left);
     2f3:	5a                   	pop    %edx
     ...
     2ff:	6a 00                	push   $0x0
     301:	e8 7b 0b 00 00       	call   e81 <close>
      dup(p[0]);
     306:	5a                   	pop    %edx
     307:	ff 75 f0             	pushl  -0x10(%ebp)
     30a:	e8 c2 0b 00 00       	call   ed1 <dup>
      close(p[0]);
     30f:	59                   	pop    %ecx
     310:	ff 75 f0             	pushl  -0x10(%ebp)
     313:	e8 69 0b 00 00       	call   e81 <close>
      close(p[1]);
     318:	58                   	pop    %eax
     319:	ff 75 f4             	pushl  -0xc(%ebp)
     31c:	e8 60 0b 00 00       	call   e81 <close>
      runcmd(pcmd->right);
     321:	58                   	pop    %eax
    ...
    panic("fork");
     ...
     32d:	68 62 13 00 00       	push   $0x1362
...
00000340 <fork1>:
{
  ...
  pid = fork();
     34a:	e8 02 0b 00 00       	call   e51 <fork>
  if(pid == -1)
  ...
  return pid;
    ...
    panic("fork");
     ...
     359:	68 62 13 00 00       	push   $0x1362
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     37b:	6a 54                	push   $0x54
     37d:	e8 ae 0e 00 00       	call   1230 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3ab:	6a 18                	push   $0x18
     3ad:	e8 7e 0e 00 00       	call   1230 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3fb:	6a 0c                	push   $0xc
     3fd:	e8 2e 0e 00 00       	call   1230 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     43b:	6a 0c                	push   $0xc
     43d:	e8 ee 0d 00 00       	call   1230 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     4bd:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 a0 1a 00 00       	push   $0x1aa0
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     52d:	50                   	push   %eax
     52e:	68 a0 1a 00 00       	push   $0x1aa0
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     56e:	50                   	push   %eax
     56f:	68 98 1a 00 00       	push   $0x1a98
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     590:	56                   	push   %esi
     591:	68 a0 1a 00 00       	push   $0x1aa0
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     63d:	50                   	push   %eax
     63e:	68 a0 1a 00 00       	push   $0x1aa0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     6ab:	68 89 13 00 00       	push   $0x1389
     6b0:	53                   	push   %ebx
     6b1:	56                   	push   %esi
  ...
  return cmd;
     ...
     736:	68 6c 13 00 00       	push   $0x136c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     753:	68 8c 13 00 00       	push   $0x138c
     758:	57                   	push   %edi
     759:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     7a6:	68 a3 13 00 00       	push   $0x13a3
     7ab:	57                   	push   %edi
     7ac:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     7f0:	68 95 13 00 00       	push   $0x1395
  ...
  cmd->eargv[argc] = 0;
     ...
     842:	68 8e 13 00 00       	push   $0x138e
...
00000850 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     86d:	68 a8 13 00 00       	push   $0x13a8
  cmd = parseexec(ps, es);
...
000008c0 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     903:	68 aa 13 00 00       	push   $0x13aa
     908:	57                   	push   %edi
     909:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     919:	68 a6 13 00 00       	push   $0x13a6
     91e:	57                   	push   %edi
     91f:	56                   	push   %esi
...
00000970 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     983:	68 8c 13 00 00       	push   $0x138c
     988:	56                   	push   %esi
     989:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     9ad:	68 c8 13 00 00       	push   $0x13c8
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     a1d:	3e ff 24 85 08 14 00 	notrack jmp *0x1408(,%eax,4)
     a24:	00 
...
00000ac0 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     aeb:	68 51 13 00 00       	push   $0x1351
     af0:	53                   	push   %ebx
     af1:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     b13:	52                   	push   %edx
     b14:	50                   	push   %eax
     b15:	68 ca 13 00 00       	push   $0x13ca
     b1a:	6a 02                	push   $0x2
     b1c:	e8 af 04 00 00       	call   fd0 <printf>
    panic("syntax");
     b21:	c7 04 24 8e 13 00 00 	movl   $0x138e,(%esp)
     ...
     c59:	31 f6                	xor    %esi,%esi
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     c78:	50                   	push   %eax
     c79:	6a 00                	push   $0x0
     c7b:	e8 f1 01 00 00       	call   e71 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     ce1:	e8 b3 01 00 00       	call   e99 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     cf5:	50                   	push   %eax
     cf6:	e8 b6 01 00 00       	call   eb1 <fstat>
  close(fd);
     cfb:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     cfe:	89 c6                	mov    %eax,%esi
  close(fd);
     d00:	e8 7c 01 00 00       	call   e81 <close>
  return r;
...
thread_create(thread_t* pid,void* (*start_routine)(void *, void *),void* arg1, void* arg2){
  ...
  stack = malloc(PGSIZE);
     ...
     d9f:	e8 8c 04 00 00       	call   1230 <malloc>
  *pid= clone(start_routine , arg1 , arg2 , stack);
     da4:	50                   	push   %eax
     da5:	ff 75 14             	pushl  0x14(%ebp)
     da8:	ff 75 10             	pushl  0x10(%ebp)
     dab:	ff 75 0c             	pushl  0xc(%ebp)
     dae:	e8 46 01 00 00       	call   ef9 <clone>
     db3:	8b 55 08             	mov    0x8(%ebp),%edx
  if(*pid){
     db6:	83 c4 20             	add    $0x20,%esp
     db9:	85 c0                	test   %eax,%eax
  *pid= clone(start_routine , arg1 , arg2 , stack);
     dbb:	89 02                	mov    %eax,(%edx)
  if(*pid){
     dbd:	0f 94 c0             	sete   %al
    return 0; 
  }
  return -1;
}
...
thread_join(thread_t tid,void** retval){
  ...
  int x=join(tid,retval);
     dda:	ff 75 0c             	pushl  0xc(%ebp)
     ddd:	ff 75 08             	pushl  0x8(%ebp)
     de0:	e8 1c 01 00 00       	call   f01 <join>
  if(x){
  ...
  if(x){
     ...
     deb:	0f 94 c0             	sete   %al
     dee:	0f b6 c0             	movzbl %al,%eax
     df1:	f7 d8                	neg    %eax
}
     df3:	c3                   	ret    
...
lock_init(lock_t *lk){
  ...
  lk->flag=0;
     ...
     e0a:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return 0;
}
...
lock_release(lock_t *lk){
     ...
     e49:	8b 55 08             	mov    0x8(%ebp),%edx
     e4c:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lk->flag,0);
}
     e4f:	5d                   	pop    %ebp
     e50:	c3                   	ret    
...
00000e59 <exit>:
SYSCALL(exit)
     e59:	b8 02 00 00 00       	mov    $0x2,%eax
     e5e:	cd 40                	int    $0x40
     e60:	c3                   	ret    

00000e61 <wait>:
SYSCALL(wait)
     e61:	b8 03 00 00 00       	mov    $0x3,%eax
     e66:	cd 40                	int    $0x40
     e68:	c3                   	ret    

00000e69 <pipe>:
SYSCALL(pipe)
     e69:	b8 04 00 00 00       	mov    $0x4,%eax
     e6e:	cd 40                	int    $0x40
     e70:	c3                   	ret    

00000e71 <read>:
SYSCALL(read)
     e71:	b8 05 00 00 00       	mov    $0x5,%eax
     e76:	cd 40                	int    $0x40
     e78:	c3                   	ret    

00000e79 <write>:
SYSCALL(write)
     e79:	b8 10 00 00 00       	mov    $0x10,%eax
     e7e:	cd 40                	int    $0x40
     e80:	c3                   	ret    

00000e81 <close>:
SYSCALL(close)
     e81:	b8 15 00 00 00       	mov    $0x15,%eax
     e86:	cd 40                	int    $0x40
     e88:	c3                   	ret    

00000e89 <kill>:
SYSCALL(kill)
     e89:	b8 06 00 00 00       	mov    $0x6,%eax
     e8e:	cd 40                	int    $0x40
     e90:	c3                   	ret    

00000e91 <exec>:
SYSCALL(exec)
     e91:	b8 07 00 00 00       	mov    $0x7,%eax
     e96:	cd 40                	int    $0x40
     e98:	c3                   	ret    

00000e99 <open>:
SYSCALL(open)
     e99:	b8 0f 00 00 00       	mov    $0xf,%eax
     e9e:	cd 40                	int    $0x40
     ea0:	c3                   	ret    

00000ea1 <mknod>:
SYSCALL(mknod)
     ea1:	b8 11 00 00 00       	mov    $0x11,%eax
     ea6:	cd 40                	int    $0x40
     ea8:	c3                   	ret    

00000ea9 <unlink>:
SYSCALL(unlink)
     ea9:	b8 12 00 00 00       	mov    $0x12,%eax
     eae:	cd 40                	int    $0x40
     eb0:	c3                   	ret    

00000eb1 <fstat>:
SYSCALL(fstat)
     eb1:	b8 08 00 00 00       	mov    $0x8,%eax
     eb6:	cd 40                	int    $0x40
     eb8:	c3                   	ret    

00000eb9 <link>:
SYSCALL(link)
     eb9:	b8 13 00 00 00       	mov    $0x13,%eax
     ebe:	cd 40                	int    $0x40
     ec0:	c3                   	ret    

00000ec1 <mkdir>:
SYSCALL(mkdir)
     ec1:	b8 14 00 00 00       	mov    $0x14,%eax
     ec6:	cd 40                	int    $0x40
     ec8:	c3                   	ret    

00000ec9 <chdir>:
SYSCALL(chdir)
     ec9:	b8 09 00 00 00       	mov    $0x9,%eax
     ece:	cd 40                	int    $0x40
     ed0:	c3                   	ret    

00000ed1 <dup>:
SYSCALL(dup)
     ed1:	b8 0a 00 00 00       	mov    $0xa,%eax
     ed6:	cd 40                	int    $0x40
     ed8:	c3                   	ret    

00000ed9 <getpid>:
SYSCALL(getpid)
     ed9:	b8 0b 00 00 00       	mov    $0xb,%eax
     ede:	cd 40                	int    $0x40
     ee0:	c3                   	ret    

00000ee1 <sbrk>:
SYSCALL(sbrk)
     ee1:	b8 0c 00 00 00       	mov    $0xc,%eax
     ee6:	cd 40                	int    $0x40
     ee8:	c3                   	ret    

00000ee9 <sleep>:
SYSCALL(sleep)
     ee9:	b8 0d 00 00 00       	mov    $0xd,%eax
     eee:	cd 40                	int    $0x40
     ef0:	c3                   	ret    

00000ef1 <uptime>:
SYSCALL(uptime)
     ef1:	b8 0e 00 00 00       	mov    $0xe,%eax
     ef6:	cd 40                	int    $0x40
     ef8:	c3                   	ret    

00000ef9 <clone>:
SYSCALL(clone)
     ef9:	b8 16 00 00 00       	mov    $0x16,%eax
     efe:	cd 40                	int    $0x40
     f00:	c3                   	ret    

00000f01 <join>:
SYSCALL(join)
     f01:	b8 17 00 00 00       	mov    $0x17,%eax
     f06:	cd 40                	int    $0x40
     f08:	c3                   	ret    

00000f09 <thread_exit>:
     f09:	b8 18 00 00 00       	mov    $0x18,%eax
     f0e:	cd 40                	int    $0x40
     f10:	c3                   	ret    
     ...
     f2c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f59:	0f b6 92 28 14 00 00 	movzbl 0x1428(%edx),%edx
  ...
  write(fd, &c, 1);
     ...
     f9e:	56                   	push   %esi
     f9f:	57                   	push   %edi
     fa0:	e8 d4 fe ff ff       	call   e79 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1019:	e8 5b fe ff ff       	call   e79 <write>
  ...
  write(fd, &c, 1);
    ...
    1079:	e8 fb fd ff ff       	call   e79 <write>
        putc(fd, c);
      } else {
  ...
  write(fd, &c, 1);
    ...
    108d:	e8 e7 fd ff ff       	call   e79 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    1104:	e8 70 fd ff ff       	call   e79 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    1154:	eb 1a                	jmp    1170 <printf+0x1a0>
          s = "(null)";
    1156:	bb 20 14 00 00       	mov    $0x1420,%ebx
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    117b:	57                   	push   %edi
    117c:	53                   	push   %ebx
    117d:	e8 f7 fc ff ff       	call   e79 <write>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11a5:	a1 24 1b 00 00       	mov    0x1b24,%eax
{
    ...
    11c6:	73 10                	jae    11d8 <free+0x38>
{
  ...
  freep = p;
    ...
    11f1:	5b                   	pop    %ebx
  freep = p;
    11f2:	a3 24 1b 00 00       	mov    %eax,0x1b24
}
    11f7:	5e                   	pop    %esi
    11f8:	5f                   	pop    %edi
    11f9:	5d                   	pop    %ebp
  ...
  freep = p;
    121a:	a3 24 1b 00 00       	mov    %eax,0x1b24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1240:	8b 3d 24 1b 00 00    	mov    0x1b24,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1289:	8b 3d 24 1b 00 00    	mov    0x1b24,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    129b:	e8 41 fc ff ff       	call   ee1 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    12b7:	a1 24 1b 00 00       	mov    0x1b24,%eax
    ...
    12e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    12e7:	a3 24 1b 00 00       	mov    %eax,0x1b24
}
    ...
    base.s.ptr = freep = prevp = &base;
    1300:	c7 05 24 1b 00 00 28 	movl   $0x1b28,0x1b24
    1307:	1b 00 00 
    base.s.size = 0;
    130a:	bf 28 1b 00 00       	mov    $0x1b28,%edi
    base.s.ptr = freep = prevp = &base;
    130f:	c7 05 28 1b 00 00 28 	movl   $0x1b28,0x1b28
    1316:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1319:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    131b:	c7 05 2c 1b 00 00 00 	movl   $0x0,0x1b2c
    1322:	00 00 00 
    if(p->s.size >= nunits){

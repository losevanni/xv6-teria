...
8010005a:	e8 81 46 00 00       	call   801046e0 <initlock>
  bcache.head.next = &bcache.head;
...
801000e8:	e8 73 47 00 00       	call   80104860 <acquire>
...
801001c2:	e8 b9 44 00 00       	call   80104680 <holdingsleep>
...
80100203:	e8 78 44 00 00       	call   80104680 <holdingsleep>
...
80100213:	e8 28 44 00 00       	call   80104640 <releasesleep>

  acquire(&bcache.lock);
80100218:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
8010021f:	e8 3c 46 00 00       	call   80104860 <acquire>
  b->refcnt--;
...
8010026f:	5d                   	pop    %ebp
  release(&bcache.lock);
80100270:	e9 ab 46 00 00       	jmp    80104920 <release>
    panic("brelse");
...
801002b1:	e8 aa 45 00 00       	call   80104860 <acquire>
...
8010030e:	e8 0d 46 00 00       	call   80104920 <release>
        ilock(ip);
80100313:	5a                   	pop    %edx
...
80100365:	e8 b6 45 00 00       	call   80104920 <release>
  ilock(ip);
8010036a:	58                   	pop    %eax
...
801003dc:	e8 1f 43 00 00       	call   80104700 <getcallerpcs>
  for(i=0; i<10; i++)
...
8010042a:	e8 a1 5c 00 00       	call   801060d0 <uartputc>
...
80100515:	e8 b6 5b 00 00       	call   801060d0 <uartputc>
8010051a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100521:	e8 aa 5b 00 00       	call   801060d0 <uartputc>
80100526:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052d:	e8 9e 5b 00 00       	call   801060d0 <uartputc>
...
80100561:	e8 aa 44 00 00       	call   80104a10 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
8010065f:	e8 fc 41 00 00       	call   80104860 <acquire>
  for(i = 0; i < n; i++)
...
80100697:	e8 84 42 00 00       	call   80104920 <release>
  ilock(ip);
8010069c:	58                   	pop    %eax
...
801007bd:	e8 9e 40 00 00       	call   80104860 <acquire>
...
80100828:	e8 f3 40 00 00       	call   80104920 <release>
...
80100877:	e8 e4 3f 00 00       	call   80104860 <acquire>
  while((c = getc()) >= 0){
...
801009cf:	e8 4c 3f 00 00       	call   80104920 <release>
  if(doprocdump) {
...
80100a44:	e8 97 3c 00 00       	call   801046e0 <initlock>
...
80100b0a:	75 ce                	jne    80100ada <exec+0x5a>
  if((pgdir = setupkvm()) == 0)
80100b0c:	e8 2f 67 00 00       	call   80107240 <setupkvm>
...
80100b73:	e8 e8 64 00 00       	call   80107060 <allocuvm>
...
80100ba9:	e8 e2 63 00 00       	call   80106f90 <loaduvm>
...
80100beb:	e8 d0 65 00 00       	call   801071c0 <freevm>
  if(ip){
...
80100c32:	e8 29 64 00 00       	call   80107060 <allocuvm>
...
80100c51:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE)); 
80100c53:	e8 88 66 00 00       	call   801072e0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100ca3:	e8 c8 3e 00 00       	call   80104b70 <strlen>
...
80100cb6:	e8 b5 3e 00 00       	call   80104b70 <strlen>
...
80100ce1:	e8 da 64 00 00       	call   801071c0 <freevm>
...
80100d2d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d33:	e8 08 67 00 00       	call   80107440 <copyout>
...
80100d71:	e8 ba 3d 00 00       	call   80104b30 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d9d:	e8 5e 60 00 00       	call   80106e00 <switchuvm>
  freevm(oldpgdir);
80100da2:	89 3c 24             	mov    %edi,(%esp)
80100da5:	e8 16 64 00 00       	call   801071c0 <freevm>
  return 0;
...
80100df4:	e8 e7 38 00 00       	call   801046e0 <initlock>
}
...
80100e15:	e8 46 3a 00 00       	call   80104860 <acquire>
...
80100e41:	e8 da 3a 00 00       	call   80104920 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e5a:	e8 c1 3a 00 00       	call   80104920 <release>
}
...
80100e83:	e8 d8 39 00 00       	call   80104860 <acquire>
  if(f->ref < 1)
...
80100ea0:	e8 7b 3a 00 00       	call   80104920 <release>
  return f;
}
...
80100ed5:	e8 86 39 00 00       	call   80104860 <acquire>
  if(f->ref < 1)
...
80100f0d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f10:	e8 0b 3a 00 00       	call   80104920 <release>
...
80100f3d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f3e:	e9 dd 39 00 00       	jmp    80104920 <release>
...
80101217:	68 9f 75 10 80       	push   $0x8010759f
...
801012d4:	68 b2 75 10 80       	push   $0x801075b2
...
801013c7:	e8 54 35 00 00       	call   80104920 <release>
...
801013f2:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801013f5:	e8 26 35 00 00       	call   80104920 <release>
      return ip;
...
80101422:	68 c8 75 10 80       	push   $0x801075c8
...
801014eb:	68 d8 75 10 80       	push   $0x801075d8
...
80101525:	e8 e6 34 00 00       	call   80104a10 <memmove>
  brelse(bp);
...
8010155a:	e8 81 31 00 00       	call   801046e0 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101577:	e8 24 30 00 00       	call   801045a0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015c1:	68 58 76 10 80       	push   $0x80107658
...
8010165e:	e8 0d 33 00 00       	call   80104970 <memset>
      dip->type = type;
...
80101705:	e8 06 33 00 00       	call   80104a10 <memmove>
  log_write(bp);
...
80101743:	e8 18 31 00 00       	call   80104860 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101753:	e8 c8 31 00 00       	call   80104920 <release>
}
...
80101786:	e8 55 2e 00 00       	call   801045e0 <acquiresleep>
  if(ip->valid == 0){
...
801017f8:	e8 13 32 00 00       	call   80104a10 <memmove>
    brelse(bp);
...
80101857:	e8 24 2e 00 00       	call   80104680 <holdingsleep>
...
80101872:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
80101873:	e9 c8 2d 00 00       	jmp    80104640 <releasesleep>
    panic("iunlock");
...
801018a4:	e8 37 2d 00 00       	call   801045e0 <acquiresleep>
...
801018be:	e8 7d 2d 00 00       	call   80104640 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801018ca:	e8 91 2f 00 00       	call   80104860 <acquire>
  ip->ref--;
...
801018e3:	5d                   	pop    %ebp
  release(&icache.lock);
801018e4:	e9 37 30 00 00       	jmp    80104920 <release>
801018e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&icache.lock);
801018f0:	83 ec 0c             	sub    $0xc,%esp
801018f3:	68 e0 09 11 80       	push   $0x801109e0
801018f8:	e8 63 2f 00 00       	call   80104860 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101907:	e8 14 30 00 00       	call   80104920 <release>
    if(r == 1){
...
80101b07:	e8 04 2f 00 00       	call   80104a10 <memmove>
    brelse(bp);
...
80101c03:	e8 08 2e 00 00       	call   80104a10 <memmove>
    log_write(bp);
...
80101ca2:	e8 d9 2d 00 00       	call   80104a80 <strncmp>
}
80101ca7:	c9                   	leave  
80101ca8:	c3                   	ret    
...
80101d05:	e8 76 2d 00 00       	call   80104a80 <strncmp>
      continue;
...
80101d9c:	e8 bf 2a 00 00       	call   80104860 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101dac:	e8 6f 2b 00 00       	call   80104920 <release>
...
80101e17:	e8 f4 2b 00 00       	call   80104a10 <memmove>
...
80101ea3:	e8 68 2b 00 00       	call   80104a10 <memmove>
    name[len] = 0;
...
80101fd5:	e8 f6 2a 00 00       	call   80104ad0 <strncpy>
...
8010212b:	68 b4 76 10 80       	push   $0x801076b4
80102130:	e8 5b e2 ff ff       	call   80100390 <panic>
    panic("idestart");
80102135:	83 ec 0c             	sub    $0xc,%esp
80102138:	68 ab 76 10 80       	push   $0x801076ab
...
8010215a:	68 c6 76 10 80       	push   $0x801076c6
8010215f:	68 80 a5 10 80       	push   $0x8010a580
80102164:	e8 77 25 00 00       	call   801046e0 <initlock>
...
801021f2:	e8 69 26 00 00       	call   80104860 <acquire>
...
8010226b:	e8 b0 26 00 00       	call   80104920 <release>
...
80102292:	e8 e9 23 00 00       	call   80104680 <holdingsleep>
...
801022cc:	e8 8f 25 00 00       	call   80104860 <acquire>
...
80102335:	c9                   	leave  
  release(&idelock);
80102336:	e9 e5 25 00 00       	jmp    80104920 <release>
...
8010235a:	68 f5 76 10 80       	push   $0x801076f5
8010235f:	e8 2c e0 ff ff       	call   80100390 <panic>
    panic("iderw: nothing to do");
80102364:	83 ec 0c             	sub    $0xc,%esp
80102367:	68 e0 76 10 80       	push   $0x801076e0
8010236c:	e8 1f e0 ff ff       	call   80100390 <panic>
    panic("iderw: buf not locked");
80102371:	83 ec 0c             	sub    $0xc,%esp
80102374:	68 ca 76 10 80       	push   $0x801076ca
...
801023ce:	68 14 77 10 80       	push   $0x80107714
...
801024a6:	e8 c5 24 00 00       	call   80104970 <memset>
...
801024e0:	e8 7b 23 00 00       	call   80104860 <acquire>
...
801024fa:	c9                   	leave  
    release(&kmem.lock);
801024fb:	e9 20 24 00 00       	jmp    80104920 <release>
    panic("kfree");
80102500:	83 ec 0c             	sub    $0xc,%esp
80102503:	68 46 77 10 80       	push   $0x80107746
...
8010256f:	68 4c 77 10 80       	push   $0x8010774c
80102574:	68 40 26 11 80       	push   $0x80112640
80102579:	e8 62 21 00 00       	call   801046e0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102663:	e8 f8 21 00 00       	call   80104860 <acquire>
  r = kmem.freelist;
...
80102691:	e8 8a 22 00 00       	call   80104920 <release>
  return (char*)r;
...
801026df:	0f b6 8a 80 78 10 80 	movzbl -0x7fef8780(%edx),%ecx
  shift ^= togglecode[data];
801026e6:	0f b6 82 80 77 10 80 	movzbl -0x7fef8880(%edx),%eax
  shift |= shiftcode[data];
...
801026fc:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
801026ff:	8b 04 85 60 77 10 80 	mov    -0x7fef88a0(,%eax,4),%eax
...
80102738:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
8010273a:	0f b6 8a 80 78 10 80 	movzbl -0x7fef8780(%edx),%ecx
...
80102abf:	e8 fc 1e 00 00       	call   801049c0 <memcmp>
...
80102bf4:	e8 17 1e 00 00       	call   80104a10 <memmove>
...
80102c9e:	68 80 79 10 80       	push   $0x80107980
80102ca3:	68 80 26 11 80       	push   $0x80112680
80102ca8:	e8 33 1a 00 00       	call   801046e0 <initlock>
  readsb(dev, &sb);
80102cad:	58                   	pop    %eax
...
80102d3f:	e8 1c 1b 00 00       	call   80104860 <acquire>
...
80102d5d:	e8 7e 13 00 00       	call   801040e0 <sleep>
...
80102d94:	e8 87 1b 00 00       	call   80104920 <release>
      break;
    }
  }
}
...
80102db2:	e8 a9 1a 00 00       	call   80104860 <acquire>
  log.outstanding -= 1;
...
80102df0:	e8 2b 1b 00 00       	call   80104920 <release>
}
...
80102e0a:	e8 51 1a 00 00       	call   80104860 <acquire>
    wakeup(&log);
...
80102e2c:	e8 ef 1a 00 00       	call   80104920 <release>
...
80102e84:	e8 87 1b 00 00       	call   80104a10 <memmove>
...
80102ee4:	e8 37 1a 00 00       	call   80104920 <release>
...
80102ef7:	68 84 79 10 80       	push   $0x80107984
...
80102f52:	e8 09 19 00 00       	call   80104860 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102f94:	c9                   	leave  
  release(&log.lock);
80102f95:	e9 86 19 00 00       	jmp    80104920 <release>
...
80102fc1:	68 93 79 10 80       	push   $0x80107993
80102fc6:	e8 c5 d3 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102fcb:	83 ec 0c             	sub    $0xc,%esp
80102fce:	68 a9 79 10 80       	push   $0x801079a9
...
80102ff8:	68 c4 79 10 80       	push   $0x801079c4
80102ffd:	e8 ae d6 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80103002:	e8 09 2d 00 00       	call   80105d10 <idtinit>
...
8010301a:	e8 d1 0d 00 00       	call   80103df0 <scheduler>
8010301f:	90                   	nop
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 b1 3d 00 00       	call   80106de0 <switchkvm>
  seginit();
8010302f:	e8 1c 3d 00 00       	call   80106d50 <seginit>
  lapicinit();
...
80103065:	e8 56 42 00 00       	call   801072c0 <kvmalloc>
  mpinit();        // detect other processors
8010306a:	e8 81 01 00 00       	call   801031f0 <mpinit>
  lapicinit();     // interrupt controller
8010306f:	e8 2c f7 ff ff       	call   801027a0 <lapicinit>
  seginit();       // segment descriptors
80103074:	e8 d7 3c 00 00       	call   80106d50 <seginit>
  picinit();       // disable pic
...
80103088:	e8 83 2f 00 00       	call   80106010 <uartinit>
  pinit();         // process table
8010308d:	e8 2e 08 00 00       	call   801038c0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 f9 2b 00 00       	call   80105c90 <tvinit>
  binit();         // buffer cache
...
801030b8:	e8 53 19 00 00       	call   80104a10 <memmove>
...
8010319e:	68 d8 79 10 80       	push   $0x801079d8
801031a3:	56                   	push   %esi
801031a4:	e8 17 18 00 00       	call   801049c0 <memcmp>
...
8010325a:	68 dd 79 10 80       	push   $0x801079dd
8010325f:	50                   	push   %eax
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
80103260:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103263:	e8 58 17 00 00       	call   801049c0 <memcmp>
...
801033c0:	68 fc 79 10 80       	push   $0x801079fc
...
80103464:	00 00 00 
  initlock(&p->lock, "pipe");
80103467:	68 1b 7a 10 80       	push   $0x80107a1b
8010346c:	50                   	push   %eax
8010346d:	e8 6e 12 00 00       	call   801046e0 <initlock>
  (*f0)->type = FD_PIPE;
...
80103513:	e8 48 13 00 00       	call   80104860 <acquire>
  if(writable){
...
80103557:	5d                   	pop    %ebp
    release(&p->lock);
80103558:	e9 c3 13 00 00       	jmp    80104920 <release>
...
80103584:	e8 97 13 00 00       	call   80104920 <release>
    kfree((char*)p);
...
801035b1:	e8 aa 12 00 00       	call   80104860 <acquire>
  for(i = 0; i < n; i++){
...
80103611:	e8 ca 0a 00 00       	call   801040e0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
8010363c:	e8 df 12 00 00       	call   80104920 <release>
        return -1;
...
801036ba:	e8 a1 11 00 00       	call   80104860 <acquire>
...
801036ed:	e8 ee 09 00 00       	call   801040e0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010375e:	e8 bd 11 00 00       	call   80104920 <release>
  return i;
...
80103779:	e8 a2 11 00 00       	call   80104920 <release>
      return -1;
...
801037a1:	e8 ba 10 00 00       	call   80104860 <acquire>
...
801037bc:	74 7a                	je     80103838 <allocproc+0xa8>
    if(p->state == UNUSED)
801037be:	8b 43 10             	mov    0x10(%ebx),%eax
...
801037ca:	83 ec 0c             	sub    $0xc,%esp
  p->state = EMBRYO;
801037cd:	c7 43 10 01 00 00 00 	movl   $0x1,0x10(%ebx)
  p->pid = nextpid++;
801037d4:	89 43 14             	mov    %eax,0x14(%ebx)
...
801037df:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037e5:	e8 36 11 00 00       	call   80104920 <release>
...
80103802:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103807:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
8010380a:	c7 40 14 7c 5c 10 80 	movl   $0x80105c7c,0x14(%eax)
  p->context = (struct context*)sp;
80103811:	89 43 20             	mov    %eax,0x20(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103814:	6a 14                	push   $0x14
80103816:	6a 00                	push   $0x0
80103818:	50                   	push   %eax
80103819:	e8 52 11 00 00       	call   80104970 <memset>
  p->context->eip = (uint)forkret;
8010381e:	8b 43 20             	mov    0x20(%ebx),%eax
...
80103842:	e8 d9 10 00 00       	call   80104920 <release>
}
...
80103850:	c3                   	ret    
    p->state = UNUSED;
80103851:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return 0;
...
8010387f:	e8 9c 10 00 00       	call   80104920 <release>
...
801038ca:	68 20 7a 10 80       	push   $0x80107a20
801038cf:	68 20 2d 11 80       	push   $0x80112d20
801038d4:	e8 07 0e 00 00       	call   801046e0 <initlock>
}
...
80103978:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010397b:	e8 e0 0d 00 00       	call   80104760 <pushcli>
  c = mycpu();
80103980:	e8 5b ff ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103985:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010398b:	e8 20 0e 00 00       	call   801047b0 <popcli>
}
...
801039b7:	e8 84 38 00 00       	call   80107240 <setupkvm>
...
801039d5:	e8 36 35 00 00       	call   80106f10 <inituvm>
...
801039ea:	e8 81 0f 00 00       	call   80104970 <memset>
...
80103a43:	68 50 7a 10 80       	push   $0x80107a50
80103a48:	50                   	push   %eax
80103a49:	e8 e2 10 00 00       	call   80104b30 <safestrcpy>
  p->cwd = namei("/");
80103a4e:	c7 04 24 59 7a 10 80 	movl   $0x80107a59,(%esp)
...
80103a87:	68 37 7a 10 80       	push   $0x80107a37
...
80103aa9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aac:	e8 af 0c 00 00       	call   80104760 <pushcli>
  c = mycpu();
80103ab1:	e8 2a fe ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103ab6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103abc:	e8 ef 0c 00 00       	call   801047b0 <popcli>
  sz = curproc->sz;
...
80103aea:	e8 71 35 00 00       	call   80107060 <allocuvm>
...
80103b0a:	e8 81 36 00 00       	call   80107190 <deallocuvm>
...
80103b2a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b2d:	e8 2e 0c 00 00       	call   80104760 <pushcli>
  c = mycpu();
80103b32:	e8 a9 fd ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103b37:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b3d:	e8 6e 0c 00 00       	call   801047b0 <popcli>
  if((np = allocproc()) == 0){
...
80103b5c:	e8 af 37 00 00       	call   80107310 <copyuvm>
...
80103c4a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103c4d:	e8 0e 0b 00 00       	call   80104760 <pushcli>
  c = mycpu();
80103c52:	e8 89 fc ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103c57:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80103c5d:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  popcli();
80103c60:	e8 4b 0b 00 00       	call   801047b0 <popcli>
  if((np=allocproc())==0)
80103c65:	e8 26 fb ff ff       	call   80103790 <allocproc>
80103c6a:	85 c0                	test   %eax,%eax
80103c6c:	0f 84 fc 00 00 00    	je     80103d6e <clone+0x12e>
  np->pgdir = p->pgdir;
80103c72:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103c75:	89 c3                	mov    %eax,%ebx
  *np->tf=*p->tf;
80103c77:	b9 13 00 00 00       	mov    $0x13,%ecx
80103c7c:	8b 7b 1c             	mov    0x1c(%ebx),%edi
  np->pgdir = p->pgdir;
80103c7f:	8b 42 04             	mov    0x4(%edx),%eax
80103c82:	89 43 04             	mov    %eax,0x4(%ebx)
  np->sz=p->sz;
80103c85:	8b 02                	mov    (%edx),%eax
  np->parent=p;
80103c87:	89 53 18             	mov    %edx,0x18(%ebx)
  np->sz=p->sz;
80103c8a:	89 03                	mov    %eax,(%ebx)
  np->tid=np->pid;
80103c8c:	8b 43 14             	mov    0x14(%ebx),%eax
80103c8f:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
  np->pid=np->parent->pid;
80103c95:	8b 42 14             	mov    0x14(%edx),%eax
80103c98:	89 43 14             	mov    %eax,0x14(%ebx)
  *(uint*)sret=0xFFFFFFF; // 모름 FFFFFFFF
80103c9b:	8b 45 14             	mov    0x14(%ebp),%eax
  *np->tf=*p->tf;
80103c9e:	8b 72 1c             	mov    0x1c(%edx),%esi
80103ca1:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  *(uint*)sarg1=(uint)arg1;
80103ca3:	8b 4d 14             	mov    0x14(%ebp),%ecx
  for(i=0;i<NOFILE;i++){ // 파일 fd 복사
80103ca6:	31 f6                	xor    %esi,%esi
80103ca8:	89 d7                	mov    %edx,%edi
  *(uint*)sret=0xFFFFFFF; // 모름 FFFFFFFF
80103caa:	c7 80 f4 0f 00 00 ff 	movl   $0xfffffff,0xff4(%eax)
80103cb1:	ff ff 0f 
  *(uint*)sarg1=(uint)arg1;
80103cb4:	8b 45 0c             	mov    0xc(%ebp),%eax
80103cb7:	89 81 f8 0f 00 00    	mov    %eax,0xff8(%ecx)
  *(uint*)sarg2=(uint)arg2;
80103cbd:	8b 45 10             	mov    0x10(%ebp),%eax
80103cc0:	89 81 fc 0f 00 00    	mov    %eax,0xffc(%ecx)
  np->tf->esp=(uint)stack;
80103cc6:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103cc9:	89 48 44             	mov    %ecx,0x44(%eax)
  np->tf->esp+=PGSIZE-3*sizeof(void*); 
80103ccc:	8b 43 1c             	mov    0x1c(%ebx),%eax
  np->threadstack=stack;
80103ccf:	89 4b 0c             	mov    %ecx,0xc(%ebx)
  np->tf->esp+=PGSIZE-3*sizeof(void*); 
80103cd2:	81 40 44 f4 0f 00 00 	addl   $0xff4,0x44(%eax)
  np->tf->ebp=np->tf->esp; //tf 가 뭐지? 일단 esp = ebp
80103cd9:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103cdc:	8b 48 44             	mov    0x44(%eax),%ecx
80103cdf:	89 48 08             	mov    %ecx,0x8(%eax)
  np->tf->eip=(uint) fcn; // 스레드의 명령어 포인터는 함수포인터
80103ce2:	8b 4d 08             	mov    0x8(%ebp),%ecx
80103ce5:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103ce8:	89 48 38             	mov    %ecx,0x38(%eax)
  np->tf->eax=0; // eax 를 0 으로 변경 
80103ceb:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103cee:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i=0;i<NOFILE;i++){ // 파일 fd 복사
80103cf5:	8d 76 00             	lea    0x0(%esi),%esi
    if(p->ofile[i]){
80103cf8:	8b 44 b7 2c          	mov    0x2c(%edi,%esi,4),%eax
80103cfc:	85 c0                	test   %eax,%eax
80103cfe:	74 10                	je     80103d10 <clone+0xd0>
      np->ofile[i]=filedup(p->ofile[i]);
80103d00:	83 ec 0c             	sub    $0xc,%esp
80103d03:	50                   	push   %eax
80103d04:	e8 67 d1 ff ff       	call   80100e70 <filedup>
80103d09:	83 c4 10             	add    $0x10,%esp
80103d0c:	89 44 b3 2c          	mov    %eax,0x2c(%ebx,%esi,4)
  for(i=0;i<NOFILE;i++){ // 파일 fd 복사
80103d10:	83 c6 01             	add    $0x1,%esi
80103d13:	83 fe 10             	cmp    $0x10,%esi
80103d16:	75 e0                	jne    80103cf8 <clone+0xb8>
  np->cwd=idup(p->cwd);
80103d18:	83 ec 0c             	sub    $0xc,%esp
80103d1b:	ff 77 6c             	pushl  0x6c(%edi)
80103d1e:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80103d21:	e8 0a da ff ff       	call   80101730 <idup>
  safestrcpy(np->name, p->name, sizeof(p->name));
80103d26:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103d29:	83 c4 0c             	add    $0xc,%esp
  np->cwd=idup(p->cwd);
80103d2c:	89 43 6c             	mov    %eax,0x6c(%ebx)
  safestrcpy(np->name, p->name, sizeof(p->name));
80103d2f:	8d 43 70             	lea    0x70(%ebx),%eax
80103d32:	83 c2 70             	add    $0x70,%edx
80103d35:	6a 10                	push   $0x10
80103d37:	52                   	push   %edx
80103d38:	50                   	push   %eax
80103d39:	e8 f2 0d 00 00       	call   80104b30 <safestrcpy>
  acquire(&ptable.lock);
80103d3e:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d45:	e8 16 0b 00 00       	call   80104860 <acquire>
  np->state=RUNNABLE; // 생성한 스레드는 실행 준비
80103d4a:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  release(&ptable.lock);
80103d51:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d58:	e8 c3 0b 00 00       	call   80104920 <release>
  return np->tid;
...
80103d90:	68 5b 7a 10 80       	push   $0x80107a5b
80103d95:	e8 16 c9 ff ff       	call   801006b0 <cprintf>
  cprintf("exit retval : %d\n", retval);
80103d9a:	58                   	pop    %eax
80103d9b:	5a                   	pop    %edx
80103d9c:	53                   	push   %ebx
80103d9d:	68 76 7a 10 80       	push   $0x80107a76
80103da2:	e8 09 c9 ff ff       	call   801006b0 <cprintf>
  cprintf("exit int retval : %d\n", (int)retval);
80103da7:	59                   	pop    %ecx
80103da8:	5e                   	pop    %esi
80103da9:	53                   	push   %ebx
80103daa:	68 88 7a 10 80       	push   $0x80107a88
80103daf:	e8 fc c8 ff ff       	call   801006b0 <cprintf>
  cprintf("exit retval : %d\n", a);
80103db4:	58                   	pop    %eax
80103db5:	5a                   	pop    %edx
80103db6:	53                   	push   %ebx
80103db7:	68 76 7a 10 80       	push   $0x80107a76
80103dbc:	e8 ef c8 ff ff       	call   801006b0 <cprintf>
  pushcli();
80103dc1:	e8 9a 09 00 00       	call   80104760 <pushcli>
  c = mycpu();
80103dc6:	e8 15 fb ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103dcb:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103dd1:	e8 da 09 00 00       	call   801047b0 <popcli>
}
80103dd6:	83 c4 10             	add    $0x10,%esp
  p->ret=retval;
80103dd9:	89 9e 84 00 00 00    	mov    %ebx,0x84(%esi)
}
...
80103dfa:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103dfd:	e8 de fa ff ff       	call   801038e0 <mycpu>
  c->proc = 0;
...
80103e1c:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
    acquire(&ptable.lock);
80103e21:	68 20 2d 11 80       	push   $0x80112d20
80103e26:	e8 35 0a 00 00       	call   80104860 <acquire>
80103e2b:	83 c4 10             	add    $0x10,%esp
80103e2e:	66 90                	xchg   %ax,%ax
      if(p->state != RUNNABLE)
80103e30:	83 7b 10 03          	cmpl   $0x3,0x10(%ebx)
...
80103e40:	e8 bb 2f 00 00       	call   80106e00 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103e45:	58                   	pop    %eax
80103e46:	5a                   	pop    %edx
80103e47:	ff 73 20             	pushl  0x20(%ebx)
80103e4a:	57                   	push   %edi
      p->state = RUNNING;
80103e4b:	c7 43 10 04 00 00 00 	movl   $0x4,0x10(%ebx)
      swtch(&(c->scheduler), p->context);
80103e52:	e8 3c 0d 00 00       	call   80104b93 <swtch>
      switchkvm();
80103e57:	e8 84 2f 00 00       	call   80106de0 <switchkvm>
      c->proc = 0;
...
80103e98:	53                   	push   %ebx
  pushcli();
80103e99:	e8 c2 08 00 00       	call   80104760 <pushcli>
  c = mycpu();
80103e9e:	e8 3d fa ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103ea3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ea9:	e8 02 09 00 00       	call   801047b0 <popcli>
  if(!holding(&ptable.lock))
80103eae:	83 ec 0c             	sub    $0xc,%esp
80103eb1:	68 20 2d 11 80       	push   $0x80112d20
80103eb6:	e8 55 09 00 00       	call   80104810 <holding>
80103ebb:	83 c4 10             	add    $0x10,%esp
80103ebe:	85 c0                	test   %eax,%eax
80103ec0:	74 4f                	je     80103f11 <sched+0x81>
  if(mycpu()->ncli != 1)
80103ec2:	e8 19 fa ff ff       	call   801038e0 <mycpu>
80103ec7:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
80103ece:	75 68                	jne    80103f38 <sched+0xa8>
  if(p->state == RUNNING)
80103ed0:	83 7b 10 04          	cmpl   $0x4,0x10(%ebx)
...
80103edb:	75 41                	jne    80103f1e <sched+0x8e>
  intena = mycpu()->intena;
80103edd:	e8 fe f9 ff ff       	call   801038e0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103ee2:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
80103ee5:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103eeb:	e8 f0 f9 ff ff       	call   801038e0 <mycpu>
80103ef0:	83 ec 08             	sub    $0x8,%esp
80103ef3:	ff 70 04             	pushl  0x4(%eax)
80103ef6:	53                   	push   %ebx
80103ef7:	e8 97 0c 00 00       	call   80104b93 <swtch>
  mycpu()->intena = intena;
80103efc:	e8 df f9 ff ff       	call   801038e0 <mycpu>
}
...
80103f5a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103f5d:	e8 fe 07 00 00       	call   80104760 <pushcli>
  c = mycpu();
80103f62:	e8 79 f9 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103f67:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f6d:	e8 3e 08 00 00       	call   801047b0 <popcli>
  if(curproc == initproc)
80103f72:	8d 5e 2c             	lea    0x2c(%esi),%ebx
80103f75:	8d 7e 6c             	lea    0x6c(%esi),%edi
80103f78:	39 35 b8 a5 10 80    	cmp    %esi,0x8010a5b8
80103f7e:	0f 84 fd 00 00 00    	je     80104081 <exit+0x131>
...
80103f92:	e8 29 cf ff ff       	call   80100ec0 <fileclose>
      curproc->ofile[fd] = 0;
80103f97:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80103f9d:	83 c4 10             	add    $0x10,%esp
  for(fd = 0; fd < NOFILE; fd++){
80103fa0:	83 c3 04             	add    $0x4,%ebx
80103fa3:	39 df                	cmp    %ebx,%edi
80103fa5:	75 e1                	jne    80103f88 <exit+0x38>
  begin_op();
80103fa7:	e8 84 ed ff ff       	call   80102d30 <begin_op>
  iput(curproc->cwd);
80103fac:	83 ec 0c             	sub    $0xc,%esp
80103faf:	ff 76 6c             	pushl  0x6c(%esi)
80103fb2:	e8 d9 d8 ff ff       	call   80101890 <iput>
  end_op();
80103fb7:	e8 e4 ed ff ff       	call   80102da0 <end_op>
  curproc->cwd = 0;
80103fbc:	c7 46 6c 00 00 00 00 	movl   $0x0,0x6c(%esi)
  acquire(&ptable.lock);
80103fc3:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103fca:	e8 91 08 00 00       	call   80104860 <acquire>
  wakeup1(curproc->parent);
80103fcf:	8b 56 18             	mov    0x18(%esi),%edx
...
80103fda:	eb 10                	jmp    80103fec <exit+0x9c>
80103fdc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103fe0:	05 88 00 00 00       	add    $0x88,%eax
80103fe5:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103fea:	74 1e                	je     8010400a <exit+0xba>
    if(p->state == SLEEPING && p->chan == chan)
80103fec:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80103ff0:	75 ee                	jne    80103fe0 <exit+0x90>
80103ff2:	3b 50 24             	cmp    0x24(%eax),%edx
80103ff5:	75 e9                	jne    80103fe0 <exit+0x90>
      p->state = RUNNABLE;
80103ff7:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ffe:	05 88 00 00 00       	add    $0x88,%eax
80104003:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80104008:	75 e2                	jne    80103fec <exit+0x9c>
      p->parent = initproc;
8010400a:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104010:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80104015:	eb 17                	jmp    8010402e <exit+0xde>
80104017:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010401e:	66 90                	xchg   %ax,%ax
80104020:	81 c2 88 00 00 00    	add    $0x88,%edx
80104026:	81 fa 54 4f 11 80    	cmp    $0x80114f54,%edx
8010402c:	74 3a                	je     80104068 <exit+0x118>
    if(p->parent == curproc){
8010402e:	39 72 18             	cmp    %esi,0x18(%edx)
80104031:	75 ed                	jne    80104020 <exit+0xd0>
      if(p->state == ZOMBIE)
80104033:	83 7a 10 05          	cmpl   $0x5,0x10(%edx)
      p->parent = initproc;
80104037:	89 4a 18             	mov    %ecx,0x18(%edx)
      if(p->state == ZOMBIE)
8010403a:	75 e4                	jne    80104020 <exit+0xd0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010403c:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104041:	eb 11                	jmp    80104054 <exit+0x104>
80104043:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104047:	90                   	nop
80104048:	05 88 00 00 00       	add    $0x88,%eax
8010404d:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80104052:	74 cc                	je     80104020 <exit+0xd0>
    if(p->state == SLEEPING && p->chan == chan)
80104054:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80104058:	75 ee                	jne    80104048 <exit+0xf8>
8010405a:	3b 48 24             	cmp    0x24(%eax),%ecx
8010405d:	75 e9                	jne    80104048 <exit+0xf8>
      p->state = RUNNABLE;
8010405f:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
80104066:	eb e0                	jmp    80104048 <exit+0xf8>
  curproc->state = ZOMBIE;
80104068:	c7 46 10 05 00 00 00 	movl   $0x5,0x10(%esi)
  sched();
8010406f:	e8 1c fe ff ff       	call   80103e90 <sched>
  panic("zombie exit");
80104074:	83 ec 0c             	sub    $0xc,%esp
80104077:	68 eb 7a 10 80       	push   $0x80107aeb
8010407c:	e8 0f c3 ff ff       	call   80100390 <panic>
    panic("init exiting");
80104081:	83 ec 0c             	sub    $0xc,%esp
80104084:	68 de 7a 10 80       	push   $0x80107ade
80104089:	e8 02 c3 ff ff       	call   80100390 <panic>
...
801040a0:	e8 bb 07 00 00       	call   80104860 <acquire>
  pushcli();
801040a5:	e8 b6 06 00 00       	call   80104760 <pushcli>
  c = mycpu();
801040aa:	e8 31 f8 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
801040af:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040b5:	e8 f6 06 00 00       	call   801047b0 <popcli>
  myproc()->state = RUNNABLE;
801040ba:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  sched();
801040c1:	e8 ca fd ff ff       	call   80103e90 <sched>
  release(&ptable.lock);
801040c6:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801040cd:	e8 4e 08 00 00       	call   80104920 <release>
}
...
801040f0:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
801040f3:	e8 68 06 00 00       	call   80104760 <pushcli>
  c = mycpu();
801040f8:	e8 e3 f7 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
801040fd:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104103:	e8 a8 06 00 00       	call   801047b0 <popcli>
  if(p == 0)
...
80104114:	81 fe 20 2d 11 80    	cmp    $0x80112d20,%esi
8010411a:	74 4c                	je     80104168 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
8010411c:	83 ec 0c             	sub    $0xc,%esp
8010411f:	68 20 2d 11 80       	push   $0x80112d20
80104124:	e8 37 07 00 00       	call   80104860 <acquire>
    release(lk);
80104129:	89 34 24             	mov    %esi,(%esp)
8010412c:	e8 ef 07 00 00       	call   80104920 <release>
  p->chan = chan;
80104131:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80104134:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
8010413b:	e8 50 fd ff ff       	call   80103e90 <sched>
  p->chan = 0;
80104140:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
80104147:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010414e:	e8 cd 07 00 00       	call   80104920 <release>
    acquire(lk);
...
8010415f:	5d                   	pop    %ebp
    acquire(lk);
80104160:	e9 fb 06 00 00       	jmp    80104860 <acquire>
...
80104189:	68 fd 7a 10 80       	push   $0x80107afd
8010418e:	e8 fd c1 ff ff       	call   80100390 <panic>
    panic("sleep");
80104193:	83 ec 0c             	sub    $0xc,%esp
80104196:	68 f7 7a 10 80       	push   $0x80107af7
...
801041ad:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801041b0:	e8 ab 05 00 00       	call   80104760 <pushcli>
  c = mycpu();
801041b5:	e8 26 f7 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
801041ba:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
801041c0:	e8 eb 05 00 00       	call   801047b0 <popcli>
  acquire(&ptable.lock);
801041c5:	83 ec 0c             	sub    $0xc,%esp
801041c8:	68 20 2d 11 80       	push   $0x80112d20
801041cd:	e8 8e 06 00 00       	call   80104860 <acquire>
801041d2:	83 c4 10             	add    $0x10,%esp
    havekids=0;
801041d5:	31 c0                	xor    %eax,%eax
    for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
801041d7:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
801041dc:	eb 10                	jmp    801041ee <join+0x4e>
801041de:	66 90                	xchg   %ax,%ax
801041e0:	81 c3 88 00 00 00    	add    $0x88,%ebx
801041e6:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
801041ec:	74 32                	je     80104220 <join+0x80>
      if(p->tid != id || p->parent != cp ||  p->pgdir != p->parent->pgdir)
801041ee:	39 b3 80 00 00 00    	cmp    %esi,0x80(%ebx)
801041f4:	75 ea                	jne    801041e0 <join+0x40>
801041f6:	39 7b 18             	cmp    %edi,0x18(%ebx)
801041f9:	75 e5                	jne    801041e0 <join+0x40>
801041fb:	8b 57 04             	mov    0x4(%edi),%edx
801041fe:	39 53 04             	cmp    %edx,0x4(%ebx)
80104201:	75 dd                	jne    801041e0 <join+0x40>
      if(p->state==ZOMBIE){
80104203:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
80104207:	74 35                	je     8010423e <join+0x9e>
    for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
80104209:	81 c3 88 00 00 00    	add    $0x88,%ebx
      havekids=1;
8010420f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
80104214:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
8010421a:	75 d2                	jne    801041ee <join+0x4e>
8010421c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(!havekids || cp->killed){
80104220:	85 c0                	test   %eax,%eax
80104222:	74 76                	je     8010429a <join+0xfa>
80104224:	8b 47 28             	mov    0x28(%edi),%eax
80104227:	85 c0                	test   %eax,%eax
80104229:	75 6f                	jne    8010429a <join+0xfa>
    sleep(cp,&ptable.lock);
8010422b:	83 ec 08             	sub    $0x8,%esp
8010422e:	68 20 2d 11 80       	push   $0x80112d20
80104233:	57                   	push   %edi
80104234:	e8 a7 fe ff ff       	call   801040e0 <sleep>
    havekids=0;
80104239:	83 c4 10             	add    $0x10,%esp
8010423c:	eb 97                	jmp    801041d5 <join+0x35>
        kfree(p->kstack);
8010423e:	83 ec 0c             	sub    $0xc,%esp
80104241:	ff 73 08             	pushl  0x8(%ebx)
80104244:	e8 27 e2 ff ff       	call   80102470 <kfree>
        p->kstack=0;
80104249:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        p->tid=0;
80104250:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
80104257:	00 00 00 
        p->pid=0;
8010425a:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent=0;
80104261:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0]=0;
80104268:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed=0;
...
8010427a:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104281:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104288:	e8 93 06 00 00       	call   80104920 <release>
        return 0;
...
801042a2:	e8 79 06 00 00       	call   80104920 <release>
      return -1;
801042a7:	83 c4 10             	add    $0x10,%esp
}
801042aa:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
...
801042c8:	53                   	push   %ebx
  pushcli();
801042c9:	e8 92 04 00 00       	call   80104760 <pushcli>
  c = mycpu();
801042ce:	e8 0d f6 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
801042d3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801042d9:	e8 d2 04 00 00       	call   801047b0 <popcli>
  acquire(&ptable.lock);
801042de:	83 ec 0c             	sub    $0xc,%esp
801042e1:	68 20 2d 11 80       	push   $0x80112d20
801042e6:	e8 75 05 00 00       	call   80104860 <acquire>
801042eb:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
801042ee:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042f0:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
...
80104340:	e8 9b fd ff ff       	call   801040e0 <sleep>
    havekids = 0;
...
80104353:	ff 73 08             	pushl  0x8(%ebx)
        pid = p->pid;
80104356:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
...
80104362:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104369:	e8 52 2e 00 00       	call   801071c0 <freevm>
        release(&ptable.lock);
8010436e:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
80104375:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
8010437c:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
80104383:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80104387:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
8010438e:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        release(&ptable.lock);
80104395:	e8 86 05 00 00       	call   80104920 <release>
        return pid;
...
801043a9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801043ae:	68 20 2d 11 80       	push   $0x80112d20
801043b3:	e8 68 05 00 00       	call   80104920 <release>
      return -1;
...
801043d3:	e8 88 04 00 00       	call   80104860 <acquire>
...
801043e8:	05 88 00 00 00       	add    $0x88,%eax
801043ed:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
801043f2:	74 1e                	je     80104412 <wakeup+0x52>
    if(p->state == SLEEPING && p->chan == chan)
801043f4:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
801043f8:	75 ee                	jne    801043e8 <wakeup+0x28>
801043fa:	3b 58 24             	cmp    0x24(%eax),%ebx
801043fd:	75 e9                	jne    801043e8 <wakeup+0x28>
      p->state = RUNNABLE;
801043ff:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104406:	05 88 00 00 00       	add    $0x88,%eax
8010440b:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80104410:	75 e2                	jne    801043f4 <wakeup+0x34>
  wakeup1(chan);
  release(&ptable.lock);
80104412:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80104419:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010441c:	c9                   	leave  
  release(&ptable.lock);
8010441d:	e9 fe 04 00 00       	jmp    80104920 <release>
...
80104443:	e8 18 04 00 00       	call   80104860 <acquire>
80104448:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010444b:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104450:	eb 12                	jmp    80104464 <kill+0x34>
80104452:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104458:	05 88 00 00 00       	add    $0x88,%eax
8010445d:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80104462:	74 34                	je     80104498 <kill+0x68>
    if(p->pid == pid){
80104464:	39 58 14             	cmp    %ebx,0x14(%eax)
80104467:	75 ef                	jne    80104458 <kill+0x28>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104469:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
      p->killed = 1;
8010446d:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
80104474:	75 07                	jne    8010447d <kill+0x4d>
        p->state = RUNNABLE;
80104476:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
      release(&ptable.lock);
8010447d:	83 ec 0c             	sub    $0xc,%esp
80104480:	68 20 2d 11 80       	push   $0x80112d20
80104485:	e8 96 04 00 00       	call   80104920 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801044a0:	e8 7b 04 00 00       	call   80104920 <release>
}
...
801044cd:	bb c4 2d 11 80       	mov    $0x80112dc4,%ebx
...
801044e3:	68 83 7e 10 80       	push   $0x80107e83
801044e8:	e8 c3 c1 ff ff       	call   801006b0 <cprintf>
801044ed:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801044f0:	81 c3 88 00 00 00    	add    $0x88,%ebx
801044f6:	81 fb c4 4f 11 80    	cmp    $0x80114fc4,%ebx
...
80104507:	74 e7                	je     801044f0 <procdump+0x30>
      state = "???";
80104509:	ba 0e 7b 10 80       	mov    $0x80107b0e,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010450e:	83 f8 05             	cmp    $0x5,%eax
80104511:	77 11                	ja     80104524 <procdump+0x64>
80104513:	8b 14 85 70 7b 10 80 	mov    -0x7fef8490(,%eax,4),%edx
      state = "???";
8010451a:	b8 0e 7b 10 80       	mov    $0x80107b0e,%eax
...
80104529:	68 12 7b 10 80       	push   $0x80107b12
...
80104550:	e8 ab 01 00 00       	call   80104700 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80104571:	68 21 75 10 80       	push   $0x80107521
...
801045ae:	68 88 7b 10 80       	push   $0x80107b88
801045b3:	8d 43 04             	lea    0x4(%ebx),%eax
801045b6:	50                   	push   %eax
801045b7:	e8 24 01 00 00       	call   801046e0 <initlock>
  lk->name = name;
...
801045c5:	83 c4 10             	add    $0x10,%esp
  lk->pid = 0;
801045c8:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  lk->name = name;
801045cf:	89 43 38             	mov    %eax,0x38(%ebx)
}
...
801045f3:	e8 68 02 00 00       	call   80104860 <acquire>
  while (lk->locked) {
801045f8:	8b 13                	mov    (%ebx),%edx
801045fa:	83 c4 10             	add    $0x10,%esp
801045fd:	85 d2                	test   %edx,%edx
801045ff:	74 1a                	je     8010461b <acquiresleep+0x3b>
80104601:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    sleep(lk, &lk->lk);
80104608:	83 ec 08             	sub    $0x8,%esp
8010460b:	56                   	push   %esi
8010460c:	53                   	push   %ebx
8010460d:	e8 ce fa ff ff       	call   801040e0 <sleep>
  while (lk->locked) {
80104612:	8b 03                	mov    (%ebx),%eax
80104614:	83 c4 10             	add    $0x10,%esp
80104617:	85 c0                	test   %eax,%eax
80104619:	75 ed                	jne    80104608 <acquiresleep+0x28>
  }
  lk->locked = 1;
8010461b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104621:	e8 4a f3 ff ff       	call   80103970 <myproc>
80104626:	8b 40 14             	mov    0x14(%eax),%eax
80104629:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
8010462c:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
80104634:	5d                   	pop    %ebp
  release(&lk->lk);
80104635:	e9 e6 02 00 00       	jmp    80104920 <release>
...
80104653:	e8 08 02 00 00       	call   80104860 <acquire>
  lk->locked = 0;
80104658:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
8010465e:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80104665:	89 1c 24             	mov    %ebx,(%esp)
80104668:	e8 53 fd ff ff       	call   801043c0 <wakeup>
  release(&lk->lk);
8010466d:	89 75 08             	mov    %esi,0x8(%ebp)
...
80104678:	5d                   	pop    %ebp
  release(&lk->lk);
80104679:	e9 a2 02 00 00       	jmp    80104920 <release>
...
80104688:	31 ff                	xor    %edi,%edi
8010468a:	56                   	push   %esi
8010468b:	53                   	push   %ebx
8010468c:	83 ec 18             	sub    $0x18,%esp
8010468f:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int r;
  
  acquire(&lk->lk);
80104692:	8d 73 04             	lea    0x4(%ebx),%esi
80104695:	56                   	push   %esi
80104696:	e8 c5 01 00 00       	call   80104860 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
8010469b:	8b 03                	mov    (%ebx),%eax
8010469d:	83 c4 10             	add    $0x10,%esp
801046a0:	85 c0                	test   %eax,%eax
801046a2:	75 1c                	jne    801046c0 <holdingsleep+0x40>
  release(&lk->lk);
801046a4:	83 ec 0c             	sub    $0xc,%esp
801046a7:	56                   	push   %esi
801046a8:	e8 73 02 00 00       	call   80104920 <release>
  return r;
}
801046ad:	8d 65 f4             	lea    -0xc(%ebp),%esp
801046b0:	89 f8                	mov    %edi,%eax
801046b2:	5b                   	pop    %ebx
801046b3:	5e                   	pop    %esi
801046b4:	5f                   	pop    %edi
801046b5:	5d                   	pop    %ebp
...
801046c3:	e8 a8 f2 ff ff       	call   80103970 <myproc>
801046c8:	39 58 14             	cmp    %ebx,0x14(%eax)
801046cb:	0f 94 c0             	sete   %al
801046ce:	0f b6 c0             	movzbl %al,%eax
801046d1:	89 c7                	mov    %eax,%edi
801046d3:	eb cf                	jmp    801046a4 <holdingsleep+0x24>
801046d5:	66 90                	xchg   %ax,%ax
...
{
8010470d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ebp = (uint*)v - 2;
80104710:	83 e8 08             	sub    $0x8,%eax
  for(i = 0; i < 10; i++){
...
80104724:	77 1a                	ja     80104740 <getcallerpcs+0x40>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104726:	8b 58 04             	mov    0x4(%eax),%ebx
80104729:	89 1c 91             	mov    %ebx,(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
8010472c:	83 c2 01             	add    $0x1,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
8010472f:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80104731:	83 fa 0a             	cmp    $0xa,%edx
80104734:	75 e2                	jne    80104718 <getcallerpcs+0x18>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
80104739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
80104740:	8d 04 91             	lea    (%ecx,%edx,4),%eax
80104743:	8d 51 28             	lea    0x28(%ecx),%edx
...
8010475b:	75 f3                	jne    80104750 <getcallerpcs+0x50>
}
8010475d:	5b                   	pop    %ebx
8010475e:	5d                   	pop    %ebp
8010475f:	c3                   	ret    
...
8010476d:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010476e:	e8 6d f1 ff ff       	call   801038e0 <mycpu>
80104773:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80104779:	85 c0                	test   %eax,%eax
8010477b:	74 13                	je     80104790 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
8010477d:	e8 5e f1 ff ff       	call   801038e0 <mycpu>
80104782:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
801047a1:	eb da                	jmp    8010477d <pushcli+0x1d>
...
801047bb:	58                   	pop    %eax
  if(readeflags()&FL_IF)
801047bc:	f6 c4 02             	test   $0x2,%ah
801047bf:	75 31                	jne    801047f2 <popcli+0x42>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
801047c1:	e8 1a f1 ff ff       	call   801038e0 <mycpu>
801047c6:	83 a8 a4 00 00 00 01 	subl   $0x1,0xa4(%eax)
801047cd:	78 30                	js     801047ff <popcli+0x4f>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
801047cf:	e8 0c f1 ff ff       	call   801038e0 <mycpu>
801047d4:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
801047da:	85 d2                	test   %edx,%edx
801047dc:	74 02                	je     801047e0 <popcli+0x30>
    sti();
}
801047de:	c9                   	leave  
801047df:	c3                   	ret    
  if(mycpu()->ncli == 0 && mycpu()->intena)
801047e0:	e8 fb f0 ff ff       	call   801038e0 <mycpu>
801047e5:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
801047eb:	85 c0                	test   %eax,%eax
801047ed:	74 ef                	je     801047de <popcli+0x2e>
  asm volatile("sti");
801047ef:	fb                   	sti    
}
801047f0:	c9                   	leave  
...
801047f5:	68 93 7b 10 80       	push   $0x80107b93
801047fa:	e8 91 bb ff ff       	call   80100390 <panic>
    panic("popcli");
801047ff:	83 ec 0c             	sub    $0xc,%esp
80104802:	68 aa 7b 10 80       	push   $0x80107baa
...
8010481c:	31 db                	xor    %ebx,%ebx
  pushcli();
8010481e:	e8 3d ff ff ff       	call   80104760 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104823:	8b 06                	mov    (%esi),%eax
80104825:	85 c0                	test   %eax,%eax
80104827:	75 0f                	jne    80104838 <holding+0x28>
  popcli();
80104829:	e8 82 ff ff ff       	call   801047b0 <popcli>
}
8010482e:	89 d8                	mov    %ebx,%eax
80104830:	5b                   	pop    %ebx
80104831:	5e                   	pop    %esi
80104832:	5d                   	pop    %ebp
80104833:	c3                   	ret    
80104834:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  r = lock->locked && lock->cpu == mycpu();
80104838:	8b 5e 08             	mov    0x8(%esi),%ebx
8010483b:	e8 a0 f0 ff ff       	call   801038e0 <mycpu>
80104840:	39 c3                	cmp    %eax,%ebx
80104842:	0f 94 c3             	sete   %bl
  popcli();
80104845:	e8 66 ff ff ff       	call   801047b0 <popcli>
  r = lock->locked && lock->cpu == mycpu();
8010484a:	0f b6 db             	movzbl %bl,%ebx
}
8010484d:	89 d8                	mov    %ebx,%eax
8010484f:	5b                   	pop    %ebx
80104850:	5e                   	pop    %esi
80104851:	5d                   	pop    %ebp
80104852:	c3                   	ret    
...
80104869:	e8 f2 fe ff ff       	call   80104760 <pushcli>
  if(holding(lk))
8010486e:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104871:	83 ec 0c             	sub    $0xc,%esp
80104874:	53                   	push   %ebx
80104875:	e8 96 ff ff ff       	call   80104810 <holding>
8010487a:	83 c4 10             	add    $0x10,%esp
8010487d:	85 c0                	test   %eax,%eax
8010487f:	0f 85 7f 00 00 00    	jne    80104904 <acquire+0xa4>
80104885:	89 c6                	mov    %eax,%esi
  asm volatile("lock; xchgl %0, %1" :
80104887:	ba 01 00 00 00       	mov    $0x1,%edx
8010488c:	eb 05                	jmp    80104893 <acquire+0x33>
...
801048a4:	e8 37 f0 ff ff       	call   801038e0 <mycpu>
801048a9:	89 43 08             	mov    %eax,0x8(%ebx)
  ebp = (uint*)v - 2;
801048ac:	89 e8                	mov    %ebp,%eax
801048ae:	66 90                	xchg   %ax,%ax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801048b0:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
801048b6:	81 fa fe ff ff 7f    	cmp    $0x7ffffffe,%edx
801048bc:	77 22                	ja     801048e0 <acquire+0x80>
    pcs[i] = ebp[1];     // saved %eip
801048be:	8b 50 04             	mov    0x4(%eax),%edx
801048c1:	89 54 b3 0c          	mov    %edx,0xc(%ebx,%esi,4)
  for(i = 0; i < 10; i++){
801048c5:	83 c6 01             	add    $0x1,%esi
    ebp = (uint*)ebp[0]; // saved %ebp
801048c8:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
801048ca:	83 fe 0a             	cmp    $0xa,%esi
...
801048dd:	8d 76 00             	lea    0x0(%esi),%esi
  for(; i < 10; i++)
801048e0:	8d 44 b3 0c          	lea    0xc(%ebx,%esi,4),%eax
801048e4:	83 c3 34             	add    $0x34,%ebx
...
80104907:	68 b1 7b 10 80       	push   $0x80107bb1
...
8010492f:	e8 dc fe ff ff       	call   80104810 <holding>
80104934:	83 c4 10             	add    $0x10,%esp
80104937:	85 c0                	test   %eax,%eax
80104939:	74 22                	je     8010495d <release+0x3d>
  lk->pcs[0] = 0;
8010493b:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104942:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104949:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
8010494e:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
80104954:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104957:	c9                   	leave  
  popcli();
80104958:	e9 53 fe ff ff       	jmp    801047b0 <popcli>
    panic("release");
8010495d:	83 ec 0c             	sub    $0xc,%esp
80104960:	68 b9 7b 10 80       	push   $0x80107bb9
80104965:	e8 26 ba ff ff       	call   80100390 <panic>
...
80104984:	09 cf                	or     %ecx,%edi
80104986:	83 e7 03             	and    $0x3,%edi
80104989:	75 25                	jne    801049b0 <memset+0x40>
    c &= 0xFF;
8010498b:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010498e:	c1 e0 18             	shl    $0x18,%eax
80104991:	89 fb                	mov    %edi,%ebx
80104993:	c1 e9 02             	shr    $0x2,%ecx
...
801049cb:	8b 55 08             	mov    0x8(%ebp),%edx
...
801049d4:	74 2a                	je     80104a00 <memcmp+0x40>
801049d6:	01 c6                	add    %eax,%esi
801049d8:	eb 10                	jmp    801049ea <memcmp+0x2a>
...
80104a1f:	8b 75 0c             	mov    0xc(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80104a22:	39 d6                	cmp    %edx,%esi
80104a24:	73 2a                	jae    80104a50 <memmove+0x40>
80104a26:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
80104a29:	39 fa                	cmp    %edi,%edx
80104a2b:	73 23                	jae    80104a50 <memmove+0x40>
80104a2d:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
80104a30:	85 c9                	test   %ecx,%ecx
80104a32:	74 13                	je     80104a47 <memmove+0x37>
80104a34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      *--d = *--s;
80104a38:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
80104a3c:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
80104a3f:	83 e8 01             	sub    $0x1,%eax
80104a42:	83 f8 ff             	cmp    $0xffffffff,%eax
...
80104a4d:	8d 76 00             	lea    0x0(%esi),%esi
    while(n-- > 0)
80104a50:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
80104a53:	89 d7                	mov    %edx,%edi
80104a55:	85 c9                	test   %ecx,%ecx
80104a57:	74 ee                	je     80104a47 <memmove+0x37>
80104a59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
80104a60:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
80104a61:	39 f0                	cmp    %esi,%eax
...
80104a88:	8b 75 10             	mov    0x10(%ebp),%esi
80104a8b:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104a8e:	53                   	push   %ebx
80104a8f:	8b 45 0c             	mov    0xc(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80104a92:	85 f6                	test   %esi,%esi
80104a94:	74 32                	je     80104ac8 <strncmp+0x48>
80104a96:	01 c6                	add    %eax,%esi
80104a98:	eb 14                	jmp    80104aae <strncmp+0x2e>
80104a9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104aa0:	38 da                	cmp    %bl,%dl
80104aa2:	75 14                	jne    80104ab8 <strncmp+0x38>
    n--, p++, q++;
80104aa4:	83 c0 01             	add    $0x1,%eax
80104aa7:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80104aaa:	39 f0                	cmp    %esi,%eax
80104aac:	74 1a                	je     80104ac8 <strncmp+0x48>
80104aae:	0f b6 11             	movzbl (%ecx),%edx
80104ab1:	0f b6 18             	movzbl (%eax),%ebx
80104ab4:	84 d2                	test   %dl,%dl
80104ab6:	75 e8                	jne    80104aa0 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104ab8:	0f b6 c2             	movzbl %dl,%eax
80104abb:	29 d8                	sub    %ebx,%eax
}
80104abd:	5b                   	pop    %ebx
80104abe:	5e                   	pop    %esi
80104abf:	5d                   	pop    %ebp
...
80104add:	8b 45 10             	mov    0x10(%ebp),%eax
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80104ae0:	89 f2                	mov    %esi,%edx
80104ae2:	eb 1b                	jmp    80104aff <strncpy+0x2f>
80104ae4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104ae8:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104aec:	8b 7d 0c             	mov    0xc(%ebp),%edi
80104aef:	83 c2 01             	add    $0x1,%edx
80104af2:	0f b6 7f ff          	movzbl -0x1(%edi),%edi
80104af6:	89 f9                	mov    %edi,%ecx
80104af8:	88 4a ff             	mov    %cl,-0x1(%edx)
80104afb:	84 c9                	test   %cl,%cl
80104afd:	74 09                	je     80104b08 <strncpy+0x38>
80104aff:	89 c3                	mov    %eax,%ebx
80104b01:	83 e8 01             	sub    $0x1,%eax
80104b04:	85 db                	test   %ebx,%ebx
80104b06:	7f e0                	jg     80104ae8 <strncpy+0x18>
    ;
  while(n-- > 0)
80104b08:	89 d1                	mov    %edx,%ecx
80104b0a:	85 c0                	test   %eax,%eax
80104b0c:	7e 15                	jle    80104b23 <strncpy+0x53>
80104b0e:	66 90                	xchg   %ax,%ax
    *s++ = 0;
80104b10:	83 c1 01             	add    $0x1,%ecx
80104b13:	c6 41 ff 00          	movb   $0x0,-0x1(%ecx)
  while(n-- > 0)
80104b17:	89 c8                	mov    %ecx,%eax
80104b19:	f7 d0                	not    %eax
80104b1b:	01 d0                	add    %edx,%eax
80104b1d:	01 d8                	add    %ebx,%eax
80104b1f:	85 c0                	test   %eax,%eax
80104b21:	7f ed                	jg     80104b10 <strncpy+0x40>
  return os;
}
80104b23:	5b                   	pop    %ebx
80104b24:	89 f0                	mov    %esi,%eax
80104b26:	5e                   	pop    %esi
80104b27:	5f                   	pop    %edi
80104b28:	5d                   	pop    %ebp
80104b29:	c3                   	ret    
...
80104b38:	8b 55 10             	mov    0x10(%ebp),%edx
80104b3b:	8b 75 08             	mov    0x8(%ebp),%esi
...
80104b44:	7e 21                	jle    80104b67 <safestrcpy+0x37>
80104b46:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
80104b4a:	89 f2                	mov    %esi,%edx
80104b4c:	eb 12                	jmp    80104b60 <safestrcpy+0x30>
...
80104b79:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
80104b7c:	80 3a 00             	cmpb   $0x0,(%edx)
80104b7f:	74 10                	je     80104b91 <strlen+0x21>
80104b81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104b88:	83 c0 01             	add    $0x1,%eax
80104b8b:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80104b8f:	75 f7                	jne    80104b88 <strlen+0x18>
    ;
  return n;
}
80104b91:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80104b93:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80104b97:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80104b9d:	56                   	push   %esi
  pushl %edi
80104b9e:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
80104b9f:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80104ba1:	89 d4                	mov    %edx,%esp
...
80104bbb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104bbe:	e8 ad ed ff ff       	call   80103970 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104bc3:	8b 00                	mov    (%eax),%eax
80104bc5:	39 d8                	cmp    %ebx,%eax
80104bc7:	76 17                	jbe    80104be0 <fetchint+0x30>
80104bc9:	8d 53 04             	lea    0x4(%ebx),%edx
80104bcc:	39 d0                	cmp    %edx,%eax
80104bce:	72 10                	jb     80104be0 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
80104bd0:	8b 45 0c             	mov    0xc(%ebp),%eax
80104bd3:	8b 13                	mov    (%ebx),%edx
80104bd5:	89 10                	mov    %edx,(%eax)
  return 0;
80104bd7:	31 c0                	xor    %eax,%eax
}
80104bd9:	83 c4 04             	add    $0x4,%esp
80104bdc:	5b                   	pop    %ebx
80104bdd:	5d                   	pop    %ebp
80104bde:	c3                   	ret    
80104bdf:	90                   	nop
...
80104be5:	eb f2                	jmp    80104bd9 <fetchint+0x29>
...
80104bfb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104bfe:	e8 6d ed ff ff       	call   80103970 <myproc>

  if(addr >= curproc->sz)
80104c03:	39 18                	cmp    %ebx,(%eax)
80104c05:	76 31                	jbe    80104c38 <fetchstr+0x48>
    return -1;
  *pp = (char*)addr;
...
80104c10:	73 26                	jae    80104c38 <fetchstr+0x48>
80104c12:	89 d8                	mov    %ebx,%eax
80104c14:	eb 11                	jmp    80104c27 <fetchstr+0x37>
...
80104c25:	76 11                	jbe    80104c38 <fetchstr+0x48>
    if(*s == 0)
...
80104c59:	e8 12 ed ff ff       	call   80103970 <myproc>
80104c5e:	8b 55 08             	mov    0x8(%ebp),%edx
80104c61:	8b 40 1c             	mov    0x1c(%eax),%eax
80104c64:	8b 40 44             	mov    0x44(%eax),%eax
80104c67:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104c6a:	e8 01 ed ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104c6f:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104c72:	8b 00                	mov    (%eax),%eax
80104c74:	39 c6                	cmp    %eax,%esi
80104c76:	73 18                	jae    80104c90 <argint+0x40>
80104c78:	8d 53 08             	lea    0x8(%ebx),%edx
80104c7b:	39 d0                	cmp    %edx,%eax
80104c7d:	72 11                	jb     80104c90 <argint+0x40>
  *ip = *(int*)(addr);
80104c7f:	8b 45 0c             	mov    0xc(%ebp),%eax
80104c82:	8b 53 04             	mov    0x4(%ebx),%edx
...
80104c90:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104c95:	eb f2                	jmp    80104c89 <argint+0x39>
...
80104cac:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104caf:	e8 bc ec ff ff       	call   80103970 <myproc>
 
  if(argint(n, &i) < 0)
80104cb4:	83 ec 08             	sub    $0x8,%esp
  struct proc *curproc = myproc();
80104cb7:	89 c6                	mov    %eax,%esi
  if(argint(n, &i) < 0)
80104cb9:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104cbc:	50                   	push   %eax
80104cbd:	ff 75 08             	pushl  0x8(%ebp)
80104cc0:	e8 8b ff ff ff       	call   80104c50 <argint>
    return -1;
...
80104cce:	78 20                	js     80104cf0 <argptr+0x50>
80104cd0:	8b 16                	mov    (%esi),%edx
80104cd2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cd5:	39 c2                	cmp    %eax,%edx
80104cd7:	76 17                	jbe    80104cf0 <argptr+0x50>
80104cd9:	01 c3                	add    %eax,%ebx
80104cdb:	39 da                	cmp    %ebx,%edx
80104cdd:	72 11                	jb     80104cf0 <argptr+0x50>
    return -1;
  *pp = (char*)i;
...
80104cf5:	eb ef                	jmp    80104ce6 <argptr+0x46>
...
80104d07:	83 ec 20             	sub    $0x20,%esp
  int addr;
  if(argint(n, &addr) < 0)
80104d0a:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104d0d:	50                   	push   %eax
80104d0e:	ff 75 08             	pushl  0x8(%ebp)
80104d11:	e8 3a ff ff ff       	call   80104c50 <argint>
80104d16:	83 c4 10             	add    $0x10,%esp
80104d19:	85 c0                	test   %eax,%eax
80104d1b:	78 13                	js     80104d30 <argstr+0x30>
    return -1;
  return fetchstr(addr, pp);
80104d1d:	83 ec 08             	sub    $0x8,%esp
80104d20:	ff 75 0c             	pushl  0xc(%ebp)
80104d23:	ff 75 f4             	pushl  -0xc(%ebp)
80104d26:	e8 c5 fe ff ff       	call   80104bf0 <fetchstr>
...
80104d48:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104d4b:	e8 20 ec ff ff       	call   80103970 <myproc>
80104d50:	89 c3                	mov    %eax,%ebx
...
80104d5b:	83 fa 17             	cmp    $0x17,%edx
80104d5e:	77 20                	ja     80104d80 <syscall+0x40>
80104d60:	8b 14 85 e0 7b 10 80 	mov    -0x7fef8420(,%eax,4),%edx
80104d67:	85 d2                	test   %edx,%edx
80104d69:	74 15                	je     80104d80 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
80104d6b:	ff d2                	call   *%edx
80104d6d:	89 c2                	mov    %eax,%edx
80104d6f:	8b 43 1c             	mov    0x1c(%ebx),%eax
80104d72:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104d80:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104d81:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104d84:	50                   	push   %eax
80104d85:	ff 73 14             	pushl  0x14(%ebx)
80104d88:	68 c1 7b 10 80       	push   $0x80107bc1
80104d8d:	e8 1e b9 ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
80104d92:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104dc7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104dca:	e8 81 d2 ff ff       	call   80102050 <nameiparent>
...
80104dec:	e8 bf ce ff ff       	call   80101cb0 <dirlookup>
...
80104dfe:	e8 fd cb ff ff       	call   80101a00 <iunlockput>
    ilock(ip);
80104e03:	89 34 24             	mov    %esi,(%esp)
80104e06:	e8 55 c9 ff ff       	call   80101760 <ilock>
...
80104e34:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104e36:	e8 c5 cb ff ff       	call   80101a00 <iunlockput>
    return 0;
...
80104e5a:	e8 81 c7 ff ff       	call   801015e0 <ialloc>
...
80104e91:	e8 0a c8 ff ff       	call   801016a0 <iupdate>
...
80104ea3:	ff 76 04             	pushl  0x4(%esi)
80104ea6:	57                   	push   %edi
80104ea7:	53                   	push   %ebx
80104ea8:	e8 c3 d0 ff ff       	call   80101f70 <dirlink>
...
80104eb8:	e8 43 cb ff ff       	call   80101a00 <iunlockput>
  return ip;
...
80104ed9:	e8 c2 c7 ff ff       	call   801016a0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104ede:	83 c4 0c             	add    $0xc,%esp
80104ee1:	ff 76 04             	pushl  0x4(%esi)
80104ee4:	68 60 7c 10 80       	push   $0x80107c60
80104ee9:	56                   	push   %esi
80104eea:	e8 81 d0 ff ff       	call   80101f70 <dirlink>
...
80104efc:	68 5f 7c 10 80       	push   $0x80107c5f
80104f01:	56                   	push   %esi
80104f02:	e8 69 d0 ff ff       	call   80101f70 <dirlink>
...
80104f11:	68 53 7c 10 80       	push   $0x80107c53
80104f16:	e8 75 b4 ff ff       	call   80100390 <panic>
...
80104f2f:	68 62 7c 10 80       	push   $0x80107c62
80104f34:	e8 57 b4 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104f39:	83 ec 0c             	sub    $0xc,%esp
80104f3c:	68 44 7c 10 80       	push   $0x80107c44
80104f41:	e8 4a b4 ff ff       	call   80100390 <panic>
...
80104f54:	89 d6                	mov    %edx,%esi
80104f56:	53                   	push   %ebx
80104f57:	89 c3                	mov    %eax,%ebx
  if(argint(n, &fd) < 0)
...
80104f62:	e8 e9 fc ff ff       	call   80104c50 <argint>
...
80104f74:	e8 f7 e9 ff ff       	call   80103970 <myproc>
...
80104faa:	53                   	push   %ebx
  if(argfd(0, 0, &f) < 0)
80104fab:	8d 55 f4             	lea    -0xc(%ebp),%edx
{
80104fae:	83 ec 10             	sub    $0x10,%esp
  if(argfd(0, 0, &f) < 0)
80104fb1:	e8 9a ff ff ff       	call   80104f50 <argfd.constprop.0>
80104fb6:	85 c0                	test   %eax,%eax
80104fb8:	78 1e                	js     80104fd8 <sys_dup+0x38>
  if((fd=fdalloc(f)) < 0)
80104fba:	8b 75 f4             	mov    -0xc(%ebp),%esi
  for(fd = 0; fd < NOFILE; fd++){
80104fbd:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104fbf:	e8 ac e9 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80104fc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80104fc8:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
80104fcc:	85 d2                	test   %edx,%edx
80104fce:	74 20                	je     80104ff0 <sys_dup+0x50>
  for(fd = 0; fd < NOFILE; fd++){
80104fd0:	83 c3 01             	add    $0x1,%ebx
80104fd3:	83 fb 10             	cmp    $0x10,%ebx
...
80104fed:	8d 76 00             	lea    0x0(%esi),%esi
      curproc->ofile[fd] = f;
80104ff0:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
80104ff4:	83 ec 0c             	sub    $0xc,%esp
80104ff7:	ff 75 f4             	pushl  -0xc(%ebp)
80104ffa:	e8 71 be ff ff       	call   80100e70 <filedup>
  return fd;
...
80105049:	e8 52 fc ff ff       	call   80104ca0 <argptr>
8010504e:	83 c4 10             	add    $0x10,%esp
80105051:	85 c0                	test   %eax,%eax
80105053:	78 1b                	js     80105070 <sys_read+0x60>
...
80105061:	e8 8a bf ff ff       	call   80100ff0 <fileread>
...
801050b9:	e8 e2 fb ff ff       	call   80104ca0 <argptr>
801050be:	83 c4 10             	add    $0x10,%esp
801050c1:	85 c0                	test   %eax,%eax
801050c3:	78 1b                	js     801050e0 <sys_write+0x60>
...
801050d1:	e8 ba bf ff ff       	call   80101090 <filewrite>
...
801050f7:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
801050fa:	8d 55 f4             	lea    -0xc(%ebp),%edx
801050fd:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105100:	e8 4b fe ff ff       	call   80104f50 <argfd.constprop.0>
80105105:	85 c0                	test   %eax,%eax
80105107:	78 27                	js     80105130 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80105109:	e8 62 e8 ff ff       	call   80103970 <myproc>
8010510e:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
80105111:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80105114:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
8010511b:	00 
  fileclose(f);
8010511c:	ff 75 f4             	pushl  -0xc(%ebp)
8010511f:	e8 9c bd ff ff       	call   80100ec0 <fileclose>
  return 0;
...
80105149:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
8010514c:	8d 55 f0             	lea    -0x10(%ebp),%edx
8010514f:	e8 fc fd ff ff       	call   80104f50 <argfd.constprop.0>
80105154:	85 c0                	test   %eax,%eax
80105156:	78 30                	js     80105188 <sys_fstat+0x48>
80105158:	83 ec 04             	sub    $0x4,%esp
8010515b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010515e:	6a 14                	push   $0x14
80105160:	50                   	push   %eax
80105161:	6a 01                	push   $0x1
80105163:	e8 38 fb ff ff       	call   80104ca0 <argptr>
80105168:	83 c4 10             	add    $0x10,%esp
8010516b:	85 c0                	test   %eax,%eax
8010516d:	78 19                	js     80105188 <sys_fstat+0x48>
  return filestat(f, st);
8010516f:	83 ec 08             	sub    $0x8,%esp
80105172:	ff 75 f4             	pushl  -0xc(%ebp)
80105175:	ff 75 f0             	pushl  -0x10(%ebp)
80105178:	e8 23 be ff ff       	call   80100fa0 <filestat>
...
80105199:	8d 45 d4             	lea    -0x2c(%ebp),%eax
{
8010519c:	53                   	push   %ebx
8010519d:	83 ec 34             	sub    $0x34,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
801051a0:	50                   	push   %eax
801051a1:	6a 00                	push   $0x0
801051a3:	e8 58 fb ff ff       	call   80104d00 <argstr>
801051a8:	83 c4 10             	add    $0x10,%esp
801051ab:	85 c0                	test   %eax,%eax
801051ad:	0f 88 ff 00 00 00    	js     801052b2 <sys_link+0x122>
801051b3:	83 ec 08             	sub    $0x8,%esp
801051b6:	8d 45 d0             	lea    -0x30(%ebp),%eax
801051b9:	50                   	push   %eax
801051ba:	6a 01                	push   $0x1
801051bc:	e8 3f fb ff ff       	call   80104d00 <argstr>
801051c1:	83 c4 10             	add    $0x10,%esp
801051c4:	85 c0                	test   %eax,%eax
801051c6:	0f 88 e6 00 00 00    	js     801052b2 <sys_link+0x122>
  begin_op();
801051cc:	e8 5f db ff ff       	call   80102d30 <begin_op>
  if((ip = namei(old)) == 0){
801051d1:	83 ec 0c             	sub    $0xc,%esp
801051d4:	ff 75 d4             	pushl  -0x2c(%ebp)
801051d7:	e8 54 ce ff ff       	call   80102030 <namei>
801051dc:	83 c4 10             	add    $0x10,%esp
801051df:	89 c3                	mov    %eax,%ebx
801051e1:	85 c0                	test   %eax,%eax
801051e3:	0f 84 e8 00 00 00    	je     801052d1 <sys_link+0x141>
  ilock(ip);
...
801051f5:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801051fa:	0f 84 b9 00 00 00    	je     801052b9 <sys_link+0x129>
  iupdate(ip);
80105200:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
80105203:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80105208:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
8010520b:	53                   	push   %ebx
8010520c:	e8 8f c4 ff ff       	call   801016a0 <iupdate>
  iunlock(ip);
80105211:	89 1c 24             	mov    %ebx,(%esp)
80105214:	e8 27 c6 ff ff       	call   80101840 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105219:	58                   	pop    %eax
8010521a:	5a                   	pop    %edx
8010521b:	57                   	push   %edi
8010521c:	ff 75 d0             	pushl  -0x30(%ebp)
8010521f:	e8 2c ce ff ff       	call   80102050 <nameiparent>
80105224:	83 c4 10             	add    $0x10,%esp
80105227:	89 c6                	mov    %eax,%esi
80105229:	85 c0                	test   %eax,%eax
8010522b:	74 5f                	je     8010528c <sys_link+0xfc>
  ilock(dp);
8010522d:	83 ec 0c             	sub    $0xc,%esp
80105230:	50                   	push   %eax
80105231:	e8 2a c5 ff ff       	call   80101760 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105236:	8b 03                	mov    (%ebx),%eax
80105238:	83 c4 10             	add    $0x10,%esp
8010523b:	39 06                	cmp    %eax,(%esi)
8010523d:	75 41                	jne    80105280 <sys_link+0xf0>
8010523f:	83 ec 04             	sub    $0x4,%esp
80105242:	ff 73 04             	pushl  0x4(%ebx)
80105245:	57                   	push   %edi
80105246:	56                   	push   %esi
80105247:	e8 24 cd ff ff       	call   80101f70 <dirlink>
8010524c:	83 c4 10             	add    $0x10,%esp
8010524f:	85 c0                	test   %eax,%eax
80105251:	78 2d                	js     80105280 <sys_link+0xf0>
  iunlockput(dp);
80105253:	83 ec 0c             	sub    $0xc,%esp
80105256:	56                   	push   %esi
80105257:	e8 a4 c7 ff ff       	call   80101a00 <iunlockput>
  iput(ip);
8010525c:	89 1c 24             	mov    %ebx,(%esp)
8010525f:	e8 2c c6 ff ff       	call   80101890 <iput>
  end_op();
80105264:	e8 37 db ff ff       	call   80102da0 <end_op>
  return 0;
...
80105284:	e8 77 c7 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
801052ed:	83 ec 54             	sub    $0x54,%esp
  if(argstr(0, &path) < 0)
801052f0:	50                   	push   %eax
801052f1:	6a 00                	push   $0x0
801052f3:	e8 08 fa ff ff       	call   80104d00 <argstr>
801052f8:	83 c4 10             	add    $0x10,%esp
801052fb:	85 c0                	test   %eax,%eax
801052fd:	0f 88 7d 01 00 00    	js     80105480 <sys_unlink+0x1a0>
  begin_op();
80105303:	e8 28 da ff ff       	call   80102d30 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105308:	8d 5d ca             	lea    -0x36(%ebp),%ebx
8010530b:	83 ec 08             	sub    $0x8,%esp
8010530e:	53                   	push   %ebx
8010530f:	ff 75 c0             	pushl  -0x40(%ebp)
80105312:	e8 39 cd ff ff       	call   80102050 <nameiparent>
80105317:	83 c4 10             	add    $0x10,%esp
8010531a:	89 c6                	mov    %eax,%esi
8010531c:	85 c0                	test   %eax,%eax
8010531e:	0f 84 66 01 00 00    	je     8010548a <sys_unlink+0x1aa>
  ilock(dp);
80105324:	83 ec 0c             	sub    $0xc,%esp
80105327:	50                   	push   %eax
80105328:	e8 33 c4 ff ff       	call   80101760 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010532d:	58                   	pop    %eax
8010532e:	5a                   	pop    %edx
8010532f:	68 60 7c 10 80       	push   $0x80107c60
80105334:	53                   	push   %ebx
80105335:	e8 56 c9 ff ff       	call   80101c90 <namecmp>
8010533a:	83 c4 10             	add    $0x10,%esp
8010533d:	85 c0                	test   %eax,%eax
8010533f:	0f 84 03 01 00 00    	je     80105448 <sys_unlink+0x168>
80105345:	83 ec 08             	sub    $0x8,%esp
80105348:	68 5f 7c 10 80       	push   $0x80107c5f
8010534d:	53                   	push   %ebx
8010534e:	e8 3d c9 ff ff       	call   80101c90 <namecmp>
80105353:	83 c4 10             	add    $0x10,%esp
80105356:	85 c0                	test   %eax,%eax
80105358:	0f 84 ea 00 00 00    	je     80105448 <sys_unlink+0x168>
...
80105367:	e8 44 c9 ff ff       	call   80101cb0 <dirlookup>
8010536c:	83 c4 10             	add    $0x10,%esp
8010536f:	89 c3                	mov    %eax,%ebx
80105371:	85 c0                	test   %eax,%eax
80105373:	0f 84 cf 00 00 00    	je     80105448 <sys_unlink+0x168>
  ilock(ip);
...
8010538a:	0f 8e 23 01 00 00    	jle    801054b3 <sys_unlink+0x1d3>
...
801053ae:	e8 ad c7 ff ff       	call   80101b60 <writei>
801053b3:	83 c4 20             	add    $0x20,%esp
801053b6:	83 f8 10             	cmp    $0x10,%eax
801053b9:	0f 85 e7 00 00 00    	jne    801054a6 <sys_unlink+0x1c6>
  if(ip->type == T_DIR){
801053bf:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801053c4:	0f 84 96 00 00 00    	je     80105460 <sys_unlink+0x180>
  iunlockput(dp);
801053ca:	83 ec 0c             	sub    $0xc,%esp
801053cd:	56                   	push   %esi
801053ce:	e8 2d c6 ff ff       	call   80101a00 <iunlockput>
  ip->nlink--;
801053d3:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801053d8:	89 1c 24             	mov    %ebx,(%esp)
801053db:	e8 c0 c2 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
801053e0:	89 1c 24             	mov    %ebx,(%esp)
801053e3:	e8 18 c6 ff ff       	call   80101a00 <iunlockput>
  end_op();
...
801053f2:	8d 65 f4             	lea    -0xc(%ebp),%esp
801053f5:	5b                   	pop    %ebx
801053f6:	5e                   	pop    %esi
801053f7:	5f                   	pop    %edi
801053f8:	5d                   	pop    %ebp
...
80105406:	ba 20 00 00 00       	mov    $0x20,%edx
8010540b:	eb 0b                	jmp    80105418 <sys_unlink+0x138>
8010540d:	8d 76 00             	lea    0x0(%esi),%esi
80105410:	83 c2 10             	add    $0x10,%edx
80105413:	39 53 58             	cmp    %edx,0x58(%ebx)
80105416:	76 82                	jbe    8010539a <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105418:	6a 10                	push   $0x10
8010541a:	52                   	push   %edx
8010541b:	57                   	push   %edi
8010541c:	53                   	push   %ebx
8010541d:	89 55 b4             	mov    %edx,-0x4c(%ebp)
80105420:	e8 3b c6 ff ff       	call   80101a60 <readi>
80105425:	83 c4 10             	add    $0x10,%esp
80105428:	8b 55 b4             	mov    -0x4c(%ebp),%edx
8010542b:	83 f8 10             	cmp    $0x10,%eax
8010542e:	75 69                	jne    80105499 <sys_unlink+0x1b9>
    if(de.inum != 0)
80105430:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80105435:	74 d9                	je     80105410 <sys_unlink+0x130>
    iunlockput(ip);
80105437:	83 ec 0c             	sub    $0xc,%esp
8010543a:	53                   	push   %ebx
8010543b:	e8 c0 c5 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
8010544c:	e8 af c5 ff ff       	call   80101a00 <iunlockput>
  end_op();
80105451:	e8 4a d9 ff ff       	call   80102da0 <end_op>
  return -1;
80105456:	83 c4 10             	add    $0x10,%esp
80105459:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010545e:	eb 92                	jmp    801053f2 <sys_unlink+0x112>
    iupdate(dp);
80105460:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
80105463:	66 83 6e 56 01       	subw   $0x1,0x56(%esi)
    iupdate(dp);
80105468:	56                   	push   %esi
80105469:	e8 32 c2 ff ff       	call   801016a0 <iupdate>
8010546e:	83 c4 10             	add    $0x10,%esp
80105471:	e9 54 ff ff ff       	jmp    801053ca <sys_unlink+0xea>
...
80105485:	e9 68 ff ff ff       	jmp    801053f2 <sys_unlink+0x112>
    end_op();
8010548a:	e8 11 d9 ff ff       	call   80102da0 <end_op>
    return -1;
8010548f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105494:	e9 59 ff ff ff       	jmp    801053f2 <sys_unlink+0x112>
      panic("isdirempty: readi");
80105499:	83 ec 0c             	sub    $0xc,%esp
8010549c:	68 84 7c 10 80       	push   $0x80107c84
801054a1:	e8 ea ae ff ff       	call   80100390 <panic>
    panic("unlink: writei");
801054a6:	83 ec 0c             	sub    $0xc,%esp
801054a9:	68 96 7c 10 80       	push   $0x80107c96
801054ae:	e8 dd ae ff ff       	call   80100390 <panic>
    panic("unlink: nlink < 1");
801054b3:	83 ec 0c             	sub    $0xc,%esp
801054b6:	68 72 7c 10 80       	push   $0x80107c72
801054bb:	e8 d0 ae ff ff       	call   80100390 <panic>
...
801054c9:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
801054cc:	53                   	push   %ebx
801054cd:	83 ec 24             	sub    $0x24,%esp
  if(argstr(0, &path) < 0 || argint(1, &omode) < 0)
801054d0:	50                   	push   %eax
801054d1:	6a 00                	push   $0x0
801054d3:	e8 28 f8 ff ff       	call   80104d00 <argstr>
801054d8:	83 c4 10             	add    $0x10,%esp
801054db:	85 c0                	test   %eax,%eax
801054dd:	0f 88 8a 00 00 00    	js     8010556d <sys_open+0xad>
801054e3:	83 ec 08             	sub    $0x8,%esp
801054e6:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801054e9:	50                   	push   %eax
801054ea:	6a 01                	push   $0x1
801054ec:	e8 5f f7 ff ff       	call   80104c50 <argint>
801054f1:	83 c4 10             	add    $0x10,%esp
801054f4:	85 c0                	test   %eax,%eax
801054f6:	78 75                	js     8010556d <sys_open+0xad>
    return -1;

  begin_op();
801054f8:	e8 33 d8 ff ff       	call   80102d30 <begin_op>

  if(omode & O_CREATE){
801054fd:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105501:	75 75                	jne    80105578 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80105506:	ff 75 e0             	pushl  -0x20(%ebp)
80105509:	e8 22 cb ff ff       	call   80102030 <namei>
8010550e:	83 c4 10             	add    $0x10,%esp
80105511:	89 c6                	mov    %eax,%esi
80105513:	85 c0                	test   %eax,%eax
80105515:	74 7e                	je     80105595 <sys_open+0xd5>
      end_op();
      return -1;
    }
    ilock(ip);
...
8010551b:	e8 40 c2 ff ff       	call   80101760 <ilock>
...
8010552e:	e8 cd b8 ff ff       	call   80100e00 <filealloc>
...
8010553e:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
80105540:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
80105554:	e8 67 b9 ff ff       	call   80100ec0 <fileclose>
80105559:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010555c:	83 ec 0c             	sub    $0xc,%esp
8010555f:	56                   	push   %esi
80105560:	e8 9b c4 ff ff       	call   80101a00 <iunlockput>
    end_op();
...
80105587:	e8 24 f8 ff ff       	call   80104db0 <create>
    if(ip == 0){
...
801055a8:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801055ab:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
801055af:	56                   	push   %esi
801055b0:	e8 8b c2 ff ff       	call   80101840 <iunlock>
  end_op();
801055b5:	e8 e6 d7 ff ff       	call   80102da0 <end_op>
...
80105612:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105615:	50                   	push   %eax
80105616:	6a 00                	push   $0x0
80105618:	e8 e3 f6 ff ff       	call   80104d00 <argstr>
8010561d:	83 c4 10             	add    $0x10,%esp
80105620:	85 c0                	test   %eax,%eax
80105622:	78 34                	js     80105658 <sys_mkdir+0x58>
80105624:	83 ec 0c             	sub    $0xc,%esp
80105627:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010562a:	31 c9                	xor    %ecx,%ecx
8010562c:	ba 01 00 00 00       	mov    $0x1,%edx
80105631:	6a 00                	push   $0x0
80105633:	e8 78 f7 ff ff       	call   80104db0 <create>
80105638:	83 c4 10             	add    $0x10,%esp
8010563b:	85 c0                	test   %eax,%eax
8010563d:	74 19                	je     80105658 <sys_mkdir+0x58>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80105643:	e8 b8 c3 ff ff       	call   80101a00 <iunlockput>
  end_op();
...
80105682:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105685:	50                   	push   %eax
80105686:	6a 00                	push   $0x0
80105688:	e8 73 f6 ff ff       	call   80104d00 <argstr>
8010568d:	83 c4 10             	add    $0x10,%esp
80105690:	85 c0                	test   %eax,%eax
80105692:	78 64                	js     801056f8 <sys_mknod+0x88>
     argint(1, &major) < 0 ||
80105694:	83 ec 08             	sub    $0x8,%esp
80105697:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010569a:	50                   	push   %eax
8010569b:	6a 01                	push   $0x1
8010569d:	e8 ae f5 ff ff       	call   80104c50 <argint>
  if((argstr(0, &path)) < 0 ||
801056a2:	83 c4 10             	add    $0x10,%esp
801056a5:	85 c0                	test   %eax,%eax
801056a7:	78 4f                	js     801056f8 <sys_mknod+0x88>
     argint(2, &minor) < 0 ||
801056a9:	83 ec 08             	sub    $0x8,%esp
801056ac:	8d 45 f4             	lea    -0xc(%ebp),%eax
801056af:	50                   	push   %eax
801056b0:	6a 02                	push   $0x2
801056b2:	e8 99 f5 ff ff       	call   80104c50 <argint>
     argint(1, &major) < 0 ||
801056b7:	83 c4 10             	add    $0x10,%esp
801056ba:	85 c0                	test   %eax,%eax
801056bc:	78 3a                	js     801056f8 <sys_mknod+0x88>
     (ip = create(path, T_DEV, major, minor)) == 0){
801056be:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
801056c2:	83 ec 0c             	sub    $0xc,%esp
801056c5:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
801056c9:	ba 03 00 00 00       	mov    $0x3,%edx
801056ce:	50                   	push   %eax
801056cf:	8b 45 ec             	mov    -0x14(%ebp),%eax
801056d2:	e8 d9 f6 ff ff       	call   80104db0 <create>
     argint(2, &minor) < 0 ||
801056d7:	83 c4 10             	add    $0x10,%esp
801056da:	85 c0                	test   %eax,%eax
801056dc:	74 1a                	je     801056f8 <sys_mknod+0x88>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
801056e2:	e8 19 c3 ff ff       	call   80101a00 <iunlockput>
  end_op();
801056e7:	e8 b4 d6 ff ff       	call   80102da0 <end_op>
  return 0;
...
80105719:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010571c:	e8 4f e2 ff ff       	call   80103970 <myproc>
...
80105755:	e8 06 c0 ff ff       	call   80101760 <ilock>
  if(ip->type != T_DIR){
8010575a:	83 c4 10             	add    $0x10,%esp
8010575d:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105762:	75 2c                	jne    80105790 <sys_chdir+0x80>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80105768:	e8 d3 c0 ff ff       	call   80101840 <iunlock>
  iput(curproc->cwd);
8010576d:	58                   	pop    %eax
8010576e:	ff 76 6c             	pushl  0x6c(%esi)
80105771:	e8 1a c1 ff ff       	call   80101890 <iput>
  end_op();
80105776:	e8 25 d6 ff ff       	call   80102da0 <end_op>
  curproc->cwd = ip;
8010577b:	89 5e 6c             	mov    %ebx,0x6c(%esi)
  return 0;
8010577e:	83 c4 10             	add    $0x10,%esp
80105781:	31 c0                	xor    %eax,%eax
}
80105783:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105786:	5b                   	pop    %ebx
80105787:	5e                   	pop    %esi
80105788:	5d                   	pop    %ebp
80105789:	c3                   	ret    
...
80105794:	e8 67 c2 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105799:	e8 02 d6 ff ff       	call   80102da0 <end_op>
    return -1;
8010579e:	83 c4 10             	add    $0x10,%esp
801057a1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057a6:	eb db                	jmp    80105783 <sys_chdir+0x73>
801057a8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801057af:	90                   	nop
    end_op();
801057b0:	e8 eb d5 ff ff       	call   80102da0 <end_op>
    return -1;
801057b5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057ba:	eb c7                	jmp    80105783 <sys_chdir+0x73>
...
801057c9:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
{
801057cf:	53                   	push   %ebx
801057d0:	81 ec a4 00 00 00    	sub    $0xa4,%esp
  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
801057d6:	50                   	push   %eax
801057d7:	6a 00                	push   $0x0
801057d9:	e8 22 f5 ff ff       	call   80104d00 <argstr>
801057de:	83 c4 10             	add    $0x10,%esp
801057e1:	85 c0                	test   %eax,%eax
801057e3:	0f 88 8b 00 00 00    	js     80105874 <sys_exec+0xb4>
801057e9:	83 ec 08             	sub    $0x8,%esp
801057ec:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
801057f2:	50                   	push   %eax
801057f3:	6a 01                	push   $0x1
801057f5:	e8 56 f4 ff ff       	call   80104c50 <argint>
801057fa:	83 c4 10             	add    $0x10,%esp
801057fd:	85 c0                	test   %eax,%eax
801057ff:	78 73                	js     80105874 <sys_exec+0xb4>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105801:	83 ec 04             	sub    $0x4,%esp
80105804:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for(i=0;; i++){
8010580a:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
8010580c:	68 80 00 00 00       	push   $0x80
80105811:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105817:	6a 00                	push   $0x0
80105819:	50                   	push   %eax
8010581a:	e8 51 f1 ff ff       	call   80104970 <memset>
8010581f:	83 c4 10             	add    $0x10,%esp
80105822:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105828:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
8010582e:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
80105835:	83 ec 08             	sub    $0x8,%esp
80105838:	57                   	push   %edi
80105839:	01 f0                	add    %esi,%eax
8010583b:	50                   	push   %eax
8010583c:	e8 6f f3 ff ff       	call   80104bb0 <fetchint>
80105841:	83 c4 10             	add    $0x10,%esp
80105844:	85 c0                	test   %eax,%eax
80105846:	78 2c                	js     80105874 <sys_exec+0xb4>
      return -1;
    if(uarg == 0){
80105848:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
8010584e:	85 c0                	test   %eax,%eax
80105850:	74 36                	je     80105888 <sys_exec+0xc8>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80105852:	8d 8d 68 ff ff ff    	lea    -0x98(%ebp),%ecx
80105858:	83 ec 08             	sub    $0x8,%esp
8010585b:	8d 14 31             	lea    (%ecx,%esi,1),%edx
8010585e:	52                   	push   %edx
8010585f:	50                   	push   %eax
80105860:	e8 8b f3 ff ff       	call   80104bf0 <fetchstr>
80105865:	83 c4 10             	add    $0x10,%esp
80105868:	85 c0                	test   %eax,%eax
8010586a:	78 08                	js     80105874 <sys_exec+0xb4>
  for(i=0;; i++){
8010586c:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
8010586f:	83 fb 20             	cmp    $0x20,%ebx
80105872:	75 b4                	jne    80105828 <sys_exec+0x68>
      return -1;
  }
...
8010588b:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
      argv[i] = 0;
80105891:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
80105898:	00 00 00 00 
  return exec(path, argv);
8010589c:	50                   	push   %eax
8010589d:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
801058a3:	e8 d8 b1 ff ff       	call   80100a80 <exec>
...
80105951:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80105958:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
8010595c:	85 c9                	test   %ecx,%ecx
8010595e:	74 20                	je     80105980 <sys_pipe+0xc0>
  for(fd = 0; fd < NOFILE; fd++){
80105960:	83 c2 01             	add    $0x1,%edx
80105963:	83 fa 10             	cmp    $0x10,%edx
80105966:	75 f0                	jne    80105958 <sys_pipe+0x98>
      myproc()->ofile[fd0] = 0;
80105968:	e8 03 e0 ff ff       	call   80103970 <myproc>
8010596d:	c7 44 b0 0c 00 00 00 	movl   $0x0,0xc(%eax,%esi,4)
80105974:	00 
80105975:	eb a1                	jmp    80105918 <sys_pipe+0x58>
80105977:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010597e:	66 90                	xchg   %ax,%ax
      curproc->ofile[fd] = f;
80105980:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
  }
  fd[0] = fd0;
...
801059a0:	f3 0f 1e fb          	endbr32 
  return fork();
801059a4:	e9 77 e1 ff ff       	jmp    80103b20 <fork>
...
801059b7:	83 ec 08             	sub    $0x8,%esp
  exit();
801059ba:	e8 91 e5 ff ff       	call   80103f50 <exit>
...
801059d0:	f3 0f 1e fb          	endbr32 
  return wait();
801059d4:	e9 e7 e8 ff ff       	jmp    801042c0 <wait>
...
801059f0:	e8 5b f2 ff ff       	call   80104c50 <argint>
801059f5:	83 c4 10             	add    $0x10,%esp
801059f8:	85 c0                	test   %eax,%eax
801059fa:	78 14                	js     80105a10 <sys_kill+0x30>
    return -1;
  return kill(pid);
801059fc:	83 ec 0c             	sub    $0xc,%esp
801059ff:	ff 75 f4             	pushl  -0xc(%ebp)
80105a02:	e8 29 ea ff ff       	call   80104430 <kill>
...
80105a2f:	8b 40 14             	mov    0x14(%eax),%eax
}
80105a32:	c9                   	leave  
80105a33:	c3                   	ret    
...
80105a51:	e8 fa f1 ff ff       	call   80104c50 <argint>
80105a56:	83 c4 10             	add    $0x10,%esp
80105a59:	85 c0                	test   %eax,%eax
80105a5b:	78 23                	js     80105a80 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
...
80105a62:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105a65:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105a67:	ff 75 f4             	pushl  -0xc(%ebp)
80105a6a:	e8 31 e0 ff ff       	call   80103aa0 <growproc>
80105a6f:	83 c4 10             	add    $0x10,%esp
80105a72:	85 c0                	test   %eax,%eax
80105a74:	78 0a                	js     80105a80 <sys_sbrk+0x40>
    return -1;
  return addr;
}
...
80105a85:	eb ef                	jmp    80105a76 <sys_sbrk+0x36>
...
80105aa1:	e8 aa f1 ff ff       	call   80104c50 <argint>
80105aa6:	83 c4 10             	add    $0x10,%esp
80105aa9:	85 c0                	test   %eax,%eax
80105aab:	0f 88 86 00 00 00    	js     80105b37 <sys_sleep+0xa7>
    return -1;
  acquire(&tickslock);
80105ab1:	83 ec 0c             	sub    $0xc,%esp
80105ab4:	68 60 4f 11 80       	push   $0x80114f60
80105ab9:	e8 a2 ed ff ff       	call   80104860 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105abe:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105ac1:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  while(ticks - ticks0 < n){
80105ac7:	83 c4 10             	add    $0x10,%esp
80105aca:	85 d2                	test   %edx,%edx
80105acc:	75 23                	jne    80105af1 <sys_sleep+0x61>
80105ace:	eb 50                	jmp    80105b20 <sys_sleep+0x90>
    if(myproc()->killed){
      release(&tickslock);
      return -1;
    }
...
80105ad8:	68 a0 57 11 80       	push   $0x801157a0
80105add:	e8 fe e5 ff ff       	call   801040e0 <sleep>
  while(ticks - ticks0 < n){
80105ae2:	a1 a0 57 11 80       	mov    0x801157a0,%eax
...
80105b00:	68 60 4f 11 80       	push   $0x80114f60
80105b05:	e8 16 ee ff ff       	call   80104920 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105b23:	68 60 4f 11 80       	push   $0x80114f60
...
80105b48:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105b4b:	68 60 4f 11 80       	push   $0x80114f60
80105b50:	e8 0b ed ff ff       	call   80104860 <acquire>
  xticks = ticks;
80105b55:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  release(&tickslock);
80105b5b:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
80105b62:	e8 b9 ed ff ff       	call   80104920 <release>
  return xticks;
}
80105b67:	89 d8                	mov    %ebx,%eax
80105b69:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105b6c:	c9                   	leave  
80105b6d:	c3                   	ret    
...
80105b7a:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105b7d:	50                   	push   %eax
80105b7e:	6a 00                	push   $0x0
80105b80:	e8 cb f0 ff ff       	call   80104c50 <argint>
80105b85:	83 c4 10             	add    $0x10,%esp
80105b88:	85 c0                	test   %eax,%eax
80105b8a:	78 5c                	js     80105be8 <sys_clone+0x78>
80105b8c:	83 ec 08             	sub    $0x8,%esp
80105b8f:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105b92:	50                   	push   %eax
80105b93:	6a 01                	push   $0x1
80105b95:	e8 b6 f0 ff ff       	call   80104c50 <argint>
80105b9a:	83 c4 10             	add    $0x10,%esp
80105b9d:	85 c0                	test   %eax,%eax
80105b9f:	78 47                	js     80105be8 <sys_clone+0x78>
80105ba1:	83 ec 08             	sub    $0x8,%esp
80105ba4:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105ba7:	50                   	push   %eax
80105ba8:	6a 02                	push   $0x2
80105baa:	e8 a1 f0 ff ff       	call   80104c50 <argint>
80105baf:	83 c4 10             	add    $0x10,%esp
80105bb2:	85 c0                	test   %eax,%eax
80105bb4:	78 32                	js     80105be8 <sys_clone+0x78>
80105bb6:	83 ec 08             	sub    $0x8,%esp
80105bb9:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105bbc:	50                   	push   %eax
80105bbd:	6a 03                	push   $0x3
80105bbf:	e8 8c f0 ff ff       	call   80104c50 <argint>
80105bc4:	83 c4 10             	add    $0x10,%esp
80105bc7:	85 c0                	test   %eax,%eax
80105bc9:	78 1d                	js     80105be8 <sys_clone+0x78>
    return -1;
  return clone((void *)fcn, (void *)arg1,(void *)arg2, (void *)stack);
80105bcb:	ff 75 f4             	pushl  -0xc(%ebp)
80105bce:	ff 75 f0             	pushl  -0x10(%ebp)
80105bd1:	ff 75 ec             	pushl  -0x14(%ebp)
80105bd4:	ff 75 e8             	pushl  -0x18(%ebp)
80105bd7:	e8 64 e0 ff ff       	call   80103c40 <clone>
...
80105c20:	89 45 f4             	mov    %eax,-0xc(%ebp)
  return join(arg1,retval);
80105c23:	e8 78 e5 ff ff       	call   801041a0 <join>
...
80105c50:	e8 fb ef ff ff       	call   80104c50 <argint>
80105c55:	89 45 f4             	mov    %eax,-0xc(%ebp)
  retval=(void*) int_retval;
  thread_exit(retval);
80105c58:	89 04 24             	mov    %eax,(%esp)
80105c5b:	e8 20 e1 ff ff       	call   80103d80 <thread_exit>
  return 0;
...
80105c65:	06                   	push   %es
  pushl %fs
80105c66:	0f a0                	push   %fs
  pushl %gs
80105c68:	0f a8                	push   %gs
  pushal
80105c6a:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105c6b:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105c6f:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105c71:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105c73:	54                   	push   %esp
  call trap
80105c74:	e8 c7 00 00 00       	call   80105d40 <trap>
  addl $4, %esp
80105c79:	83 c4 04             	add    $0x4,%esp
...
80105ca7:	c7 04 c5 a2 4f 11 80 	movl   $0x8e000008,-0x7feeb05e(,%eax,8)
80105cae:	08 00 00 8e 
80105cb2:	66 89 14 c5 a0 4f 11 	mov    %dx,-0x7feeb060(,%eax,8)
80105cb9:	80 
80105cba:	c1 ea 10             	shr    $0x10,%edx
80105cbd:	66 89 14 c5 a6 4f 11 	mov    %dx,-0x7feeb05a(,%eax,8)
80105cc4:	80 
  for(i = 0; i < 256; i++)
...
80105cd7:	c7 05 a2 51 11 80 08 	movl   $0xef000008,0x801151a2
80105cde:	00 00 ef 
  initlock(&tickslock, "time");
80105ce1:	68 a5 7c 10 80       	push   $0x80107ca5
80105ce6:	68 60 4f 11 80       	push   $0x80114f60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ceb:	66 a3 a0 51 11 80    	mov    %ax,0x801151a0
80105cf1:	c1 e8 10             	shr    $0x10,%eax
80105cf4:	66 a3 a6 51 11 80    	mov    %ax,0x801151a6
  initlock(&tickslock, "time");
...
80105d14:	55                   	push   %ebp
  pd[0] = size-1;
80105d15:	b8 ff 07 00 00       	mov    $0x7ff,%eax
80105d1a:	89 e5                	mov    %esp,%ebp
80105d1c:	83 ec 10             	sub    $0x10,%esp
80105d1f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105d23:	b8 a0 4f 11 80       	mov    $0x80114fa0,%eax
80105d28:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80105d2c:	c1 e8 10             	shr    $0x10,%eax
80105d2f:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80105d33:	8d 45 fa             	lea    -0x6(%ebp),%eax
80105d36:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80105d39:	c9                   	leave  
80105d3a:	c3                   	ret    
...
80105d4d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80105d50:	8b 43 30             	mov    0x30(%ebx),%eax
80105d53:	83 f8 40             	cmp    $0x40,%eax
80105d56:	0f 84 bc 01 00 00    	je     80105f18 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80105d5c:	83 e8 20             	sub    $0x20,%eax
80105d5f:	83 f8 1f             	cmp    $0x1f,%eax
80105d62:	77 08                	ja     80105d6c <trap+0x2c>
80105d64:	3e ff 24 85 4c 7d 10 	notrack jmp *-0x7fef82b4(,%eax,4)
80105d6b:	80 
    lapiceoi();
    break;
...
80105d6c:	e8 ff db ff ff       	call   80103970 <myproc>
80105d71:	8b 7b 38             	mov    0x38(%ebx),%edi
80105d74:	85 c0                	test   %eax,%eax
80105d76:	0f 84 eb 01 00 00    	je     80105f67 <trap+0x227>
80105d7c:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105d80:	0f 84 e1 01 00 00    	je     80105f67 <trap+0x227>
...
80105d86:	0f 20 d1             	mov    %cr2,%ecx
80105d89:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
80105d8c:	e8 bf db ff ff       	call   80103950 <cpuid>
80105d91:	8b 73 30             	mov    0x30(%ebx),%esi
80105d94:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105d97:	8b 43 34             	mov    0x34(%ebx),%eax
80105d9a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105d9d:	e8 ce db ff ff       	call   80103970 <myproc>
80105da2:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105da5:	e8 c6 db ff ff       	call   80103970 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105daa:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105dad:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105db0:	51                   	push   %ecx
80105db1:	57                   	push   %edi
80105db2:	52                   	push   %edx
80105db3:	ff 75 e4             	pushl  -0x1c(%ebp)
80105db6:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105db7:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105dba:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105dbd:	56                   	push   %esi
80105dbe:	ff 70 14             	pushl  0x14(%eax)
80105dc1:	68 08 7d 10 80       	push   $0x80107d08
80105dc6:	e8 e5 a8 ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105dcb:	83 c4 20             	add    $0x20,%esp
80105dce:	e8 9d db ff ff       	call   80103970 <myproc>
80105dd3:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  }
...
80105e07:	74 0f                	je     80105e18 <trap+0xd8>
80105e09:	e8 62 db ff ff       	call   80103970 <myproc>
80105e0e:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
80105e12:	0f 84 e8 00 00 00    	je     80105f00 <trap+0x1c0>
...
80105e45:	c3                   	ret    
    ideintr();
80105e46:	e8 95 c3 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105e4b:	e8 70 ca ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e50:	e8 1b db ff ff       	call   80103970 <myproc>
80105e55:	85 c0                	test   %eax,%eax
80105e57:	75 8a                	jne    80105de3 <trap+0xa3>
80105e59:	eb a5                	jmp    80105e00 <trap+0xc0>
    if(cpuid() == 0){
80105e5b:	e8 f0 da ff ff       	call   80103950 <cpuid>
80105e60:	85 c0                	test   %eax,%eax
80105e62:	75 e7                	jne    80105e4b <trap+0x10b>
      acquire(&tickslock);
80105e64:	83 ec 0c             	sub    $0xc,%esp
80105e67:	68 60 4f 11 80       	push   $0x80114f60
80105e6c:	e8 ef e9 ff ff       	call   80104860 <acquire>
      wakeup(&ticks);
80105e71:	c7 04 24 a0 57 11 80 	movl   $0x801157a0,(%esp)
      ticks++;
80105e78:	83 05 a0 57 11 80 01 	addl   $0x1,0x801157a0
      wakeup(&ticks);
80105e7f:	e8 3c e5 ff ff       	call   801043c0 <wakeup>
      release(&tickslock);
80105e84:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
80105e8b:	e8 90 ea ff ff       	call   80104920 <release>
80105e90:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105e93:	eb b6                	jmp    80105e4b <trap+0x10b>
    kbdintr();
80105e95:	e8 e6 c8 ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105e9a:	e8 21 ca ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e9f:	e8 cc da ff ff       	call   80103970 <myproc>
80105ea4:	85 c0                	test   %eax,%eax
80105ea6:	0f 85 37 ff ff ff    	jne    80105de3 <trap+0xa3>
80105eac:	e9 4f ff ff ff       	jmp    80105e00 <trap+0xc0>
    uartintr();
80105eb1:	e8 4a 02 00 00       	call   80106100 <uartintr>
    lapiceoi();
80105eb6:	e8 05 ca ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ebb:	e8 b0 da ff ff       	call   80103970 <myproc>
80105ec0:	85 c0                	test   %eax,%eax
80105ec2:	0f 85 1b ff ff ff    	jne    80105de3 <trap+0xa3>
80105ec8:	e9 33 ff ff ff       	jmp    80105e00 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105ecd:	8b 7b 38             	mov    0x38(%ebx),%edi
80105ed0:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105ed4:	e8 77 da ff ff       	call   80103950 <cpuid>
80105ed9:	57                   	push   %edi
80105eda:	56                   	push   %esi
80105edb:	50                   	push   %eax
80105edc:	68 b0 7c 10 80       	push   $0x80107cb0
80105ee1:	e8 ca a7 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105ee6:	e8 d5 c9 ff ff       	call   801028c0 <lapiceoi>
    break;
80105eeb:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105eee:	e8 7d da ff ff       	call   80103970 <myproc>
80105ef3:	85 c0                	test   %eax,%eax
80105ef5:	0f 85 e8 fe ff ff    	jne    80105de3 <trap+0xa3>
80105efb:	e9 00 ff ff ff       	jmp    80105e00 <trap+0xc0>
  if(myproc() && myproc()->state == RUNNING &&
80105f00:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105f04:	0f 85 0e ff ff ff    	jne    80105e18 <trap+0xd8>
    yield();
80105f0a:	e8 81 e1 ff ff       	call   80104090 <yield>
80105f0f:	e9 04 ff ff ff       	jmp    80105e18 <trap+0xd8>
80105f14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105f18:	e8 53 da ff ff       	call   80103970 <myproc>
80105f1d:	8b 70 28             	mov    0x28(%eax),%esi
80105f20:	85 f6                	test   %esi,%esi
80105f22:	75 3c                	jne    80105f60 <trap+0x220>
    myproc()->tf = tf;
80105f24:	e8 47 da ff ff       	call   80103970 <myproc>
80105f29:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
80105f2c:	e8 0f ee ff ff       	call   80104d40 <syscall>
    if(myproc()->killed)
80105f31:	e8 3a da ff ff       	call   80103970 <myproc>
80105f36:	8b 48 28             	mov    0x28(%eax),%ecx
80105f39:	85 c9                	test   %ecx,%ecx
80105f3b:	0f 84 fd fe ff ff    	je     80105e3e <trap+0xfe>
}
...
80105f47:	5d                   	pop    %ebp
      exit();
80105f48:	e9 03 e0 ff ff       	jmp    80103f50 <exit>
80105f4d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105f50:	e8 fb df ff ff       	call   80103f50 <exit>
80105f55:	e9 a6 fe ff ff       	jmp    80105e00 <trap+0xc0>
80105f5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105f60:	e8 eb df ff ff       	call   80103f50 <exit>
80105f65:	eb bd                	jmp    80105f24 <trap+0x1e4>
80105f67:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105f6a:	e8 e1 d9 ff ff       	call   80103950 <cpuid>
80105f6f:	83 ec 0c             	sub    $0xc,%esp
80105f72:	56                   	push   %esi
80105f73:	57                   	push   %edi
80105f74:	50                   	push   %eax
80105f75:	ff 73 30             	pushl  0x30(%ebx)
80105f78:	68 d4 7c 10 80       	push   $0x80107cd4
80105f7d:	e8 2e a7 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105f82:	83 c4 14             	add    $0x14,%esp
80105f85:	68 aa 7c 10 80       	push   $0x80107caa
80105f8a:	e8 01 a4 ff ff       	call   80100390 <panic>
80105f8f:	90                   	nop
...
80105f90:	f3 0f 1e fb          	endbr32 
  if(!uart)
80105f94:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
80105f99:	85 c0                	test   %eax,%eax
80105f9b:	74 1b                	je     80105fb8 <uartgetc+0x28>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105f9d:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105fa2:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105fa3:	a8 01                	test   $0x1,%al
80105fa5:	74 11                	je     80105fb8 <uartgetc+0x28>
80105fa7:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105fac:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105fad:	0f b6 c0             	movzbl %al,%eax
80105fb0:	c3                   	ret    
...
80105fc4:	89 c7                	mov    %eax,%edi
80105fc6:	56                   	push   %esi
80105fc7:	be fd 03 00 00       	mov    $0x3fd,%esi
...
80105fe5:	e8 f6 c8 ff ff       	call   801028e0 <microdelay>
...
80106015:	31 c9                	xor    %ecx,%ecx
80106017:	89 c8                	mov    %ecx,%eax
80106019:	89 e5                	mov    %esp,%ebp
8010601b:	57                   	push   %edi
8010601c:	56                   	push   %esi
8010601d:	53                   	push   %ebx
8010601e:	bb fa 03 00 00       	mov    $0x3fa,%ebx
80106023:	89 da                	mov    %ebx,%edx
80106025:	83 ec 0c             	sub    $0xc,%esp
80106028:	ee                   	out    %al,(%dx)
80106029:	bf fb 03 00 00       	mov    $0x3fb,%edi
8010602e:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80106033:	89 fa                	mov    %edi,%edx
80106035:	ee                   	out    %al,(%dx)
80106036:	b8 0c 00 00 00       	mov    $0xc,%eax
8010603b:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106040:	ee                   	out    %al,(%dx)
80106041:	be f9 03 00 00       	mov    $0x3f9,%esi
80106046:	89 c8                	mov    %ecx,%eax
80106048:	89 f2                	mov    %esi,%edx
8010604a:	ee                   	out    %al,(%dx)
8010604b:	b8 03 00 00 00       	mov    $0x3,%eax
80106050:	89 fa                	mov    %edi,%edx
80106052:	ee                   	out    %al,(%dx)
80106053:	ba fc 03 00 00       	mov    $0x3fc,%edx
...
80106062:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106063:	ba fd 03 00 00       	mov    $0x3fd,%edx
80106068:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80106069:	3c ff                	cmp    $0xff,%al
8010606b:	74 52                	je     801060bf <uartinit+0xaf>
  uart = 1;
8010606d:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80106074:	00 00 00 
80106077:	89 da                	mov    %ebx,%edx
80106079:	ec                   	in     (%dx),%al
8010607a:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010607f:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80106080:	83 ec 08             	sub    $0x8,%esp
80106083:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80106088:	bb cc 7d 10 80       	mov    $0x80107dcc,%ebx
  ioapicenable(IRQ_COM1, 0);
8010608d:	6a 00                	push   $0x0
8010608f:	6a 04                	push   $0x4
80106091:	e8 9a c3 ff ff       	call   80102430 <ioapicenable>
80106096:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80106099:	b8 78 00 00 00       	mov    $0x78,%eax
8010609e:	eb 04                	jmp    801060a4 <uartinit+0x94>
801060a0:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
801060a4:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
801060aa:	85 d2                	test   %edx,%edx
801060ac:	74 08                	je     801060b6 <uartinit+0xa6>
    uartputc(*p);
801060ae:	0f be c0             	movsbl %al,%eax
801060b1:	e8 0a ff ff ff       	call   80105fc0 <uartputc.part.0>
  for(p="xv6...\n"; *p; p++)
801060b6:	89 f0                	mov    %esi,%eax
801060b8:	83 c3 01             	add    $0x1,%ebx
801060bb:	84 c0                	test   %al,%al
801060bd:	75 e1                	jne    801060a0 <uartinit+0x90>
}
...
801060d4:	55                   	push   %ebp
  if(!uart)
801060d5:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
{
801060db:	89 e5                	mov    %esp,%ebp
801060dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if(!uart)
801060e0:	85 d2                	test   %edx,%edx
801060e2:	74 0c                	je     801060f0 <uartputc+0x20>
}
801060e4:	5d                   	pop    %ebp
801060e5:	e9 d6 fe ff ff       	jmp    80105fc0 <uartputc.part.0>
...
80106107:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
8010610a:	68 90 5f 10 80       	push   $0x80105f90
8010610f:	e8 4c a7 ff ff       	call   80100860 <consoleintr>
}
...
8010611b:	6a 00                	push   $0x0
  jmp alltraps
8010611d:	e9 42 fb ff ff       	jmp    80105c64 <alltraps>
...
80106122:	6a 00                	push   $0x0
  pushl $1
80106124:	6a 01                	push   $0x1
  jmp alltraps
80106126:	e9 39 fb ff ff       	jmp    80105c64 <alltraps>
...
8010612d:	6a 02                	push   $0x2
  jmp alltraps
8010612f:	e9 30 fb ff ff       	jmp    80105c64 <alltraps>
...
80106134:	6a 00                	push   $0x0
  pushl $3
80106136:	6a 03                	push   $0x3
  jmp alltraps
80106138:	e9 27 fb ff ff       	jmp    80105c64 <alltraps>
...
8010613f:	6a 04                	push   $0x4
  jmp alltraps
80106141:	e9 1e fb ff ff       	jmp    80105c64 <alltraps>
...
80106146:	6a 00                	push   $0x0
  pushl $5
80106148:	6a 05                	push   $0x5
  jmp alltraps
8010614a:	e9 15 fb ff ff       	jmp    80105c64 <alltraps>
...
80106151:	6a 06                	push   $0x6
  jmp alltraps
80106153:	e9 0c fb ff ff       	jmp    80105c64 <alltraps>
...
80106158:	6a 00                	push   $0x0
  pushl $7
8010615a:	6a 07                	push   $0x7
  jmp alltraps
8010615c:	e9 03 fb ff ff       	jmp    80105c64 <alltraps>

80106161 <vector8>:
.globl vector8
vector8:
  pushl $8
80106161:	6a 08                	push   $0x8
  jmp alltraps
80106163:	e9 fc fa ff ff       	jmp    80105c64 <alltraps>
...
80106168:	6a 00                	push   $0x0
  pushl $9
8010616a:	6a 09                	push   $0x9
  jmp alltraps
8010616c:	e9 f3 fa ff ff       	jmp    80105c64 <alltraps>

80106171 <vector10>:
.globl vector10
vector10:
  pushl $10
80106171:	6a 0a                	push   $0xa
  jmp alltraps
80106173:	e9 ec fa ff ff       	jmp    80105c64 <alltraps>

80106178 <vector11>:
.globl vector11
vector11:
  pushl $11
80106178:	6a 0b                	push   $0xb
  jmp alltraps
8010617a:	e9 e5 fa ff ff       	jmp    80105c64 <alltraps>

8010617f <vector12>:
.globl vector12
vector12:
  pushl $12
8010617f:	6a 0c                	push   $0xc
  jmp alltraps
80106181:	e9 de fa ff ff       	jmp    80105c64 <alltraps>

80106186 <vector13>:
.globl vector13
vector13:
  pushl $13
80106186:	6a 0d                	push   $0xd
  jmp alltraps
80106188:	e9 d7 fa ff ff       	jmp    80105c64 <alltraps>

8010618d <vector14>:
.globl vector14
vector14:
  pushl $14
8010618d:	6a 0e                	push   $0xe
  jmp alltraps
8010618f:	e9 d0 fa ff ff       	jmp    80105c64 <alltraps>
...
80106194:	6a 00                	push   $0x0
  pushl $15
80106196:	6a 0f                	push   $0xf
  jmp alltraps
80106198:	e9 c7 fa ff ff       	jmp    80105c64 <alltraps>
...
8010619d:	6a 00                	push   $0x0
  pushl $16
8010619f:	6a 10                	push   $0x10
  jmp alltraps
801061a1:	e9 be fa ff ff       	jmp    80105c64 <alltraps>

801061a6 <vector17>:
.globl vector17
vector17:
  pushl $17
801061a6:	6a 11                	push   $0x11
  jmp alltraps
801061a8:	e9 b7 fa ff ff       	jmp    80105c64 <alltraps>
...
801061ad:	6a 00                	push   $0x0
  pushl $18
801061af:	6a 12                	push   $0x12
  jmp alltraps
801061b1:	e9 ae fa ff ff       	jmp    80105c64 <alltraps>
...
801061b6:	6a 00                	push   $0x0
  pushl $19
801061b8:	6a 13                	push   $0x13
  jmp alltraps
801061ba:	e9 a5 fa ff ff       	jmp    80105c64 <alltraps>
...
801061bf:	6a 00                	push   $0x0
  pushl $20
801061c1:	6a 14                	push   $0x14
  jmp alltraps
801061c3:	e9 9c fa ff ff       	jmp    80105c64 <alltraps>
...
801061c8:	6a 00                	push   $0x0
  pushl $21
801061ca:	6a 15                	push   $0x15
  jmp alltraps
801061cc:	e9 93 fa ff ff       	jmp    80105c64 <alltraps>
...
801061d1:	6a 00                	push   $0x0
  pushl $22
801061d3:	6a 16                	push   $0x16
  jmp alltraps
801061d5:	e9 8a fa ff ff       	jmp    80105c64 <alltraps>
...
801061da:	6a 00                	push   $0x0
  pushl $23
801061dc:	6a 17                	push   $0x17
  jmp alltraps
801061de:	e9 81 fa ff ff       	jmp    80105c64 <alltraps>
...
801061e3:	6a 00                	push   $0x0
  pushl $24
801061e5:	6a 18                	push   $0x18
  jmp alltraps
801061e7:	e9 78 fa ff ff       	jmp    80105c64 <alltraps>
...
801061ec:	6a 00                	push   $0x0
  pushl $25
801061ee:	6a 19                	push   $0x19
  jmp alltraps
801061f0:	e9 6f fa ff ff       	jmp    80105c64 <alltraps>
...
801061f5:	6a 00                	push   $0x0
  pushl $26
801061f7:	6a 1a                	push   $0x1a
  jmp alltraps
801061f9:	e9 66 fa ff ff       	jmp    80105c64 <alltraps>
...
801061fe:	6a 00                	push   $0x0
  pushl $27
80106200:	6a 1b                	push   $0x1b
  jmp alltraps
80106202:	e9 5d fa ff ff       	jmp    80105c64 <alltraps>
...
80106207:	6a 00                	push   $0x0
  pushl $28
80106209:	6a 1c                	push   $0x1c
  jmp alltraps
8010620b:	e9 54 fa ff ff       	jmp    80105c64 <alltraps>
...
80106210:	6a 00                	push   $0x0
  pushl $29
80106212:	6a 1d                	push   $0x1d
  jmp alltraps
80106214:	e9 4b fa ff ff       	jmp    80105c64 <alltraps>
...
80106219:	6a 00                	push   $0x0
  pushl $30
8010621b:	6a 1e                	push   $0x1e
  jmp alltraps
8010621d:	e9 42 fa ff ff       	jmp    80105c64 <alltraps>
...
80106222:	6a 00                	push   $0x0
  pushl $31
80106224:	6a 1f                	push   $0x1f
  jmp alltraps
80106226:	e9 39 fa ff ff       	jmp    80105c64 <alltraps>
...
8010622b:	6a 00                	push   $0x0
  pushl $32
8010622d:	6a 20                	push   $0x20
  jmp alltraps
8010622f:	e9 30 fa ff ff       	jmp    80105c64 <alltraps>
...
80106234:	6a 00                	push   $0x0
  pushl $33
80106236:	6a 21                	push   $0x21
  jmp alltraps
80106238:	e9 27 fa ff ff       	jmp    80105c64 <alltraps>
...
8010623d:	6a 00                	push   $0x0
  pushl $34
8010623f:	6a 22                	push   $0x22
  jmp alltraps
80106241:	e9 1e fa ff ff       	jmp    80105c64 <alltraps>
...
80106246:	6a 00                	push   $0x0
  pushl $35
80106248:	6a 23                	push   $0x23
  jmp alltraps
8010624a:	e9 15 fa ff ff       	jmp    80105c64 <alltraps>
...
8010624f:	6a 00                	push   $0x0
  pushl $36
80106251:	6a 24                	push   $0x24
  jmp alltraps
80106253:	e9 0c fa ff ff       	jmp    80105c64 <alltraps>
...
80106258:	6a 00                	push   $0x0
  pushl $37
8010625a:	6a 25                	push   $0x25
  jmp alltraps
8010625c:	e9 03 fa ff ff       	jmp    80105c64 <alltraps>
...
80106261:	6a 00                	push   $0x0
  pushl $38
80106263:	6a 26                	push   $0x26
  jmp alltraps
80106265:	e9 fa f9 ff ff       	jmp    80105c64 <alltraps>
...
8010626a:	6a 00                	push   $0x0
  pushl $39
8010626c:	6a 27                	push   $0x27
  jmp alltraps
8010626e:	e9 f1 f9 ff ff       	jmp    80105c64 <alltraps>
...
80106273:	6a 00                	push   $0x0
  pushl $40
80106275:	6a 28                	push   $0x28
  jmp alltraps
80106277:	e9 e8 f9 ff ff       	jmp    80105c64 <alltraps>
...
8010627c:	6a 00                	push   $0x0
  pushl $41
8010627e:	6a 29                	push   $0x29
  jmp alltraps
80106280:	e9 df f9 ff ff       	jmp    80105c64 <alltraps>
...
80106285:	6a 00                	push   $0x0
  pushl $42
80106287:	6a 2a                	push   $0x2a
  jmp alltraps
80106289:	e9 d6 f9 ff ff       	jmp    80105c64 <alltraps>
...
8010628e:	6a 00                	push   $0x0
  pushl $43
80106290:	6a 2b                	push   $0x2b
  jmp alltraps
80106292:	e9 cd f9 ff ff       	jmp    80105c64 <alltraps>
...
80106297:	6a 00                	push   $0x0
  pushl $44
80106299:	6a 2c                	push   $0x2c
  jmp alltraps
8010629b:	e9 c4 f9 ff ff       	jmp    80105c64 <alltraps>
...
801062a0:	6a 00                	push   $0x0
  pushl $45
801062a2:	6a 2d                	push   $0x2d
  jmp alltraps
801062a4:	e9 bb f9 ff ff       	jmp    80105c64 <alltraps>
...
801062a9:	6a 00                	push   $0x0
  pushl $46
801062ab:	6a 2e                	push   $0x2e
  jmp alltraps
801062ad:	e9 b2 f9 ff ff       	jmp    80105c64 <alltraps>
...
801062b2:	6a 00                	push   $0x0
  pushl $47
801062b4:	6a 2f                	push   $0x2f
  jmp alltraps
801062b6:	e9 a9 f9 ff ff       	jmp    80105c64 <alltraps>
...
801062bb:	6a 00                	push   $0x0
  pushl $48
801062bd:	6a 30                	push   $0x30
  jmp alltraps
801062bf:	e9 a0 f9 ff ff       	jmp    80105c64 <alltraps>
...
801062c4:	6a 00                	push   $0x0
  pushl $49
801062c6:	6a 31                	push   $0x31
  jmp alltraps
801062c8:	e9 97 f9 ff ff       	jmp    80105c64 <alltraps>
...
801062cd:	6a 00                	push   $0x0
  pushl $50
801062cf:	6a 32                	push   $0x32
  jmp alltraps
801062d1:	e9 8e f9 ff ff       	jmp    80105c64 <alltraps>
...
801062d6:	6a 00                	push   $0x0
  pushl $51
801062d8:	6a 33                	push   $0x33
  jmp alltraps
801062da:	e9 85 f9 ff ff       	jmp    80105c64 <alltraps>
...
801062df:	6a 00                	push   $0x0
  pushl $52
801062e1:	6a 34                	push   $0x34
  jmp alltraps
801062e3:	e9 7c f9 ff ff       	jmp    80105c64 <alltraps>
...
801062e8:	6a 00                	push   $0x0
  pushl $53
801062ea:	6a 35                	push   $0x35
  jmp alltraps
801062ec:	e9 73 f9 ff ff       	jmp    80105c64 <alltraps>
...
801062f1:	6a 00                	push   $0x0
  pushl $54
801062f3:	6a 36                	push   $0x36
  jmp alltraps
801062f5:	e9 6a f9 ff ff       	jmp    80105c64 <alltraps>
...
801062fa:	6a 00                	push   $0x0
  pushl $55
801062fc:	6a 37                	push   $0x37
  jmp alltraps
801062fe:	e9 61 f9 ff ff       	jmp    80105c64 <alltraps>
...
80106303:	6a 00                	push   $0x0
  pushl $56
80106305:	6a 38                	push   $0x38
  jmp alltraps
80106307:	e9 58 f9 ff ff       	jmp    80105c64 <alltraps>
...
8010630c:	6a 00                	push   $0x0
  pushl $57
8010630e:	6a 39                	push   $0x39
  jmp alltraps
80106310:	e9 4f f9 ff ff       	jmp    80105c64 <alltraps>
...
80106315:	6a 00                	push   $0x0
  pushl $58
80106317:	6a 3a                	push   $0x3a
  jmp alltraps
80106319:	e9 46 f9 ff ff       	jmp    80105c64 <alltraps>
...
8010631e:	6a 00                	push   $0x0
  pushl $59
80106320:	6a 3b                	push   $0x3b
  jmp alltraps
80106322:	e9 3d f9 ff ff       	jmp    80105c64 <alltraps>
...
80106327:	6a 00                	push   $0x0
  pushl $60
80106329:	6a 3c                	push   $0x3c
  jmp alltraps
8010632b:	e9 34 f9 ff ff       	jmp    80105c64 <alltraps>
...
80106330:	6a 00                	push   $0x0
  pushl $61
80106332:	6a 3d                	push   $0x3d
  jmp alltraps
80106334:	e9 2b f9 ff ff       	jmp    80105c64 <alltraps>
...
80106339:	6a 00                	push   $0x0
  pushl $62
8010633b:	6a 3e                	push   $0x3e
  jmp alltraps
8010633d:	e9 22 f9 ff ff       	jmp    80105c64 <alltraps>
...
80106342:	6a 00                	push   $0x0
  pushl $63
80106344:	6a 3f                	push   $0x3f
  jmp alltraps
80106346:	e9 19 f9 ff ff       	jmp    80105c64 <alltraps>
...
8010634b:	6a 00                	push   $0x0
  pushl $64
8010634d:	6a 40                	push   $0x40
  jmp alltraps
8010634f:	e9 10 f9 ff ff       	jmp    80105c64 <alltraps>
...
80106354:	6a 00                	push   $0x0
  pushl $65
80106356:	6a 41                	push   $0x41
  jmp alltraps
80106358:	e9 07 f9 ff ff       	jmp    80105c64 <alltraps>
...
8010635d:	6a 00                	push   $0x0
  pushl $66
8010635f:	6a 42                	push   $0x42
  jmp alltraps
80106361:	e9 fe f8 ff ff       	jmp    80105c64 <alltraps>
...
80106366:	6a 00                	push   $0x0
  pushl $67
80106368:	6a 43                	push   $0x43
  jmp alltraps
8010636a:	e9 f5 f8 ff ff       	jmp    80105c64 <alltraps>
...
8010636f:	6a 00                	push   $0x0
  pushl $68
80106371:	6a 44                	push   $0x44
  jmp alltraps
80106373:	e9 ec f8 ff ff       	jmp    80105c64 <alltraps>
...
80106378:	6a 00                	push   $0x0
  pushl $69
8010637a:	6a 45                	push   $0x45
  jmp alltraps
8010637c:	e9 e3 f8 ff ff       	jmp    80105c64 <alltraps>
...
80106381:	6a 00                	push   $0x0
  pushl $70
80106383:	6a 46                	push   $0x46
  jmp alltraps
80106385:	e9 da f8 ff ff       	jmp    80105c64 <alltraps>
...
8010638a:	6a 00                	push   $0x0
  pushl $71
8010638c:	6a 47                	push   $0x47
  jmp alltraps
8010638e:	e9 d1 f8 ff ff       	jmp    80105c64 <alltraps>
...
80106393:	6a 00                	push   $0x0
  pushl $72
80106395:	6a 48                	push   $0x48
  jmp alltraps
80106397:	e9 c8 f8 ff ff       	jmp    80105c64 <alltraps>
...
8010639c:	6a 00                	push   $0x0
  pushl $73
8010639e:	6a 49                	push   $0x49
  jmp alltraps
801063a0:	e9 bf f8 ff ff       	jmp    80105c64 <alltraps>
...
801063a5:	6a 00                	push   $0x0
  pushl $74
801063a7:	6a 4a                	push   $0x4a
  jmp alltraps
801063a9:	e9 b6 f8 ff ff       	jmp    80105c64 <alltraps>
...
801063ae:	6a 00                	push   $0x0
  pushl $75
801063b0:	6a 4b                	push   $0x4b
  jmp alltraps
801063b2:	e9 ad f8 ff ff       	jmp    80105c64 <alltraps>
...
801063b7:	6a 00                	push   $0x0
  pushl $76
801063b9:	6a 4c                	push   $0x4c
  jmp alltraps
801063bb:	e9 a4 f8 ff ff       	jmp    80105c64 <alltraps>
...
801063c0:	6a 00                	push   $0x0
  pushl $77
801063c2:	6a 4d                	push   $0x4d
  jmp alltraps
801063c4:	e9 9b f8 ff ff       	jmp    80105c64 <alltraps>
...
801063c9:	6a 00                	push   $0x0
  pushl $78
801063cb:	6a 4e                	push   $0x4e
  jmp alltraps
801063cd:	e9 92 f8 ff ff       	jmp    80105c64 <alltraps>
...
801063d2:	6a 00                	push   $0x0
  pushl $79
801063d4:	6a 4f                	push   $0x4f
  jmp alltraps
801063d6:	e9 89 f8 ff ff       	jmp    80105c64 <alltraps>
...
801063db:	6a 00                	push   $0x0
  pushl $80
801063dd:	6a 50                	push   $0x50
  jmp alltraps
801063df:	e9 80 f8 ff ff       	jmp    80105c64 <alltraps>
...
801063e4:	6a 00                	push   $0x0
  pushl $81
801063e6:	6a 51                	push   $0x51
  jmp alltraps
801063e8:	e9 77 f8 ff ff       	jmp    80105c64 <alltraps>
...
801063ed:	6a 00                	push   $0x0
  pushl $82
801063ef:	6a 52                	push   $0x52
  jmp alltraps
801063f1:	e9 6e f8 ff ff       	jmp    80105c64 <alltraps>
...
801063f6:	6a 00                	push   $0x0
  pushl $83
801063f8:	6a 53                	push   $0x53
  jmp alltraps
801063fa:	e9 65 f8 ff ff       	jmp    80105c64 <alltraps>
...
801063ff:	6a 00                	push   $0x0
  pushl $84
80106401:	6a 54                	push   $0x54
  jmp alltraps
80106403:	e9 5c f8 ff ff       	jmp    80105c64 <alltraps>
...
80106408:	6a 00                	push   $0x0
  pushl $85
8010640a:	6a 55                	push   $0x55
  jmp alltraps
8010640c:	e9 53 f8 ff ff       	jmp    80105c64 <alltraps>
...
80106411:	6a 00                	push   $0x0
  pushl $86
80106413:	6a 56                	push   $0x56
  jmp alltraps
80106415:	e9 4a f8 ff ff       	jmp    80105c64 <alltraps>
...
8010641a:	6a 00                	push   $0x0
  pushl $87
8010641c:	6a 57                	push   $0x57
  jmp alltraps
8010641e:	e9 41 f8 ff ff       	jmp    80105c64 <alltraps>
...
80106423:	6a 00                	push   $0x0
  pushl $88
80106425:	6a 58                	push   $0x58
  jmp alltraps
80106427:	e9 38 f8 ff ff       	jmp    80105c64 <alltraps>
...
8010642c:	6a 00                	push   $0x0
  pushl $89
8010642e:	6a 59                	push   $0x59
  jmp alltraps
80106430:	e9 2f f8 ff ff       	jmp    80105c64 <alltraps>
...
80106435:	6a 00                	push   $0x0
  pushl $90
80106437:	6a 5a                	push   $0x5a
  jmp alltraps
80106439:	e9 26 f8 ff ff       	jmp    80105c64 <alltraps>
...
8010643e:	6a 00                	push   $0x0
  pushl $91
80106440:	6a 5b                	push   $0x5b
  jmp alltraps
80106442:	e9 1d f8 ff ff       	jmp    80105c64 <alltraps>
...
80106447:	6a 00                	push   $0x0
  pushl $92
80106449:	6a 5c                	push   $0x5c
  jmp alltraps
8010644b:	e9 14 f8 ff ff       	jmp    80105c64 <alltraps>
...
80106450:	6a 00                	push   $0x0
  pushl $93
80106452:	6a 5d                	push   $0x5d
  jmp alltraps
80106454:	e9 0b f8 ff ff       	jmp    80105c64 <alltraps>
...
80106459:	6a 00                	push   $0x0
  pushl $94
8010645b:	6a 5e                	push   $0x5e
  jmp alltraps
8010645d:	e9 02 f8 ff ff       	jmp    80105c64 <alltraps>
...
80106462:	6a 00                	push   $0x0
  pushl $95
80106464:	6a 5f                	push   $0x5f
  jmp alltraps
80106466:	e9 f9 f7 ff ff       	jmp    80105c64 <alltraps>
...
8010646b:	6a 00                	push   $0x0
  pushl $96
8010646d:	6a 60                	push   $0x60
  jmp alltraps
8010646f:	e9 f0 f7 ff ff       	jmp    80105c64 <alltraps>
...
80106474:	6a 00                	push   $0x0
  pushl $97
80106476:	6a 61                	push   $0x61
  jmp alltraps
80106478:	e9 e7 f7 ff ff       	jmp    80105c64 <alltraps>
...
8010647d:	6a 00                	push   $0x0
  pushl $98
8010647f:	6a 62                	push   $0x62
  jmp alltraps
80106481:	e9 de f7 ff ff       	jmp    80105c64 <alltraps>
...
80106486:	6a 00                	push   $0x0
  pushl $99
80106488:	6a 63                	push   $0x63
  jmp alltraps
8010648a:	e9 d5 f7 ff ff       	jmp    80105c64 <alltraps>
...
8010648f:	6a 00                	push   $0x0
  pushl $100
80106491:	6a 64                	push   $0x64
  jmp alltraps
80106493:	e9 cc f7 ff ff       	jmp    80105c64 <alltraps>
...
80106498:	6a 00                	push   $0x0
  pushl $101
8010649a:	6a 65                	push   $0x65
  jmp alltraps
8010649c:	e9 c3 f7 ff ff       	jmp    80105c64 <alltraps>
...
801064a1:	6a 00                	push   $0x0
  pushl $102
801064a3:	6a 66                	push   $0x66
  jmp alltraps
801064a5:	e9 ba f7 ff ff       	jmp    80105c64 <alltraps>
...
801064aa:	6a 00                	push   $0x0
  pushl $103
801064ac:	6a 67                	push   $0x67
  jmp alltraps
801064ae:	e9 b1 f7 ff ff       	jmp    80105c64 <alltraps>
...
801064b3:	6a 00                	push   $0x0
  pushl $104
801064b5:	6a 68                	push   $0x68
  jmp alltraps
801064b7:	e9 a8 f7 ff ff       	jmp    80105c64 <alltraps>
...
801064bc:	6a 00                	push   $0x0
  pushl $105
801064be:	6a 69                	push   $0x69
  jmp alltraps
801064c0:	e9 9f f7 ff ff       	jmp    80105c64 <alltraps>
...
801064c5:	6a 00                	push   $0x0
  pushl $106
801064c7:	6a 6a                	push   $0x6a
  jmp alltraps
801064c9:	e9 96 f7 ff ff       	jmp    80105c64 <alltraps>
...
801064ce:	6a 00                	push   $0x0
  pushl $107
801064d0:	6a 6b                	push   $0x6b
  jmp alltraps
801064d2:	e9 8d f7 ff ff       	jmp    80105c64 <alltraps>
...
801064d7:	6a 00                	push   $0x0
  pushl $108
801064d9:	6a 6c                	push   $0x6c
  jmp alltraps
801064db:	e9 84 f7 ff ff       	jmp    80105c64 <alltraps>
...
801064e0:	6a 00                	push   $0x0
  pushl $109
801064e2:	6a 6d                	push   $0x6d
  jmp alltraps
801064e4:	e9 7b f7 ff ff       	jmp    80105c64 <alltraps>
...
801064e9:	6a 00                	push   $0x0
  pushl $110
801064eb:	6a 6e                	push   $0x6e
  jmp alltraps
801064ed:	e9 72 f7 ff ff       	jmp    80105c64 <alltraps>
...
801064f2:	6a 00                	push   $0x0
  pushl $111
801064f4:	6a 6f                	push   $0x6f
  jmp alltraps
801064f6:	e9 69 f7 ff ff       	jmp    80105c64 <alltraps>
...
801064fb:	6a 00                	push   $0x0
  pushl $112
801064fd:	6a 70                	push   $0x70
  jmp alltraps
801064ff:	e9 60 f7 ff ff       	jmp    80105c64 <alltraps>
...
80106504:	6a 00                	push   $0x0
  pushl $113
80106506:	6a 71                	push   $0x71
  jmp alltraps
80106508:	e9 57 f7 ff ff       	jmp    80105c64 <alltraps>
...
8010650d:	6a 00                	push   $0x0
  pushl $114
8010650f:	6a 72                	push   $0x72
  jmp alltraps
80106511:	e9 4e f7 ff ff       	jmp    80105c64 <alltraps>
...
80106516:	6a 00                	push   $0x0
  pushl $115
80106518:	6a 73                	push   $0x73
  jmp alltraps
8010651a:	e9 45 f7 ff ff       	jmp    80105c64 <alltraps>
...
8010651f:	6a 00                	push   $0x0
  pushl $116
80106521:	6a 74                	push   $0x74
  jmp alltraps
80106523:	e9 3c f7 ff ff       	jmp    80105c64 <alltraps>
...
80106528:	6a 00                	push   $0x0
  pushl $117
8010652a:	6a 75                	push   $0x75
  jmp alltraps
8010652c:	e9 33 f7 ff ff       	jmp    80105c64 <alltraps>
...
80106531:	6a 00                	push   $0x0
  pushl $118
80106533:	6a 76                	push   $0x76
  jmp alltraps
80106535:	e9 2a f7 ff ff       	jmp    80105c64 <alltraps>
...
8010653a:	6a 00                	push   $0x0
  pushl $119
8010653c:	6a 77                	push   $0x77
  jmp alltraps
8010653e:	e9 21 f7 ff ff       	jmp    80105c64 <alltraps>
...
80106543:	6a 00                	push   $0x0
  pushl $120
80106545:	6a 78                	push   $0x78
  jmp alltraps
80106547:	e9 18 f7 ff ff       	jmp    80105c64 <alltraps>
...
8010654c:	6a 00                	push   $0x0
  pushl $121
8010654e:	6a 79                	push   $0x79
  jmp alltraps
80106550:	e9 0f f7 ff ff       	jmp    80105c64 <alltraps>
...
80106555:	6a 00                	push   $0x0
  pushl $122
80106557:	6a 7a                	push   $0x7a
  jmp alltraps
80106559:	e9 06 f7 ff ff       	jmp    80105c64 <alltraps>
...
8010655e:	6a 00                	push   $0x0
  pushl $123
80106560:	6a 7b                	push   $0x7b
  jmp alltraps
80106562:	e9 fd f6 ff ff       	jmp    80105c64 <alltraps>
...
80106567:	6a 00                	push   $0x0
  pushl $124
80106569:	6a 7c                	push   $0x7c
  jmp alltraps
8010656b:	e9 f4 f6 ff ff       	jmp    80105c64 <alltraps>
...
80106570:	6a 00                	push   $0x0
  pushl $125
80106572:	6a 7d                	push   $0x7d
  jmp alltraps
80106574:	e9 eb f6 ff ff       	jmp    80105c64 <alltraps>
...
80106579:	6a 00                	push   $0x0
  pushl $126
8010657b:	6a 7e                	push   $0x7e
  jmp alltraps
8010657d:	e9 e2 f6 ff ff       	jmp    80105c64 <alltraps>
...
80106582:	6a 00                	push   $0x0
  pushl $127
80106584:	6a 7f                	push   $0x7f
  jmp alltraps
80106586:	e9 d9 f6 ff ff       	jmp    80105c64 <alltraps>
...
8010658b:	6a 00                	push   $0x0
  pushl $128
8010658d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106592:	e9 cd f6 ff ff       	jmp    80105c64 <alltraps>
...
80106597:	6a 00                	push   $0x0
  pushl $129
80106599:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010659e:	e9 c1 f6 ff ff       	jmp    80105c64 <alltraps>
...
801065a3:	6a 00                	push   $0x0
  pushl $130
801065a5:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801065aa:	e9 b5 f6 ff ff       	jmp    80105c64 <alltraps>
...
801065af:	6a 00                	push   $0x0
  pushl $131
801065b1:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801065b6:	e9 a9 f6 ff ff       	jmp    80105c64 <alltraps>
...
801065bb:	6a 00                	push   $0x0
  pushl $132
801065bd:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801065c2:	e9 9d f6 ff ff       	jmp    80105c64 <alltraps>
...
801065c7:	6a 00                	push   $0x0
  pushl $133
801065c9:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801065ce:	e9 91 f6 ff ff       	jmp    80105c64 <alltraps>
...
801065d3:	6a 00                	push   $0x0
  pushl $134
801065d5:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801065da:	e9 85 f6 ff ff       	jmp    80105c64 <alltraps>
...
801065df:	6a 00                	push   $0x0
  pushl $135
801065e1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801065e6:	e9 79 f6 ff ff       	jmp    80105c64 <alltraps>
...
801065eb:	6a 00                	push   $0x0
  pushl $136
801065ed:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801065f2:	e9 6d f6 ff ff       	jmp    80105c64 <alltraps>
...
801065f7:	6a 00                	push   $0x0
  pushl $137
801065f9:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801065fe:	e9 61 f6 ff ff       	jmp    80105c64 <alltraps>
...
80106603:	6a 00                	push   $0x0
  pushl $138
80106605:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010660a:	e9 55 f6 ff ff       	jmp    80105c64 <alltraps>
...
8010660f:	6a 00                	push   $0x0
  pushl $139
80106611:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106616:	e9 49 f6 ff ff       	jmp    80105c64 <alltraps>
...
8010661b:	6a 00                	push   $0x0
  pushl $140
8010661d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106622:	e9 3d f6 ff ff       	jmp    80105c64 <alltraps>
...
80106627:	6a 00                	push   $0x0
  pushl $141
80106629:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010662e:	e9 31 f6 ff ff       	jmp    80105c64 <alltraps>
...
80106633:	6a 00                	push   $0x0
  pushl $142
80106635:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010663a:	e9 25 f6 ff ff       	jmp    80105c64 <alltraps>
...
8010663f:	6a 00                	push   $0x0
  pushl $143
80106641:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106646:	e9 19 f6 ff ff       	jmp    80105c64 <alltraps>
...
8010664b:	6a 00                	push   $0x0
  pushl $144
8010664d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106652:	e9 0d f6 ff ff       	jmp    80105c64 <alltraps>
...
80106657:	6a 00                	push   $0x0
  pushl $145
80106659:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010665e:	e9 01 f6 ff ff       	jmp    80105c64 <alltraps>
...
80106663:	6a 00                	push   $0x0
  pushl $146
80106665:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010666a:	e9 f5 f5 ff ff       	jmp    80105c64 <alltraps>
...
8010666f:	6a 00                	push   $0x0
  pushl $147
80106671:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106676:	e9 e9 f5 ff ff       	jmp    80105c64 <alltraps>
...
8010667b:	6a 00                	push   $0x0
  pushl $148
8010667d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106682:	e9 dd f5 ff ff       	jmp    80105c64 <alltraps>
...
80106687:	6a 00                	push   $0x0
  pushl $149
80106689:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010668e:	e9 d1 f5 ff ff       	jmp    80105c64 <alltraps>
...
80106693:	6a 00                	push   $0x0
  pushl $150
80106695:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010669a:	e9 c5 f5 ff ff       	jmp    80105c64 <alltraps>
...
8010669f:	6a 00                	push   $0x0
  pushl $151
801066a1:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801066a6:	e9 b9 f5 ff ff       	jmp    80105c64 <alltraps>
...
801066ab:	6a 00                	push   $0x0
  pushl $152
801066ad:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801066b2:	e9 ad f5 ff ff       	jmp    80105c64 <alltraps>
...
801066b7:	6a 00                	push   $0x0
  pushl $153
801066b9:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801066be:	e9 a1 f5 ff ff       	jmp    80105c64 <alltraps>
...
801066c3:	6a 00                	push   $0x0
  pushl $154
801066c5:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801066ca:	e9 95 f5 ff ff       	jmp    80105c64 <alltraps>
...
801066cf:	6a 00                	push   $0x0
  pushl $155
801066d1:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801066d6:	e9 89 f5 ff ff       	jmp    80105c64 <alltraps>
...
801066db:	6a 00                	push   $0x0
  pushl $156
801066dd:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801066e2:	e9 7d f5 ff ff       	jmp    80105c64 <alltraps>
...
801066e7:	6a 00                	push   $0x0
  pushl $157
801066e9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801066ee:	e9 71 f5 ff ff       	jmp    80105c64 <alltraps>
...
801066f3:	6a 00                	push   $0x0
  pushl $158
801066f5:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801066fa:	e9 65 f5 ff ff       	jmp    80105c64 <alltraps>
...
801066ff:	6a 00                	push   $0x0
  pushl $159
80106701:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106706:	e9 59 f5 ff ff       	jmp    80105c64 <alltraps>
...
8010670b:	6a 00                	push   $0x0
  pushl $160
8010670d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106712:	e9 4d f5 ff ff       	jmp    80105c64 <alltraps>
...
80106717:	6a 00                	push   $0x0
  pushl $161
80106719:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010671e:	e9 41 f5 ff ff       	jmp    80105c64 <alltraps>
...
80106723:	6a 00                	push   $0x0
  pushl $162
80106725:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010672a:	e9 35 f5 ff ff       	jmp    80105c64 <alltraps>
...
8010672f:	6a 00                	push   $0x0
  pushl $163
80106731:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106736:	e9 29 f5 ff ff       	jmp    80105c64 <alltraps>
...
8010673b:	6a 00                	push   $0x0
  pushl $164
8010673d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106742:	e9 1d f5 ff ff       	jmp    80105c64 <alltraps>
...
80106747:	6a 00                	push   $0x0
  pushl $165
80106749:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010674e:	e9 11 f5 ff ff       	jmp    80105c64 <alltraps>
...
80106753:	6a 00                	push   $0x0
  pushl $166
80106755:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010675a:	e9 05 f5 ff ff       	jmp    80105c64 <alltraps>
...
8010675f:	6a 00                	push   $0x0
  pushl $167
80106761:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106766:	e9 f9 f4 ff ff       	jmp    80105c64 <alltraps>
...
8010676b:	6a 00                	push   $0x0
  pushl $168
8010676d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106772:	e9 ed f4 ff ff       	jmp    80105c64 <alltraps>
...
80106777:	6a 00                	push   $0x0
  pushl $169
80106779:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010677e:	e9 e1 f4 ff ff       	jmp    80105c64 <alltraps>
...
80106783:	6a 00                	push   $0x0
  pushl $170
80106785:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010678a:	e9 d5 f4 ff ff       	jmp    80105c64 <alltraps>
...
8010678f:	6a 00                	push   $0x0
  pushl $171
80106791:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106796:	e9 c9 f4 ff ff       	jmp    80105c64 <alltraps>
...
8010679b:	6a 00                	push   $0x0
  pushl $172
8010679d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801067a2:	e9 bd f4 ff ff       	jmp    80105c64 <alltraps>
...
801067a7:	6a 00                	push   $0x0
  pushl $173
801067a9:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801067ae:	e9 b1 f4 ff ff       	jmp    80105c64 <alltraps>
...
801067b3:	6a 00                	push   $0x0
  pushl $174
801067b5:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801067ba:	e9 a5 f4 ff ff       	jmp    80105c64 <alltraps>
...
801067bf:	6a 00                	push   $0x0
  pushl $175
801067c1:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801067c6:	e9 99 f4 ff ff       	jmp    80105c64 <alltraps>
...
801067cb:	6a 00                	push   $0x0
  pushl $176
801067cd:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801067d2:	e9 8d f4 ff ff       	jmp    80105c64 <alltraps>
...
801067d7:	6a 00                	push   $0x0
  pushl $177
801067d9:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801067de:	e9 81 f4 ff ff       	jmp    80105c64 <alltraps>
...
801067e3:	6a 00                	push   $0x0
  pushl $178
801067e5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801067ea:	e9 75 f4 ff ff       	jmp    80105c64 <alltraps>
...
801067ef:	6a 00                	push   $0x0
  pushl $179
801067f1:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801067f6:	e9 69 f4 ff ff       	jmp    80105c64 <alltraps>
...
801067fb:	6a 00                	push   $0x0
  pushl $180
801067fd:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106802:	e9 5d f4 ff ff       	jmp    80105c64 <alltraps>
...
80106807:	6a 00                	push   $0x0
  pushl $181
80106809:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010680e:	e9 51 f4 ff ff       	jmp    80105c64 <alltraps>
...
80106813:	6a 00                	push   $0x0
  pushl $182
80106815:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010681a:	e9 45 f4 ff ff       	jmp    80105c64 <alltraps>
...
8010681f:	6a 00                	push   $0x0
  pushl $183
80106821:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106826:	e9 39 f4 ff ff       	jmp    80105c64 <alltraps>
...
8010682b:	6a 00                	push   $0x0
  pushl $184
8010682d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106832:	e9 2d f4 ff ff       	jmp    80105c64 <alltraps>
...
80106837:	6a 00                	push   $0x0
  pushl $185
80106839:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010683e:	e9 21 f4 ff ff       	jmp    80105c64 <alltraps>
...
80106843:	6a 00                	push   $0x0
  pushl $186
80106845:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010684a:	e9 15 f4 ff ff       	jmp    80105c64 <alltraps>
...
8010684f:	6a 00                	push   $0x0
  pushl $187
80106851:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106856:	e9 09 f4 ff ff       	jmp    80105c64 <alltraps>
...
8010685b:	6a 00                	push   $0x0
  pushl $188
8010685d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106862:	e9 fd f3 ff ff       	jmp    80105c64 <alltraps>
...
80106867:	6a 00                	push   $0x0
  pushl $189
80106869:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010686e:	e9 f1 f3 ff ff       	jmp    80105c64 <alltraps>
...
80106873:	6a 00                	push   $0x0
  pushl $190
80106875:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010687a:	e9 e5 f3 ff ff       	jmp    80105c64 <alltraps>
...
8010687f:	6a 00                	push   $0x0
  pushl $191
80106881:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106886:	e9 d9 f3 ff ff       	jmp    80105c64 <alltraps>
...
8010688b:	6a 00                	push   $0x0
  pushl $192
8010688d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106892:	e9 cd f3 ff ff       	jmp    80105c64 <alltraps>
...
80106897:	6a 00                	push   $0x0
  pushl $193
80106899:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010689e:	e9 c1 f3 ff ff       	jmp    80105c64 <alltraps>
...
801068a3:	6a 00                	push   $0x0
  pushl $194
801068a5:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801068aa:	e9 b5 f3 ff ff       	jmp    80105c64 <alltraps>
...
801068af:	6a 00                	push   $0x0
  pushl $195
801068b1:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801068b6:	e9 a9 f3 ff ff       	jmp    80105c64 <alltraps>
...
801068bb:	6a 00                	push   $0x0
  pushl $196
801068bd:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801068c2:	e9 9d f3 ff ff       	jmp    80105c64 <alltraps>
...
801068c7:	6a 00                	push   $0x0
  pushl $197
801068c9:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801068ce:	e9 91 f3 ff ff       	jmp    80105c64 <alltraps>
...
801068d3:	6a 00                	push   $0x0
  pushl $198
801068d5:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801068da:	e9 85 f3 ff ff       	jmp    80105c64 <alltraps>
...
801068df:	6a 00                	push   $0x0
  pushl $199
801068e1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801068e6:	e9 79 f3 ff ff       	jmp    80105c64 <alltraps>
...
801068eb:	6a 00                	push   $0x0
  pushl $200
801068ed:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801068f2:	e9 6d f3 ff ff       	jmp    80105c64 <alltraps>
...
801068f7:	6a 00                	push   $0x0
  pushl $201
801068f9:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801068fe:	e9 61 f3 ff ff       	jmp    80105c64 <alltraps>
...
80106903:	6a 00                	push   $0x0
  pushl $202
80106905:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010690a:	e9 55 f3 ff ff       	jmp    80105c64 <alltraps>
...
8010690f:	6a 00                	push   $0x0
  pushl $203
80106911:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106916:	e9 49 f3 ff ff       	jmp    80105c64 <alltraps>
...
8010691b:	6a 00                	push   $0x0
  pushl $204
8010691d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106922:	e9 3d f3 ff ff       	jmp    80105c64 <alltraps>
...
80106927:	6a 00                	push   $0x0
  pushl $205
80106929:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010692e:	e9 31 f3 ff ff       	jmp    80105c64 <alltraps>
...
80106933:	6a 00                	push   $0x0
  pushl $206
80106935:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010693a:	e9 25 f3 ff ff       	jmp    80105c64 <alltraps>
...
8010693f:	6a 00                	push   $0x0
  pushl $207
80106941:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106946:	e9 19 f3 ff ff       	jmp    80105c64 <alltraps>
...
8010694b:	6a 00                	push   $0x0
  pushl $208
8010694d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106952:	e9 0d f3 ff ff       	jmp    80105c64 <alltraps>
...
80106957:	6a 00                	push   $0x0
  pushl $209
80106959:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010695e:	e9 01 f3 ff ff       	jmp    80105c64 <alltraps>
...
80106963:	6a 00                	push   $0x0
  pushl $210
80106965:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010696a:	e9 f5 f2 ff ff       	jmp    80105c64 <alltraps>
...
8010696f:	6a 00                	push   $0x0
  pushl $211
80106971:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106976:	e9 e9 f2 ff ff       	jmp    80105c64 <alltraps>
...
8010697b:	6a 00                	push   $0x0
  pushl $212
8010697d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106982:	e9 dd f2 ff ff       	jmp    80105c64 <alltraps>
...
80106987:	6a 00                	push   $0x0
  pushl $213
80106989:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010698e:	e9 d1 f2 ff ff       	jmp    80105c64 <alltraps>
...
80106993:	6a 00                	push   $0x0
  pushl $214
80106995:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010699a:	e9 c5 f2 ff ff       	jmp    80105c64 <alltraps>
...
8010699f:	6a 00                	push   $0x0
  pushl $215
801069a1:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801069a6:	e9 b9 f2 ff ff       	jmp    80105c64 <alltraps>
...
801069ab:	6a 00                	push   $0x0
  pushl $216
801069ad:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801069b2:	e9 ad f2 ff ff       	jmp    80105c64 <alltraps>
...
801069b7:	6a 00                	push   $0x0
  pushl $217
801069b9:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801069be:	e9 a1 f2 ff ff       	jmp    80105c64 <alltraps>
...
801069c3:	6a 00                	push   $0x0
  pushl $218
801069c5:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801069ca:	e9 95 f2 ff ff       	jmp    80105c64 <alltraps>
...
801069cf:	6a 00                	push   $0x0
  pushl $219
801069d1:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801069d6:	e9 89 f2 ff ff       	jmp    80105c64 <alltraps>
...
801069db:	6a 00                	push   $0x0
  pushl $220
801069dd:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801069e2:	e9 7d f2 ff ff       	jmp    80105c64 <alltraps>
...
801069e7:	6a 00                	push   $0x0
  pushl $221
801069e9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801069ee:	e9 71 f2 ff ff       	jmp    80105c64 <alltraps>
...
801069f3:	6a 00                	push   $0x0
  pushl $222
801069f5:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801069fa:	e9 65 f2 ff ff       	jmp    80105c64 <alltraps>
...
801069ff:	6a 00                	push   $0x0
  pushl $223
80106a01:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106a06:	e9 59 f2 ff ff       	jmp    80105c64 <alltraps>
...
80106a0b:	6a 00                	push   $0x0
  pushl $224
80106a0d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106a12:	e9 4d f2 ff ff       	jmp    80105c64 <alltraps>
...
80106a17:	6a 00                	push   $0x0
  pushl $225
80106a19:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106a1e:	e9 41 f2 ff ff       	jmp    80105c64 <alltraps>
...
80106a23:	6a 00                	push   $0x0
  pushl $226
80106a25:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106a2a:	e9 35 f2 ff ff       	jmp    80105c64 <alltraps>
...
80106a2f:	6a 00                	push   $0x0
  pushl $227
80106a31:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106a36:	e9 29 f2 ff ff       	jmp    80105c64 <alltraps>
...
80106a3b:	6a 00                	push   $0x0
  pushl $228
80106a3d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106a42:	e9 1d f2 ff ff       	jmp    80105c64 <alltraps>
...
80106a47:	6a 00                	push   $0x0
  pushl $229
80106a49:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106a4e:	e9 11 f2 ff ff       	jmp    80105c64 <alltraps>
...
80106a53:	6a 00                	push   $0x0
  pushl $230
80106a55:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106a5a:	e9 05 f2 ff ff       	jmp    80105c64 <alltraps>
...
80106a5f:	6a 00                	push   $0x0
  pushl $231
80106a61:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106a66:	e9 f9 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106a6b:	6a 00                	push   $0x0
  pushl $232
80106a6d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106a72:	e9 ed f1 ff ff       	jmp    80105c64 <alltraps>
...
80106a77:	6a 00                	push   $0x0
  pushl $233
80106a79:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106a7e:	e9 e1 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106a83:	6a 00                	push   $0x0
  pushl $234
80106a85:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106a8a:	e9 d5 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106a8f:	6a 00                	push   $0x0
  pushl $235
80106a91:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106a96:	e9 c9 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106a9b:	6a 00                	push   $0x0
  pushl $236
80106a9d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106aa2:	e9 bd f1 ff ff       	jmp    80105c64 <alltraps>
...
80106aa7:	6a 00                	push   $0x0
  pushl $237
80106aa9:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106aae:	e9 b1 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106ab3:	6a 00                	push   $0x0
  pushl $238
80106ab5:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106aba:	e9 a5 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106abf:	6a 00                	push   $0x0
  pushl $239
80106ac1:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106ac6:	e9 99 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106acb:	6a 00                	push   $0x0
  pushl $240
80106acd:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106ad2:	e9 8d f1 ff ff       	jmp    80105c64 <alltraps>
...
80106ad7:	6a 00                	push   $0x0
  pushl $241
80106ad9:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106ade:	e9 81 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106ae3:	6a 00                	push   $0x0
  pushl $242
80106ae5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106aea:	e9 75 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106aef:	6a 00                	push   $0x0
  pushl $243
80106af1:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106af6:	e9 69 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106afb:	6a 00                	push   $0x0
  pushl $244
80106afd:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106b02:	e9 5d f1 ff ff       	jmp    80105c64 <alltraps>
...
80106b07:	6a 00                	push   $0x0
  pushl $245
80106b09:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106b0e:	e9 51 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106b13:	6a 00                	push   $0x0
  pushl $246
80106b15:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106b1a:	e9 45 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106b1f:	6a 00                	push   $0x0
  pushl $247
80106b21:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106b26:	e9 39 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106b2b:	6a 00                	push   $0x0
  pushl $248
80106b2d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106b32:	e9 2d f1 ff ff       	jmp    80105c64 <alltraps>
...
80106b37:	6a 00                	push   $0x0
  pushl $249
80106b39:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106b3e:	e9 21 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106b43:	6a 00                	push   $0x0
  pushl $250
80106b45:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106b4a:	e9 15 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106b4f:	6a 00                	push   $0x0
  pushl $251
80106b51:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106b56:	e9 09 f1 ff ff       	jmp    80105c64 <alltraps>
...
80106b5b:	6a 00                	push   $0x0
  pushl $252
80106b5d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106b62:	e9 fd f0 ff ff       	jmp    80105c64 <alltraps>
...
80106b67:	6a 00                	push   $0x0
  pushl $253
80106b69:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106b6e:	e9 f1 f0 ff ff       	jmp    80105c64 <alltraps>
...
80106b73:	6a 00                	push   $0x0
  pushl $254
80106b75:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106b7a:	e9 e5 f0 ff ff       	jmp    80105c64 <alltraps>
...
80106b7f:	6a 00                	push   $0x0
  pushl $255
80106b81:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106b86:	e9 d9 f0 ff ff       	jmp    80105c64 <alltraps>
...
80106b95:	89 d6                	mov    %edx,%esi
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80106b97:	c1 ea 16             	shr    $0x16,%edx
{
80106b9a:	53                   	push   %ebx
  pde = &pgdir[PDX(va)];
80106b9b:	8d 3c 90             	lea    (%eax,%edx,4),%edi
{
80106b9e:	83 ec 0c             	sub    $0xc,%esp
  if(*pde & PTE_P){
80106ba1:	8b 1f                	mov    (%edi),%ebx
80106ba3:	f6 c3 01             	test   $0x1,%bl
80106ba6:	74 28                	je     80106bd0 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106ba8:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106bae:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
...
80106bb6:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
80106bb9:	c1 e8 0a             	shr    $0xa,%eax
80106bbc:	25 fc 0f 00 00       	and    $0xffc,%eax
80106bc1:	01 d8                	add    %ebx,%eax
}
80106bc3:	5b                   	pop    %ebx
80106bc4:	5e                   	pop    %esi
80106bc5:	5f                   	pop    %edi
...
80106bd4:	e8 57 ba ff ff       	call   80102630 <kalloc>
...
80106bea:	e8 81 dd ff ff       	call   80104970 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106c14:	89 c7                	mov    %eax,%edi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106c16:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
{
80106c1a:	56                   	push   %esi
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106c1b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char*)PGROUNDDOWN((uint)va);
80106c20:	89 d6                	mov    %edx,%esi
{
80106c22:	53                   	push   %ebx
  a = (char*)PGROUNDDOWN((uint)va);
80106c23:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
{
80106c29:	83 ec 1c             	sub    $0x1c,%esp
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106c2c:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106c2f:	8b 45 08             	mov    0x8(%ebp),%eax
80106c32:	29 f0                	sub    %esi,%eax
80106c34:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c37:	eb 1f                	jmp    80106c58 <mappages+0x48>
...
80106c43:	75 45                	jne    80106c8a <mappages+0x7a>
      panic("remap");
    *pte = pa | perm | PTE_P;
80106c45:	0b 5d 0c             	or     0xc(%ebp),%ebx
80106c48:	83 cb 01             	or     $0x1,%ebx
80106c4b:	89 18                	mov    %ebx,(%eax)
    if(a == last)
80106c4d:	3b 75 e0             	cmp    -0x20(%ebp),%esi
80106c50:	74 2e                	je     80106c80 <mappages+0x70>
      break;
    a += PGSIZE;
...
80106c58:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106c5b:	b9 01 00 00 00       	mov    $0x1,%ecx
80106c60:	89 f2                	mov    %esi,%edx
80106c62:	8d 1c 06             	lea    (%esi,%eax,1),%ebx
80106c65:	89 f8                	mov    %edi,%eax
80106c67:	e8 24 ff ff ff       	call   80106b90 <walkpgdir>
80106c6c:	85 c0                	test   %eax,%eax
80106c6e:	75 d0                	jne    80106c40 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
...
80106c8d:	68 d4 7d 10 80       	push   $0x80107dd4
...
80106ca5:	89 c6                	mov    %eax,%esi
80106ca7:	53                   	push   %ebx
80106ca8:	89 d3                	mov    %edx,%ebx
  uint a, pa;
  ...
  a = PGROUNDUP(newsz);
80106caa:	8d 91 ff 0f 00 00    	lea    0xfff(%ecx),%edx
80106cb0:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106cb6:	83 ec 1c             	sub    $0x1c,%esp
80106cb9:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106cbc:	39 da                	cmp    %ebx,%edx
80106cbe:	73 5b                	jae    80106d1b <deallocuvm.part.0+0x7b>
80106cc0:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
80106cc3:	89 d7                	mov    %edx,%edi
80106cc5:	eb 14                	jmp    80106cdb <deallocuvm.part.0+0x3b>
80106cc7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106cce:	66 90                	xchg   %ax,%ax
80106cd0:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106cd6:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106cd9:	76 40                	jbe    80106d1b <deallocuvm.part.0+0x7b>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106cdb:	31 c9                	xor    %ecx,%ecx
80106cdd:	89 fa                	mov    %edi,%edx
80106cdf:	89 f0                	mov    %esi,%eax
80106ce1:	e8 aa fe ff ff       	call   80106b90 <walkpgdir>
80106ce6:	89 c3                	mov    %eax,%ebx
    if(!pte)
80106ce8:	85 c0                	test   %eax,%eax
80106cea:	74 44                	je     80106d30 <deallocuvm.part.0+0x90>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80106cec:	8b 00                	mov    (%eax),%eax
80106cee:	a8 01                	test   $0x1,%al
80106cf0:	74 de                	je     80106cd0 <deallocuvm.part.0+0x30>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106cf2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106cf7:	74 47                	je     80106d40 <deallocuvm.part.0+0xa0>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80106cf9:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106cfc:	05 00 00 00 80       	add    $0x80000000,%eax
80106d01:	81 c7 00 10 00 00    	add    $0x1000,%edi
      kfree(v);
80106d07:	50                   	push   %eax
80106d08:	e8 63 b7 ff ff       	call   80102470 <kfree>
      *pte = 0;
80106d0d:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80106d13:	83 c4 10             	add    $0x10,%esp
  for(; a  < oldsz; a += PGSIZE){
80106d16:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106d19:	77 c0                	ja     80106cdb <deallocuvm.part.0+0x3b>
    }
  }
  return newsz;
}
...
80106d2d:	8d 76 00             	lea    0x0(%esi),%esi
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106d30:	89 fa                	mov    %edi,%edx
80106d32:	81 e2 00 00 c0 ff    	and    $0xffc00000,%edx
80106d38:	8d ba 00 00 40 00    	lea    0x400000(%edx),%edi
80106d3e:	eb 96                	jmp    80106cd6 <deallocuvm.part.0+0x36>
        panic("kfree");
80106d40:	83 ec 0c             	sub    $0xc,%esp
80106d43:	68 46 77 10 80       	push   $0x80107746
...
80106d57:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106d5a:	e8 f1 cb ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
80106d5f:	ba 2f 00 00 00       	mov    $0x2f,%edx
80106d64:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106d6a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106d6e:	c7 80 f8 27 11 80 ff 	movl   $0xffff,-0x7feed808(%eax)
80106d75:	ff 00 00 
80106d78:	c7 80 fc 27 11 80 00 	movl   $0xcf9a00,-0x7feed804(%eax)
80106d7f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106d82:	c7 80 00 28 11 80 ff 	movl   $0xffff,-0x7feed800(%eax)
80106d89:	ff 00 00 
80106d8c:	c7 80 04 28 11 80 00 	movl   $0xcf9200,-0x7feed7fc(%eax)
80106d93:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106d96:	c7 80 08 28 11 80 ff 	movl   $0xffff,-0x7feed7f8(%eax)
80106d9d:	ff 00 00 
80106da0:	c7 80 0c 28 11 80 00 	movl   $0xcffa00,-0x7feed7f4(%eax)
80106da7:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106daa:	c7 80 10 28 11 80 ff 	movl   $0xffff,-0x7feed7f0(%eax)
80106db1:	ff 00 00 
80106db4:	c7 80 14 28 11 80 00 	movl   $0xcff200,-0x7feed7ec(%eax)
80106dbb:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106dbe:	05 f0 27 11 80       	add    $0x801127f0,%eax
  pd[1] = (uint)p;
...
80106de4:	a1 a4 57 11 80       	mov    0x801157a4,%eax
80106de9:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80106e12:	0f 84 cb 00 00 00    	je     80106ee3 <switchuvm+0xe3>
  if(p->kstack == 0)
80106e18:	8b 46 08             	mov    0x8(%esi),%eax
80106e1b:	85 c0                	test   %eax,%eax
80106e1d:	0f 84 da 00 00 00    	je     80106efd <switchuvm+0xfd>
  if(p->pgdir == 0)
80106e23:	8b 46 04             	mov    0x4(%esi),%eax
80106e26:	85 c0                	test   %eax,%eax
80106e28:	0f 84 c2 00 00 00    	je     80106ef0 <switchuvm+0xf0>
  pushcli();
80106e2e:	e8 2d d9 ff ff       	call   80104760 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106e33:	e8 a8 ca ff ff       	call   801038e0 <mycpu>
80106e38:	89 c3                	mov    %eax,%ebx
80106e3a:	e8 a1 ca ff ff       	call   801038e0 <mycpu>
80106e3f:	89 c7                	mov    %eax,%edi
80106e41:	e8 9a ca ff ff       	call   801038e0 <mycpu>
80106e46:	83 c7 08             	add    $0x8,%edi
80106e49:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e4c:	e8 8f ca ff ff       	call   801038e0 <mycpu>
80106e51:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106e54:	ba 67 00 00 00       	mov    $0x67,%edx
80106e59:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106e60:	83 c0 08             	add    $0x8,%eax
80106e63:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106e6a:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106e6f:	83 c1 08             	add    $0x8,%ecx
80106e72:	c1 e8 18             	shr    $0x18,%eax
80106e75:	c1 e9 10             	shr    $0x10,%ecx
80106e78:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106e7e:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106e84:	b9 99 40 00 00       	mov    $0x4099,%ecx
80106e89:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106e90:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80106e95:	e8 46 ca ff ff       	call   801038e0 <mycpu>
80106e9a:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106ea1:	e8 3a ca ff ff       	call   801038e0 <mycpu>
80106ea6:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106eaa:	8b 5e 08             	mov    0x8(%esi),%ebx
80106ead:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106eb3:	e8 28 ca ff ff       	call   801038e0 <mycpu>
80106eb8:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106ebb:	e8 20 ca ff ff       	call   801038e0 <mycpu>
80106ec0:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106ec4:	b8 28 00 00 00       	mov    $0x28,%eax
80106ec9:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106ecc:	8b 46 04             	mov    0x4(%esi),%eax
80106ecf:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106ed4:	0f 22 d8             	mov    %eax,%cr3
}
...
80106edd:	5d                   	pop    %ebp
  popcli();
80106ede:	e9 cd d8 ff ff       	jmp    801047b0 <popcli>
    panic("switchuvm: no process");
80106ee3:	83 ec 0c             	sub    $0xc,%esp
80106ee6:	68 da 7d 10 80       	push   $0x80107dda
80106eeb:	e8 a0 94 ff ff       	call   80100390 <panic>
    panic("switchuvm: no pgdir");
80106ef0:	83 ec 0c             	sub    $0xc,%esp
80106ef3:	68 05 7e 10 80       	push   $0x80107e05
80106ef8:	e8 93 94 ff ff       	call   80100390 <panic>
    panic("switchuvm: no kstack");
80106efd:	83 ec 0c             	sub    $0xc,%esp
80106f00:	68 f0 7d 10 80       	push   $0x80107df0
80106f05:	e8 86 94 ff ff       	call   80100390 <panic>
...
80106f20:	8b 75 10             	mov    0x10(%ebp),%esi
80106f23:	8b 7d 08             	mov    0x8(%ebp),%edi
80106f26:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106f29:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106f2f:	77 4b                	ja     80106f7c <inituvm+0x6c>
  mem = kalloc();
80106f31:	e8 fa b6 ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
80106f36:	83 ec 04             	sub    $0x4,%esp
80106f39:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
80106f3e:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106f40:	6a 00                	push   $0x0
80106f42:	50                   	push   %eax
80106f43:	e8 28 da ff ff       	call   80104970 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106f48:	58                   	pop    %eax
80106f49:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106f4f:	5a                   	pop    %edx
80106f50:	6a 06                	push   $0x6
80106f52:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106f57:	31 d2                	xor    %edx,%edx
80106f59:	50                   	push   %eax
80106f5a:	89 f8                	mov    %edi,%eax
80106f5c:	e8 af fc ff ff       	call   80106c10 <mappages>
  memmove(mem, init, sz);
80106f61:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106f64:	89 75 10             	mov    %esi,0x10(%ebp)
80106f67:	83 c4 10             	add    $0x10,%esp
80106f6a:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106f6d:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80106f76:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106f77:	e9 94 da ff ff       	jmp    80104a10 <memmove>
    panic("inituvm: more than a page");
80106f7c:	83 ec 0c             	sub    $0xc,%esp
80106f7f:	68 19 7e 10 80       	push   $0x80107e19
...
80106fa0:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80106fa3:	a9 ff 0f 00 00       	test   $0xfff,%eax
80106fa8:	0f 85 99 00 00 00    	jne    80107047 <loaduvm+0xb7>
  for(i = 0; i < sz; i += PGSIZE){
80106fae:	01 f0                	add    %esi,%eax
80106fb0:	89 f3                	mov    %esi,%ebx
80106fb2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106fb5:	8b 45 14             	mov    0x14(%ebp),%eax
80106fb8:	01 f0                	add    %esi,%eax
80106fba:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80106fbd:	85 f6                	test   %esi,%esi
80106fbf:	75 15                	jne    80106fd6 <loaduvm+0x46>
80106fc1:	eb 6d                	jmp    80107030 <loaduvm+0xa0>
80106fc3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106fc7:	90                   	nop
80106fc8:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106fce:	89 f0                	mov    %esi,%eax
80106fd0:	29 d8                	sub    %ebx,%eax
80106fd2:	39 c6                	cmp    %eax,%esi
80106fd4:	76 5a                	jbe    80107030 <loaduvm+0xa0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106fd6:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106fd9:	8b 45 08             	mov    0x8(%ebp),%eax
80106fdc:	31 c9                	xor    %ecx,%ecx
80106fde:	29 da                	sub    %ebx,%edx
80106fe0:	e8 ab fb ff ff       	call   80106b90 <walkpgdir>
80106fe5:	85 c0                	test   %eax,%eax
80106fe7:	74 51                	je     8010703a <loaduvm+0xaa>
    pa = PTE_ADDR(*pte);
...
8010700e:	e8 4d aa ff ff       	call   80101a60 <readi>
80107013:	83 c4 10             	add    $0x10,%esp
80107016:	39 f8                	cmp    %edi,%eax
80107018:	74 ae                	je     80106fc8 <loaduvm+0x38>
}
...
8010706a:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
8010706d:	8b 45 10             	mov    0x10(%ebp),%eax
{
80107070:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80107073:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107076:	85 c0                	test   %eax,%eax
80107078:	0f 88 b2 00 00 00    	js     80107130 <allocuvm+0xd0>
  if(newsz < oldsz)
8010707e:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80107081:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80107084:	0f 82 96 00 00 00    	jb     80107120 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
8010708a:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80107090:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80107096:	39 75 10             	cmp    %esi,0x10(%ebp)
80107099:	77 40                	ja     801070db <allocuvm+0x7b>
8010709b:	e9 83 00 00 00       	jmp    80107123 <allocuvm+0xc3>
    memset(mem, 0, PGSIZE);
801070a0:	83 ec 04             	sub    $0x4,%esp
801070a3:	68 00 10 00 00       	push   $0x1000
801070a8:	6a 00                	push   $0x0
801070aa:	50                   	push   %eax
801070ab:	e8 c0 d8 ff ff       	call   80104970 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){ // 여기 오면 안됨
801070b0:	58                   	pop    %eax
...
801070c4:	e8 47 fb ff ff       	call   80106c10 <mappages>
...
801070d9:	76 48                	jbe    80107123 <allocuvm+0xc3>
    mem = kalloc();
801070db:	e8 50 b5 ff ff       	call   80102630 <kalloc>
...
801070e9:	68 51 7e 10 80       	push   $0x80107e51
801070ee:	e8 bd 95 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80107105:	e8 96 fb ff ff       	call   80106ca0 <deallocuvm.part.0>
      return 0;
...
8010714b:	68 69 7e 10 80       	push   $0x80107e69
80107150:	e8 5b 95 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80107167:	e8 34 fb ff ff       	call   80106ca0 <deallocuvm.part.0>
      kfree(mem);
8010716c:	83 ec 0c             	sub    $0xc,%esp
8010716f:	53                   	push   %ebx
80107170:	e8 fb b2 ff ff       	call   80102470 <kfree>
      return 0;
...
80107197:	8b 55 0c             	mov    0xc(%ebp),%edx
8010719a:	8b 4d 10             	mov    0x10(%ebp),%ecx
8010719d:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
801071a0:	39 d1                	cmp    %edx,%ecx
801071a2:	73 0c                	jae    801071b0 <deallocuvm+0x20>
}
801071a4:	5d                   	pop    %ebp
801071a5:	e9 f6 fa ff ff       	jmp    80106ca0 <deallocuvm.part.0>
...
801071cd:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
801071d0:	85 f6                	test   %esi,%esi
801071d2:	74 55                	je     80107229 <freevm+0x69>
  if(newsz >= oldsz)
801071d4:	31 c9                	xor    %ecx,%ecx
801071d6:	ba 00 00 00 80       	mov    $0x80000000,%edx
801071db:	89 f0                	mov    %esi,%eax
801071dd:	89 f3                	mov    %esi,%ebx
801071df:	e8 bc fa ff ff       	call   80106ca0 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801071e4:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
801071ea:	eb 0b                	jmp    801071f7 <freevm+0x37>
...
8010720e:	e8 5d b2 ff ff       	call   80102470 <kfree>
...
80107223:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107224:	e9 47 b2 ff ff       	jmp    80102470 <kfree>
    panic("freevm: no pgdir");
80107229:	83 ec 0c             	sub    $0xc,%esp
8010722c:	68 85 7e 10 80       	push   $0x80107e85
...
80107249:	e8 e2 b3 ff ff       	call   80102630 <kalloc>
8010724e:	89 c6                	mov    %eax,%esi
80107250:	85 c0                	test   %eax,%eax
80107252:	74 42                	je     80107296 <setupkvm+0x56>
  memset(pgdir, 0, PGSIZE);
80107254:	83 ec 04             	sub    $0x4,%esp
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107257:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  memset(pgdir, 0, PGSIZE);
8010725c:	68 00 10 00 00       	push   $0x1000
80107261:	6a 00                	push   $0x0
80107263:	50                   	push   %eax
80107264:	e8 07 d7 ff ff       	call   80104970 <memset>
80107269:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
8010726c:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
8010726f:	83 ec 08             	sub    $0x8,%esp
80107272:	8b 4b 08             	mov    0x8(%ebx),%ecx
80107275:	ff 73 0c             	pushl  0xc(%ebx)
80107278:	8b 13                	mov    (%ebx),%edx
8010727a:	50                   	push   %eax
8010727b:	29 c1                	sub    %eax,%ecx
8010727d:	89 f0                	mov    %esi,%eax
8010727f:	e8 8c f9 ff ff       	call   80106c10 <mappages>
80107284:	83 c4 10             	add    $0x10,%esp
80107287:	85 c0                	test   %eax,%eax
80107289:	78 15                	js     801072a0 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010728b:	83 c3 10             	add    $0x10,%ebx
8010728e:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80107294:	75 d6                	jne    8010726c <setupkvm+0x2c>
}
80107296:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
801072c7:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801072ca:	e8 71 ff ff ff       	call   80107240 <setupkvm>
801072cf:	a3 a4 57 11 80       	mov    %eax,0x801157a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
801072d4:	05 00 00 00 80       	add    $0x80000000,%eax
801072d9:	0f 22 d8             	mov    %eax,%cr3
}
801072dc:	c9                   	leave  
801072dd:	c3                   	ret    
...
801072f2:	e8 99 f8 ff ff       	call   80106b90 <walkpgdir>
  if(pte == 0)
801072f7:	85 c0                	test   %eax,%eax
801072f9:	74 05                	je     80107300 <clearpteu+0x20>
    panic("clearpteu");
  *pte &= ~PTE_U;
801072fb:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801072fe:	c9                   	leave  
801072ff:	c3                   	ret    
    panic("clearpteu");
80107300:	83 ec 0c             	sub    $0xc,%esp
80107303:	68 96 7e 10 80       	push   $0x80107e96
...
8010731a:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
8010731d:	e8 1e ff ff ff       	call   80107240 <setupkvm>
80107322:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107325:	85 c0                	test   %eax,%eax
80107327:	0f 84 9b 00 00 00    	je     801073c8 <copyuvm+0xb8>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010732d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80107330:	85 c9                	test   %ecx,%ecx
80107332:	0f 84 90 00 00 00    	je     801073c8 <copyuvm+0xb8>
80107338:	31 f6                	xor    %esi,%esi
8010733a:	eb 46                	jmp    80107382 <copyuvm+0x72>
...
80107389:	e8 02 f8 ff ff       	call   80106b90 <walkpgdir>
...
8010739f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
801073a2:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
801073a8:	e8 83 b2 ff ff       	call   80102630 <kalloc>
801073ad:	89 c3                	mov    %eax,%ebx
...
801073b9:	e8 02 fe ff ff       	call   801071c0 <freevm>
  return 0;
801073be:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
80107412:	e8 79 f7 ff ff       	call   80106b90 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
8010741c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
80107421:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107424:	05 00 00 00 80       	add    $0x80000000,%eax
80107429:	83 fa 05             	cmp    $0x5,%edx
8010742c:	ba 00 00 00 00       	mov    $0x0,%edx
80107431:	0f 45 c2             	cmovne %edx,%eax
}
80107434:	c3                   	ret    
80107435:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80107450:	8b 55 0c             	mov    0xc(%ebp),%edx
  ...
  buf = (char*)p;
  while(len > 0){
80107453:	85 f6                	test   %esi,%esi
80107455:	75 3c                	jne    80107493 <copyout+0x53>
80107457:	eb 67                	jmp    801074c0 <copyout+0x80>
...
80107465:	29 d3                	sub    %edx,%ebx
80107467:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
8010746d:	39 f3                	cmp    %esi,%ebx
8010746f:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80107472:	29 fa                	sub    %edi,%edx
80107474:	83 ec 04             	sub    $0x4,%esp
80107477:	01 c2                	add    %eax,%edx
80107479:	53                   	push   %ebx
8010747a:	ff 75 10             	pushl  0x10(%ebp)
8010747d:	52                   	push   %edx
8010747e:	e8 8d d5 ff ff       	call   80104a10 <memmove>
    len -= n;
    buf += n;
80107483:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
80107486:	8d 97 00 10 00 00    	lea    0x1000(%edi),%edx
  while(len > 0){
8010748c:	83 c4 10             	add    $0x10,%esp
8010748f:	29 de                	sub    %ebx,%esi
80107491:	74 2d                	je     801074c0 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
80107493:	89 d7                	mov    %edx,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107495:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
80107498:	89 55 0c             	mov    %edx,0xc(%ebp)
8010749b:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
801074a1:	57                   	push   %edi
801074a2:	ff 75 08             	pushl  0x8(%ebp)
801074a5:	e8 56 ff ff ff       	call   80107400 <uva2ka>
    if(pa0 == 0)
801074aa:	83 c4 10             	add    $0x10,%esp
801074ad:	85 c0                	test   %eax,%eax
801074af:	75 af                	jne    80107460 <copyout+0x20>
  }
  return 0;
}

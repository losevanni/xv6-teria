...
main(int argc, char *argv[])
{
  ...
  57:	68 8f 08 00 00       	push   $0x88f
  5c:	50                   	push   %eax
  5d:	68 8a 08 00 00       	push   $0x88a
  62:	6a 01                	push   $0x1
  64:	e8 b7 04 00 00       	call   520 <printf>
  69:	83 c4 10             	add    $0x10,%esp
  exit();
  6c:	e8 38 03 00 00       	call   3a9 <exit>
  71:	66 90                	xchg   %ax,%ax
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	eb 1a                	jmp    6c0 <printf+0x1a0>
          s = "(null)";
 6a6:	bb 91 08 00 00       	mov    $0x891,%ebx
        while(*s != 0){
 ...
 716:	73 10                	jae    728 <free+0x38>
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	a3 e8 0b 00 00       	mov    %eax,0xbe8
}
 747:	5e                   	pop    %esi
 748:	5f                   	pop    %edi
 749:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 78d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 790:	8b 3d e8 0b 00 00    	mov    0xbe8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d9:	8b 3d e8 0b 00 00    	mov    0xbe8,%edi
 ...
 802:	e8 e9 fe ff ff       	call   6f0 <free>
  return freep;
 807:	a1 e8 0b 00 00       	mov    0xbe8,%eax
 ...
 834:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 837:	a3 e8 0b 00 00       	mov    %eax,0xbe8
}
 ...
 84e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 e8 0b 00 00 ec 	movl   $0xbec,0xbe8
 857:	0b 00 00 
    base.s.size = 0;
 85a:	bf ec 0b 00 00       	mov    $0xbec,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 ec 0b 00 00 ec 	movl   $0xbec,0xbec
 866:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 86b:	c7 05 f0 0b 00 00 00 	movl   $0x0,0xbf0
 872:	00 00 00 
    if(p->s.size >= nunits){
